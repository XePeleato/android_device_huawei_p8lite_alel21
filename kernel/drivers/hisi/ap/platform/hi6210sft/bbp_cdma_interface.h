...
/*****************************************************************************
 ...
 结构说明  : VIRAGE_RM_CTRL_C_0 寄存器结构定义。地址偏移量:0x00，初值:0x0C9B0C9B，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : VIRAGE_RM_CTRL_C_1 寄存器结构定义。地址偏移量:0x04，初值:0x00230C9B，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
typedef union
{
    ...
    struct
    {
        unsigned long  dldec_ber : 15; /* bit[0-14] : 盲检测BER统计结果 */
        unsigned long  reserved  : 17; /* bit[15-31]: 保留 */
    } reg;
