...
/***======================================================================***
                     (1/12) register_define_g_addr_11x
 ***======================================================================***/
/* 寄存器说明：
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第一近的一个BURST解调前粗测I值上报，测试用。
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第二近的一个BURST解调前粗测I值上报，测试用。
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第三近的一个BURST解调前粗测I值上报，测试用。
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第四近的一个BURST解调前粗测I值上报，测试用。
...
/* 寄存器说明：
 bit[31]     读取时刻最近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/* 寄存器说明：
 bit[31]     读取时刻第二近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/* 寄存器说明：
 bit[31]     读取时刻第三近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/* 寄存器说明：
 bit[31]     读取时刻第四近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/***======================================================================***
                     (2/12) register_define_g_addr_15x
 ***======================================================================***/
/* 寄存器说明：
 bit[31:30]  保留
 bit[29]     解调结束中断
 ...
 bit[2]      同步搜索中断请求
 bit[1]      GTC PAGE中断请求
 bit[0]      TDMA帧中断请求，1表示中断请求，0表示无中断请求，其他bit描述同此。
   UNION结构:  GBBP_CPU_INT_STA_UNION */
#define GBBP_CPU_INT_STA_ADDR                         (SOC_BBP_GSM_BASE_ADDR + 0x1200)

/* 寄存器说明：
 bit[31:30]  保留
 bit[29]     解调结束中断屏蔽寄存器
 bit[28]     电平测量结束中断屏蔽寄存器
 bit[27:25]  保留
 bit[24]     时钟测量中断屏蔽寄存器
 bit[23:20]  保留
 bit[19]     可编程中断7屏蔽寄存器
 ...
 bit[6]      时隙2中断屏蔽寄存器
 bit[5]      时隙1中断屏蔽寄存器
 bit[4]      时隙0中断屏蔽寄存器，1有效
 bit[3]      译码数据上报中断屏蔽寄存器
 bit[2]      同步搜索中断屏蔽寄存器
 bit[1]      GTC PAGE中断屏蔽寄存器
 bit[0]      TDMA帧中断屏蔽信号，1表示中断请求屏蔽，0表示中断不屏蔽，其他bit描述同此。
   UNION结构:  GBBP_CPU_INT_MASK_UNION */
...
/* 寄存器说明：
 ...
 bit[3]      译码数据上报中断清零信号
 bit[2]      同步搜索中断清零信号
 bit[1]      GTC PAGE中断清零信号
 bit[0]      TDMA帧中断清零信号，1表示中断请求清除，0表示中断请求不清除，其他bit描述同此。
   UNION结构:  GBBP_CPU_INT_CLR_UNION */
...
/* 寄存器说明：
 ...
 bit[1]      GTC PAGE中断请求
 bit[0]      TDMA帧中断请求，1表示中断请求，0表示无中断请求，其他bit描述同此。
   UNION结构:  GBBP_DSP_INT_STA_UNION */
...
/* 寄存器说明：
 ...
 bit[28]     电平测量结束中断屏蔽寄存器
 bit[27]     时钟测量中断屏蔽寄存器
 bit[26]     CTU异系统测量中断2屏蔽寄存器
 bit[25]     CTU异系统测量中断1屏蔽寄存器
 bit[24]     CTU异系统测量中断0屏蔽寄存器
 bit[23:20]  保留
 bit[19]     可编程中断7屏蔽寄存器
 bit[18]     可编程中断6屏蔽寄存器
 bit[17]     可编程中断5屏蔽寄存器
 ...
 bit[1]      GTC PAGE中断屏蔽寄存器
 bit[0]      TDMA帧中断屏蔽信号，1表示中断请求屏蔽，0表示中断不屏蔽，其他bit描述同此。
   UNION结构:  GBBP_DSP_INT_MASK_UNION */
...
/* 寄存器说明：
 ...
 bit[28]     电平测量结束中断清零信号
 bit[27]     时钟测量中断清零信号
 bit[26]     CTU异系统测量中断2清零信号
 bit[25]     CTU异系统测量中断1清零信号
 bit[24]     CTU异系统测量中断0清零信号
 bit[23:20]  保留
 bit[19]     可编程中断7清零信号
 bit[18]     可编程中断6清零信号
 bit[17]     可编程中断5清零信号
 ...
 bit[1]      GTC PAGE中断清零信号
 bit[0]      TDMA帧中断清零信号，1表示中断请求清除，0表示中断请求不清除，其他bit描述同此。
   UNION结构:  GBBP_DSP_INT_CLR_UNION */
...
/***======================================================================***
                     (3/12) register_define_g_addr_5x
 ***======================================================================***/
/* 寄存器说明：
 bit[31:24]  保留
...
/* 寄存器说明：
 bit[31]     读取时刻第五近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/* 寄存器说明：
 bit[31]     读取时刻第六近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。
 bit[30]     保留
...
/* 寄存器说明：
 bit[31:28]  保留
 bit[27:24]  16组A5 CIPH模块的测试引脚选择信号
 bit[23:20]  16组A5 DECIPH模块的测试引脚选择信号
 bit[19:16]  16组GRIF模块的测试引脚选择信号
 bit[15:12]  保留
...
/* 寄存器说明：
   详      述：PHY专用寄存器写使能控制字
            0x88888888 可以写dsp_dedicate8_reg
   UNION结构 ：无 */
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第五近的一个BURST解调前粗测I值上报，测试用
...
/* 寄存器说明：
 bit[31:15]  保留
 bit[14:0]   第六近的一个BURST解调前粗测I值上报，测试用
...
/***======================================================================***
                     (4/12) register_define_g_addr_fx
 ***======================================================================***/
/* 寄存器说明：
...
/***======================================================================***
                     (5/12) register_define_sdr_gdrx_guage
 ***======================================================================***/
/* 寄存器说明：
...
/***======================================================================***
                     (6/12) register_define_g_fe_ctrl
 ***======================================================================***/
/* 寄存器说明：
 bit[31:15]  保留
...
/***======================================================================***
                     (7/12) register_define_g_fe_ctrl_mem
 ***======================================================================***/
...
/***======================================================================***
                     (9/12) register_define_g_addr_2x_mem
 ***======================================================================***/
...
/***======================================================================***
                     (10/12) register_define_g_addr_3x_mem
 ***======================================================================***/
...
/***======================================================================***
                     (11/12) register_define_g_addr_5x_mem
 ***======================================================================***/
...
/***======================================================================***
                     (12/12) register_define_g_addr_6x_mem
 ***======================================================================***/
...
/*****************************************************************************
 ...
 结构说明  : CPU_SOFT_AFC_VALUE 寄存器结构定义。地址偏移量:0x000，初值:0x00002000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_soft_afc_value  : 14; /* bit[0-13] : 物理层软件计算AFC值，在cpu_soft_afc_renew有效时，将此值输出给VCO。 */
        unsigned long  reserved            : 17; /* bit[14-30]: 保留 */
        unsigned long  cpu_soft_afc_en_imi : 1;  /* bit[31]   : 物理层软件计算AFC值使能信号，电平信号，高有效。在此信号为高期间，GBBP不在进行AFC锁定判断，输出给VCO的值由cpu_soft_afc_value[13:0]提供。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_SOFT_VALUE_RENEW 寄存器结构定义。地址偏移量:0x004，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_soft_afc_renew_imi : 1;  /* bit[0]   : 物理层软件启动更新AFC值，脉冲信号。此信号在cpu_soft_afc_en_imi为高时才有效，写1逻辑自清零。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_CI_THRES_CFG 寄存器结构定义。地址偏移量:0x008，初值:0x00030003，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gmsk_ci_thres : 3;  /* bit[0-2]  : GMSK调制方式下，CI判决门限选择信号，用于筛选nb-afc的输出。小于该门限，afc_valui_i和afc_value_q都输出0，否则输出真实值。
                                                              cpu_psk_ci_thres[2:0]=0 C>I
                                                              cpu_psk_ci_thres[2:0]=1 C>4I
                                                              cpu_psk_ci_thres[2:0]=2 C>8I
                                                              cpu_psk_ci_thres[2:0]=3 C>16I
                                                              ...
                                                              cpu_psk_ci_thres[2:0]=7 不判决，直接输出。
                                                              默认值是3。 */
        unsigned long  reserved_0        : 13; /* bit[3-15] : 保留 */
        unsigned long  cpu_psk_ci_thres  : 3;  /* bit[16-18]: 8PSK调制方式下，CI判决门限选择信号，用于筛选nb-afc的输出。小于该门限，afc_valui_i和afc_value_q都输出0，否则输出真实值。
                                                              cpu_gmsk_ci_thres[2:0]=0 C>I
                                                              cpu_gmsk_ci_thres[2:0]=1 C>4I
                                                              cpu_gmsk_ci_thres[2:0]=2 C>8I
                                                              cpu_gmsk_ci_thres[2:0]=3 C>16I
...
/*****************************************************************************
 ...
 结构说明  : CPU_NB_AFC_NUM 寄存器结构定义。地址偏移量:0x00C，初值:0x00000002，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_nb_afc_num : 3;  /* bit[0-2] : 一阶环用于计算NB-AFC的NB个数选择信号：
                                                          0：表示选择1个NB来计算；
                                                          1：表示选择2个NB来计算；
                                                          2：表示选择4个NB来计算；
                                                          3：表示选择8个NB来计算；
...
/*****************************************************************************
 ...
 结构说明  : CPU_AFC_CFG 寄存器结构定义。地址偏移量:0x010，初值:0x00002000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_afc_init        : 14; /* bit[0-13] : G AFC初始值。
                                                                当RFCMOS使用晶体方案时，配置该值为14'h1fff（详见V3R2晶体系统方案）；其他方案时，使用原来的配置值。 */
        unsigned long  reserved_0          : 1;  /* bit[14]   : 保留 */
        unsigned long  cpu_afc_init_en_imi : 1;  /* bit[15]   : AFC初始值写入使能，CPU写1，逻辑自清零。 */
        unsigned long  reserved_1          : 15; /* bit[16-30]: 保留 */
        unsigned long  cpu_fb_afc_clr      : 1;  /* bit[31]   : FB-AFC清零信号，写1生效，逻辑自清零 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AFC_VALUE_I_CPU 寄存器结构定义。地址偏移量:0x014，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  afc_value_i : 19; /* bit[0-18] : 上报的afc实部相关累加值，直接由乘累加模块输出，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : AFC_VALUE_Q_CPU 寄存器结构定义。地址偏移量:0x018，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  afc_value_q : 19; /* bit[0-18] : 上报的afc虚部相关累加值，直接由乘累加模块输出，测试用。 */
        unsigned long  reserved    : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_AFC_PWM_WIDTH_SEL 寄存器结构定义。地址偏移量:0x01C，初值:0x00000002，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_afc_pwm_width_sel : 2;  /* bit[0-1] : 0表示使用10bit的PDM转换模块；
                                                                 1表示使用12bit的PDM转换模块；
                                                                 2表示使用14bit的PDM转换模块。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_NB_AFC_NUM_CLR 寄存器结构定义。地址偏移量:0x020，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_nb_afc_num_clr_imi : 1;  /* bit[0]   : 表示重新开始统计NB-AFC的NB-BURST个数，cpu写1，逻辑自清零。
                                                                  此时不输出当前累计NB个数对应的NB-AFC滤波值。建议先改变cpu_nb_afc_num后配置此值为1。 */
        unsigned long  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FB_KP_KINT 寄存器结构定义。地址偏移量:0x024，初值:0x00160000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  cpu_afc_maxfbnum : 5;  /* bit[16-20]: 用于FB-AFC判决的总的FB个数，可配范围为：17~31
                                                             默认配置为：22 */
...
/*****************************************************************************
 ...
 结构说明  : FB_TIMEBASE_RPT 寄存器结构定义。地址偏移量:0x028，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  fb_timebase_qb_rpt : 13; /* bit[0-12] : 滞后FB1215QB处timebase的QB计数，测试用。 */
        unsigned long  reserved_0         : 3;  /* bit[13-15]: 保留 */
        unsigned long  fb_timebase_fn_rpt : 11; /* bit[16-26]: 滞后FB1215QB处timebase的FN模2048计数，计数范围：0~2047测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : FB_FN_RPT 寄存器结构定义。地址偏移量:0x02C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_t3_cnt : 6;  /* bit[0-5]  : FB所在帧位置T3计数器上报。 */
        unsigned long  reserved_0 : 2;  /* bit[6-7]  : 保留 */
        unsigned long  gtc_t2_cnt : 5;  /* bit[8-12] : FB所在帧位置T2计数器上报。 */
        unsigned long  reserved_1 : 3;  /* bit[13-15]: 保留 */
        unsigned long  gtc_t1_cnt : 11; /* bit[16-26]: FB所在帧位置T1计数器上报。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_FB_TIMES_THRES 寄存器结构定义。地址偏移量:0x030，初值:0x03652011，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_fb_failed_thres : 2;  /* bit[0-1]  : FB同步失败次数门限。
                                                                2'd0：使用的门限值为1；
                                                                2'd1：使用的门限值为2；
                                                                2'd2：使用的门限值为3；
                                                                2'd3：使用的门限值为4。
        ...
        unsigned long  cpu_sb_failed_thres : 2;  /* bit[4-5]  : SB同步失败次数门限。
                                                                2'd0：使用的门限值为1；
                                                                2'd1：使用的门限值为2；
                                                                2'd2：使用的门限值为3；
                                                                其他：无效。
                                                                缺省值为2'd1。 */
        unsigned long  reserved_1          : 6;  /* bit[6-11] : 保留 */
        unsigned long  cpu_fb_peak_window  : 17; /* bit[12-28]: FB搜索窗的符号个数门限值。
                                                                缺省值为17'd13906（对应11帧+1时隙）。当搜索的时间长度大于该值时，FB搜索结束。
                                                                注：13906=11*1250+156 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_FB_ENERG_THRES 寄存器结构定义。地址偏移量:0x034，初值:0x00200000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  reserved_0        : 12; /* bit[0-11] : 保留 */
        unsigned long  cpu_fb_peak_thres : 11; /* bit[12-22]: FB搜索成功的门限，当FB搜索得到的能量的最大值大于该门限时，才认为搜索成功，缺省值为512。 */
        unsigned long  reserved_1        : 9;  /* bit[23-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AFC_RPT 寄存器结构定义。地址偏移量:0x038，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  afc_vctxo_cpu       : 14; /* bit[0-13] : AFC输出的VCTXO控制电压。 */
        unsigned long  reserved            : 2;  /* bit[14-15]: 保留 */
        unsigned long  afc_vctxo_16bit_cpu : 16; /* bit[16-31]: AFC输出的16比特VCTXO的控制电压信号 */
    } reg;
} GBBP_AFC_RPT_UNION;
...
/*****************************************************************************
 ...
 结构说明  : FB_RPT1 寄存器结构定义。地址偏移量:0x03C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  fb_pos_cpu : 13; /* bit[0-12] : FB搜索得到的FB时隙头位置，相对于gtc_timebase的位置。 */
...
/*****************************************************************************
 ...
 结构说明  : FB_RPT2 寄存器结构定义。地址偏移量:0x040，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  fb_square_max_cpu : 19; /* bit[0-18] : 本轮FB搜索的最大能量值，测试用。 */
        unsigned long  reserved          : 13; /* bit[19-31]: 保留 */
    } reg;
} GBBP_FB_RPT2_UNION;
...
/*****************************************************************************
 ...
 结构说明  : SB_POS_RPT1 寄存器结构定义。地址偏移量:0x044，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_pos_cpu   : 13; /* bit[0-12] : SB搜索能量最大值相对于timebase的位置，若SB搜索失败，则上报值无效。 */
        unsigned long  reserved_0   : 3;  /* bit[13-15]: 保留 */
        unsigned long  srch_fsm_cpu : 2;  /* bit[16-17]: 搜索状态机上报信号，
                                                         0：Idle State；
                                                         1：FB搜索状态；
                                                         2：AFC判断状态；
                                                         3：SB搜索状态。 */
...
/*****************************************************************************
 ...
 结构说明  : SB_SQUARE_RPT1 寄存器结构定义。地址偏移量:0x048，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_square_cpu : 30; /* bit[0-29] : SB搜索能量值的最大值，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : SB_POS_RPT2 寄存器结构定义。地址偏移量:0x04C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_max2_pos_cpu : 13; /* bit[0-12] : SB搜索能量次大值相对于timebase的位置。 */
        unsigned long  reserved        : 19; /* bit[13-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SB_SQUARE_RPT2 寄存器结构定义。地址偏移量:0x050，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_max2_square_cpu : 30; /* bit[0-29] : SB搜索能量值的次大值，测试用。 */
        unsigned long  reserved           : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SB_POS_RPT3 寄存器结构定义。地址偏移量:0x054，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_max3_pos_cpu : 13; /* bit[0-12] : SB搜索能量第三大值相对于timebase的位置。 */
        unsigned long  reserved        : 19; /* bit[13-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SB_SQUARE_RPT3 寄存器结构定义。地址偏移量:0x058，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  sb_max3_square_cpu : 30; /* bit[0-29] : SB搜索能量值的第三大值，测试用。 */
        unsigned long  reserved           : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : STATE_RPT 寄存器结构定义。地址偏移量:0x05C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mau_curr_state      : 4;  /* bit[0-3]  : 乘累加状态上报，
                                                                4'd0：空闲状态；
                                                                4'd1：同步搜索状态；
                                                                4'd2：NB盲检测及同步位置更新；
                                                                4'd3：预滤波；
                                                                ...
                                                                4'd5：VALPP软判。
                                                                测试用。 */
        unsigned long  srch_curr_state     : 2;  /* bit[4-5]  : 乘累加模块搜索过程状态上报，测试用。 */
        unsigned long  reserved_0          : 2;  /* bit[6-7]  : 保留 */
        unsigned long  int_srch_status_cpu : 4;  /* bit[8-11] : 搜索中断状态，即反应产生中断的原因。此信号当int_srch_sync_cpu有效后有效，测试用。各bit含义如下，
                                                                C01搜索流程版本：
                                                                4'd0：搜索正常结束；
                                                                4'd1：FB未同步；
                                                                4'd2：AFC未锁定；
        ...
        unsigned long  srch_status_cpu     : 3;  /* bit[16-18]:  */
        unsigned long  reserved_2          : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SRCH_QB_RPT 寄存器结构定义。地址偏移量:0x064，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  srch_timebase_qb    : 13; /* bit[0-12] : 搜索中断所在gtc_timebase上报。 */
        unsigned long  reserved_0          : 3;  /* bit[13-15]: 保留 */
        unsigned long  srch_int_mod        : 3;  /* bit[16-18]: 搜索中断时，gsp_srch_mod上报。 */
        unsigned long  reserved_1          : 9;  /* bit[19-27]: 保留 */
        unsigned long  srch_start_mod      : 3;  /* bit[28-30]: 搜索启动时，gsp_srch_mod上报。 */
        unsigned long  gsp_ncell_srch_flag : 1;  /* bit[31]   : 当前搜索小区类型上报，
                                                                0：表示服务小区；
                                                                1：表示邻区。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SRCH_FN_RPT 寄存器结构定义。地址偏移量:0x06C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  srch_fn_low  : 11; /* bit[0-10] : 搜索中断所在位置的gtc_fn_low上报。 */
        unsigned long  reserved_0   : 5;  /* bit[11-15]: 保留 */
        unsigned long  srch_fn_high : 11; /* bit[16-26]: 搜索中断所在位置的gtc_fn_high上报。 */
        unsigned long  reserved_1   : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SB_ADVANCE_LEN_CFG 寄存器结构定义。地址偏移量:0x070，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_sb_advance_len : 6;  /* bit[0-5] : 001搜索模式下，SB提前接收符号的个数，即在SB之前多接受cpu_sb_advance_len个符号，可配0~34。 */
...
/*****************************************************************************
 ...
 结构说明  : SRCH_FRQ_RPT 寄存器结构定义。地址偏移量:0x07C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  srch_start_frq : 12; /* bit[0-11] : 搜索启动时的频点信息上报。 */
        unsigned long  reserved_0     : 4;  /* bit[12-15]: 保留 */
        unsigned long  srch_int_frq   : 12; /* bit[16-27]: 搜索中断时的频点信息上报。 */
...
/*****************************************************************************
 ...
 结构说明  : AFC_LOOP1_RPT 寄存器结构定义。地址偏移量:0x078，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  nbafc_1loop_cpu   : 31; /* bit[0-30]: 一阶环当前NB-AFC环路滤波累加器的上报值 */
        unsigned long  gsp_nb_afc_switch : 1;  /* bit[31]  : NB-AFC一阶环与二阶环状态上报。
                                                             0：表示当前处于一阶环；
                                                             1：表示当前处于二阶环。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_AFC_LOOP1_CFG 寄存器结构定义。地址偏移量:0x080，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_nbafc_1loop : 31; /* bit[0-30]: 上电后一阶环NB-AFC环路滤波累加器的配置值。
                                                           再配置cpu_afc_init_en为1后生效。 */
...
/*****************************************************************************
 ...
 结构说明  : NCELL_NCO_RPT 寄存器结构定义。地址偏移量:0x084，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  ncell_nco_cpu    : 16; /* bit[0-15] : 邻区频偏检测结果上报。 */
        unsigned long  ncell_nco_status : 2;  /* bit[16-17]: 邻区频偏状态上报。 */
...
/*****************************************************************************
 ...
 结构说明  : AFC_PHASE_THRESHOLD_CFG 寄存器结构定义。地址偏移量:0x08C，初值:0x02F8012C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_afc_phase_min : 10; /* bit[0-9]  : NB-AFC算法相位估计值参考下限，典型值300。 */
        unsigned long  reserved_0        : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_afc_phase_max : 10; /* bit[16-25]: NB-AFC算法相位估计值参考上限，典型值760。 */
...
/*****************************************************************************
 ...
 结构说明  : AFC_FCUT_THRESHOLD_CFG 寄存器结构定义。地址偏移量:0x090，初值:0x04000033，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_afc_fc_low  : 13; /* bit[0-12] : NB-AFC算法系数fcut的最小值，如果经过α滤波后的相位估计值小雨相位估计值参考下限，则系数fcut的值就等于此最小值。典型值51。 */
        unsigned long  reserved_0      : 3;  /* bit[13-15]: 保留 */
        unsigned long  cpu_afc_fc_high : 13; /* bit[16-28]: NB-AFC算法系数fcut的最大值，如果经过α滤波后的相位估计值大于相位估计值的参考上限，则系数fcut的值就等于此最大值。典型值1024。 */
...
/*****************************************************************************
 ...
 结构说明  : AFC_ALPHA_SEL 寄存器结构定义。地址偏移量:0x094，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_numerator_sel : 2;  /* bit[0-1] : NB-AFC算法α滤波系数选择：
                                                             0：1/64；
                                                             1：1/32；
                                                             2：1/16；
                                                             3：1/8。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_SRCH_EN_CLR 寄存器结构定义。地址偏移量:0x124，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_srch_en_clr_imi          : 1;  /* bit[0]    : 写1表示产生gsp_srch_en清零信号，逻辑自清零。 */
        unsigned long  cpu_nb_demod_en_clr_imi      : 1;  /* bit[1]    : 写1表示产生gsp_nb_demod_en清零信号，逻辑自清零。 */
        unsigned long  cpu_agc_en_clr_imi           : 1;  /* bit[2]    : 写1表示产生gsp_agc_en清零信号，逻辑自清零。 */
        unsigned long  cpu_nb_afc_en_clr_imi        : 1;  /* bit[3]    : 写1表示产生gsp_nb_afc_en清零信号，逻辑自清零。 */
        unsigned long  gsp_alpha_toa_energy_clr_imi : 1;  /* bit[4]    : 写1表示产生TOA ALPHA能量累加值的清零信号，逻辑自清零。 */
        unsigned long  reserved_0                   : 11; /* bit[5-15] : 保留 */
        unsigned long  gsp_srch_en                  : 1;  /* bit[16]   : 搜索使能状态上报。 */
        unsigned long  gsp_nb_demod_en              : 1;  /* bit[17]   : NB解调使能状态上报。 */
        unsigned long  reserved_1                   : 14; /* bit[18-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : NB_POS_RPT 寄存器结构定义。地址偏移量:0x060，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  nb_pos_cpu         : 13; /* bit[0-12] : NB位置更新上报，是读取时刻最后一个解调BURST的位置，其相对于timebase。CPU可以在帧中断中读取。精度2QB。 */
        unsigned long  reserved_0         : 3;  /* bit[13-15]: 保留 */
        unsigned long  mod_type_cpu       : 2;  /* bit[16-17]: NB调制方式上报，
                                                               0：GMSK调制；
                                                               1：8PSK调制；
                                                               2：DummyBurst。 */
        unsigned long  reserved_1         : 6;  /* bit[18-23]: 保留 */
        unsigned long  mod_type_first_cpu : 2;  /* bit[24-25]: NB调制方式第一次判决结果上报。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_8PSK_PSP_ALPHA_PARA 寄存器结构定义。地址偏移量:0x068，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_8psk_psp_alpha_para : 2;  /* bit[0-1] : 8psk均衡解调中求PSP_EN的参数alpha，
                                                                   0：对应的值为8；
                                                                   1：对应的值为16；
                                                                   2：对应的值为24；
                                                                   3：无效。
                                                                   默认值为1。 */
        unsigned long  reserved                : 29; /* bit[2-30]: 保留 */
        unsigned long  cpu_opt_en              : 1;  /* bit[31]  : 1表示打开信道因子优化配置。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_TOA_ALPHA_PARA 寄存器结构定义。地址偏移量:0x074，初值:0x00000004，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_alpha_parameter : 3;  /* bit[0-2] : alpha滤波系数选择：
                                                               0：表示选择系数为1/2；
                                                               1：表示选择系数为1/4；
                                                               2：表示选择系数为1/8；
                                                               3：表示选择系数为1/16；
...
/*****************************************************************************
 ...
 结构说明  : CPU_CH_EST_OPT 寄存器结构定义。地址偏移量:0x088，初值:0x00050042，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_ch_est_opt_noise_alpha : 3;  /* bit[0-2]  : 信道估计优化噪声系数因子，取值1~5，默认配置2。 */
        unsigned long  reserved_0                 : 3;  /* bit[3-5]  : 保留 */
        unsigned long  cpu_valpp_opt_en           : 1;  /* bit[6]    : valpp计算PSP更新使能信号，1有效。 */
        unsigned long  cpu_ch_est_opt_bypass      : 1;  /* bit[7]    : 1表示旁路信道估计优化功能；
                                                                       0表示打开信道估计优化功能。 */
        unsigned long  reserved_1                 : 8;  /* bit[8-15] : 保留 */
        unsigned long  cpu_white_filter_thres     : 3;  /* bit[16-18]: 白化滤波判决门限，当噪声大于能量的倍数超过该门限，不启动白化滤波。对于NB可配置范围时1~7，表示1~7倍；对于SB，固定配置为5，表示5倍。 */
        unsigned long  reserved_2                 : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : NB_MOD_TYPE_RPT 寄存器结构定义。地址偏移量:0x098，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  slot_demod_flag_cpu : 16; /* bit[0-15] : bit0~bit15表示多时隙的第一，第二，第三，第四个时隙的四个BURST调制盲检测标志上报，0标识GMSK，1标识8PSK。 */
        unsigned long  slot_burst_flag_cpu : 16; /* bit[16-31]: bit16~bit31表示多时隙的第一，第二，第三，第四个时隙的四个BURST类型盲检测标志上报，0标识NB，1标识DB。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : NB_BURST_TYPE_RPT 寄存器结构定义。地址偏移量:0x0BC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  slot_demod_flag_high_cpu : 8;  /* bit[0-7]  : bit0~bit7表示多时隙的第五，第六时隙的两个BURST调制盲检测标志上报，0标识GMSK，1标识8PSK。 */
        unsigned long  reserved_0               : 8;  /* bit[8-15] : 保留 */
        unsigned long  slot_burst_flag_high_cpu : 8;  /* bit[16-23]: bit16~bit23表示多时隙的第五，第六时隙的两个BURST类型标志上报，0标识NB，1标识DB。 */
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY1 寄存器结构定义。地址偏移量:0x09C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_1d : 19; /* bit[0-18] : 第一近的一个BURST解调前粗测C值上报，测试用。 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY1 寄存器结构定义。地址偏移量:0x0A0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_1d : 15; /* bit[0-14] : 第一近的一个BURST解调前粗测I值上报，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY2 寄存器结构定义。地址偏移量:0x0A4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_2d : 19; /* bit[0-18] : 第二近的一个BURST解调前粗测C值上报，测试用。 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY2 寄存器结构定义。地址偏移量:0x0A8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_2d : 15; /* bit[0-14] : 第二近的一个BURST解调前粗测I值上报，测试用。 */
        unsigned long  reserved   : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY3 寄存器结构定义。地址偏移量:0x0AC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_3d : 19; /* bit[0-18] : 第三近的一个BURST解调前粗测C值上报，测试用。 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY3 寄存器结构定义。地址偏移量:0x0B0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_3d : 15; /* bit[0-14] : 第三近的一个BURST解调前粗测I值上报，测试用。 */
        unsigned long  reserved   : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY4 寄存器结构定义。地址偏移量:0x0B4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_4d : 19; /* bit[0-18] : 第四近的一个BURST解调前粗测C值上报，测试用。 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY4 寄存器结构定义。地址偏移量:0x0B8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_4d : 15; /* bit[0-14] : 第四近的一个BURST解调前粗测I值上报，测试用。 */
        unsigned long  reserved   : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY0 寄存器结构定义。地址偏移量:0x100，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_cpu : 31; /* bit[0-30]: 读取时刻前最近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                 : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY0 寄存器结构定义。地址偏移量:0x150，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_cpu : 26; /* bit[0-25] : 读取时刻前最近burst对应的干扰能量值，无符号数。 */
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA0 寄存器结构定义。地址偏移量:0x104，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  toa_sel_result        : 6;  /* bit[0-5]  : 最近6个时隙的TOA样点选择结果，
                                                                  bit0：最近一个burst的选择结果；
                                                                  bit1：第二近burst的选择结果，
                                                                  其他依次类推。
                                                                  0表示选择前半个符号，1表示选择后半个符号，需要在nb_pos_adj的基础上加上2QB。 */
        unsigned long  reserved_0            : 2;  /* bit[6-7]  : 保留 */
        unsigned long  max_sum_index_cpu     : 4;  /* bit[8-11] : SAIC后TOA五径C值最大值对应径号；
                                                                  取值范围0~4。 */
        unsigned long  reserved_1            : 2;  /* bit[12-13]: 保留 */
        unsigned long  mod_type_1d           : 2;  /* bit[14-15]: 读取时刻最近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻最近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_1d         : 3;  /* bit[20-22]: 读取时刻最近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_1d     : 1;  /* bit[24]   : 读取时刻最近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_3            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_1d     : 2;  /* bit[28-29]: 读取时刻前的最近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_4            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻最近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY1 寄存器结构定义。地址偏移量:0x108，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_1d_cpu : 31; /* bit[0-30]: 读取时刻前第二近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                    : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY1 寄存器结构定义。地址偏移量:0x154，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_1d_cpu : 26; /* bit[0-25] : 读取时刻前第二近burst对应的干扰能量值，无符号数。 */
        unsigned long  reserved                      : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA1 寄存器结构定义。地址偏移量:0x10C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  reserved_0            : 14; /* bit[0-13] : 保留 */
        unsigned long  mod_type_2d           : 2;  /* bit[14-15]: 读取时刻第二近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻第二近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_2d         : 3;  /* bit[20-22]: 读取时刻第二近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_1            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_2d     : 1;  /* bit[24]   : 读取时刻第二近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_2d     : 2;  /* bit[28-29]: 读取时刻前的第二近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_3            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻第二近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY2 寄存器结构定义。地址偏移量:0x110，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_2d_cpu : 31; /* bit[0-30]: 读取时刻前第三近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                    : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY2 寄存器结构定义。地址偏移量:0x158，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_2d_cpu : 26; /* bit[0-25] : 读取时刻前第三近burst对应的干扰能量值，无符号数。 */
        unsigned long  reserved                      : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA2 寄存器结构定义。地址偏移量:0x114，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    {
        unsigned long  reserved_0            : 14; /* bit[0-13] : 保留 */
        unsigned long  mod_type_3d           : 2;  /* bit[14-15]: 读取时刻第三近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻第三近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_3d         : 3;  /* bit[20-22]: 读取时刻第三近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_1            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_3d     : 1;  /* bit[24]   : 读取时刻第三近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_3d     : 2;  /* bit[28-29]: 读取时刻前的第三近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_3            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻第三近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY3 寄存器结构定义。地址偏移量:0x118，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_3d_cpu : 31; /* bit[0-30]: 读取时刻前第四近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                    : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY3 寄存器结构定义。地址偏移量:0x15C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_3d_cpu : 26; /* bit[0-25] : 读取时刻前第四近burst对应的干扰能量值，无符号数。 */
        unsigned long  reserved                      : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA3 寄存器结构定义。地址偏移量:0x11C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    {
        unsigned long  reserved_0            : 14; /* bit[0-13] : 保留 */
        unsigned long  mod_type_4d           : 2;  /* bit[14-15]: 读取时刻第四近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻第四近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_4d         : 3;  /* bit[20-22]: 读取时刻第四近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_1            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_4d     : 1;  /* bit[24]   : 读取时刻第四近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_4d     : 2;  /* bit[28-29]: 读取时刻前的第四近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_3            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻第四近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DEM_WIDTH_CFG 寄存器结构定义。地址偏移量:0x120，初值:0x00010000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_demod_width_adjust : 2;  /* bit[0-1]  : 解调动态位宽配置
                                                                   2’d0：动态右移位数为0
                                                                   2’d1：动态右移位数为1
                                                                   2’d2：动态右移位数为2
                                                                   其他：保留 */
        unsigned long  reserved_0             : 14; /* bit[2-15] : 保留 */
        unsigned long  cpu_harq_width_mode    : 1;  /* bit[16]   : HARQ译码前数据位宽恢复模式配置
                                                                   0:按照解调动态位宽方案恢复数据
                                                                   1:不做解调软值位宽恢复操作 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_DB_TYPE_CFG 寄存器结构定义。地址偏移量:0x128，初值:0x00040001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_db_type      : 2;  /* bit[0-1]  : 物理层配置的Dummy 训练序列类型。
                                                             0：Dummy Burst训练序列同NB
                                                             1：Dummy Burst训练序列同C0模式训练序列
                                                             2：Dummy Burst训练序列同NB模式训练序列有固定的映射关系。
                                                             3：保留
                                                             默认值1。 */
        unsigned long  reserved_0       : 14; /* bit[2-15] : 保留 */
        unsigned long  cpu_db_threshold : 4;  /* bit[16-19]: Dummy Burst二次判决门限；
                                                             0： threshold_db=4；
                                                             1： threshold_db=6；
                                                             2： threshold_db=8；
                                                             3： threshold_db=9；
...
/*****************************************************************************
 ...
 结构说明  : CPU_DEM_BEP_MODE_EN 寄存器结构定义。地址偏移量:0x12C，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cup_dem_bep_mode_en : 1;  /* bit[0]   : 1表示打开解调BEP功能。
                                                               0表示屏蔽解调BEP功能 */
        unsigned long  reserved            : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_VALPP_CARRY_CTRL 寄存器结构定义。地址偏移量:0x130，初值:0x82008000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_carry_burst_pos  : 7;  /* bit[0-6]  : VALPP_RAM 和 CARRY_RAM 数据搬移目标BURST位置(carry to valpp) */
        unsigned long  reserved_0           : 8;  /* bit[7-14] : 保留 */
        unsigned long  cpu_valpp_carry_mode : 1;  /* bit[15]   : VALPP_RAM 和 CARRY_RAM 数据搬移方向指示，1表示从VALPP_RAM到CARRY_RAM，0表示从CARRY_RAM到VALPP_RAM,在这种模式下，需要相应的配置cpu_carry_burst_pos作为VALPP_RAM写数据的起始地址.
                                                                 复位默认值为1 */
        unsigned long  reserved_1           : 8;  /* bit[16-23]: 保留 */
        unsigned long  cpu_valpp_carry_type : 2;  /* bit[24-25]: 表示从CARRY_RAM到VALPP_RAM的一个BURST数据量指示
                                                                          00 ：表示搬移GMSK调制的SB解调数据
                                                                          10 ：表示搬移GMSK调制的NB解调数据
                                                                          11 ：表示搬移8PSK调制的NB解调数据
                                                                          其他：表示搬移GMSK调制的NB解调数据
                                                                 复位默认值为2’b10 */
        unsigned long  reserved_2           : 5;  /* bit[26-30]: 保留 */
        unsigned long  cpu_valpp_carry_en   : 1;  /* bit[31]   : 1表示VALPP_RAM 和 CARRY_RAM 数据搬移模式使能，当cpu_valpp_carry_mode配置为1时且cpu_valpp_carry_en配置为1时，解调模块往VALPP RAM写数据的同时，会将解调数据同时保存到CARRY RAM中.
                                                                 复位默认值为1 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_VALPP_CARRY_START 寄存器结构定义。地址偏移量:0x134，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_valpp_carry_start_imi : 1;  /* bit[0]   : VALPP_RAM 和 CARRY_RAM 数据搬移启动信号，只针对从CARRY_RAM到VALPP_RAM模式有效,逻辑自清零 */
        unsigned long  reserved                  : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_SAIC_CTRL 寄存器结构定义。地址偏移量:0x138，初值:0x02000101，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_saic_shift_pre   : 2;  /* bit[0-1]  : 判决反馈前，SAIC滤波输出值的移位值，11～13比特，默认值2’b01。该值用来调整性能偏差。
                                                                 2’b00: 11
                                                                 2’b01: 12
                                                                 2’b10: 13 */
        unsigned long  reserved_0           : 6;  /* bit[2-7]  : 保留 */
        unsigned long  cpu_saic_shift_aft   : 2;  /* bit[8-9]  : 判决反馈后，SAIC滤波输出值的移位值，10～12比特，默认值是2’b01。该值用来调整性能偏差。
                                                                 2’b00: 10;
                                                                 2’b01: 11;
                                                                 2’b10: 12; */
        unsigned long  reserved_1           : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_renew_toa_pos    : 2;  /* bit[16-17]: PHY在帧头位置配置下帧NB位置的调整量。
                                                                 配置值范围－1～1，补码表示。
                                                                 2’b11：表示下帧的NB较上帧调前一个符号；
                                                                 2’b01：表示下帧的NB较上帧调后一个符号；
                                                                 2’b00 ：表示不进行帧间调整。该信号在TDMA帧头后560qb自动清零。 */
        unsigned long  reserved_2           : 2;  /* bit[18-19]: 保留 */
        unsigned long  cpu_gmsk_ci_beta     : 2;  /* bit[20-21]: GMSK CI测量的调整系数，默认值是15(配置为2’b00)，可选值1和8
                                                                 2’b00:15
                                                                 2’b01: 8
                                                                 2’b10: 1
                                                                 默认值为2’b00 */
        unsigned long  reserved_3           : 2;  /* bit[22-23]: 保留 */
        unsigned long  cpu_cross_delta      : 3;  /* bit[24-26]: case(cpu_cross_delta)
                                                                 3’b000: R[i][i] = R[i][i] + (R[i][i] >>8) ;
                                                                 3’b001: R[i][i] = R[i][i] + (R[i][i] >>9) ;
                                                                 3’b010: R[i][i] = R[i][i] + (R[i][i] >>10) ;
                                                                 3’b011: R[i][i] = R[i][i] + (R[i][i] >>11) ;
                                                                 3’b100: R[i][i] = R[i][i];
                                                                 cpu_cross_delta信号是用于选择对角线元素的处理方式，默认值是3’b010。 */
        unsigned long  reserved_4           : 4;  /* bit[27-30]: 保留 */
        unsigned long  cpu_nb_info_rpt_mode : 1;  /* bit[31]   : 1 表示固定选择偶路，0表示选择最佳路 默认值为0。                     此信号用于选择上报的nb_pos_cpu, nb_pos_adj_cpu和C/I等。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MAX_DB_DATA_ENERGY_RPT 寄存器结构定义。地址偏移量:0x13C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  max_data_energy_cpu : 22; /* bit[0-21] : DummuBurst检测DATA最大能量上报 */
...
/*****************************************************************************
 ...
 结构说明  : ENG_WEIGHT 寄存器结构定义。地址偏移量:0x144，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_mid_finger_weight : 3;  /* bit[0-2]  : NB位置计算使用的中心径能量加权值，默认值0
                                                                  含义与sb的权值一致 */
        unsigned long  reserved_0            : 1;  /* bit[3]    : 保留 */
        unsigned long  cpu_rptpos_use_weight : 1;  /* bit[4]    : 上报的nb_pos和nb_pos_adj使用中心径能量加权算法，1为使用，默认值0 */
        unsigned long  reserved_1            : 3;  /* bit[5-7]  : 保留 */
        unsigned long  cpu_dempos_use_weight : 1;  /* bit[8]    : 解调位置继承使用中心径能量加权算法，1为使用，默认值0 */
        unsigned long  reserved_2            : 7;  /* bit[9-15] : 保留 */
        unsigned long  cpu_sb_finger_weight  : 3;  /* bit[16-18]: SB位置计算使用的中心径能量加权值，默认值0
                                                                  0表示权值为1；
                                                                  1表示权值为65/64；
                                                                  2表示权值为33/32；
                                                                  3表示权值为17/16；
                                                                  4表示权值为9/8；
                                                                  5表示权值为5/4； */
        unsigned long  reserved_3            : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : LS_DC_CPU 寄存器结构定义。地址偏移量:0x160，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  ls_dc_q_cpu : 8;  /* bit[0-7]  : 当前burst直流Q路上报 */
        unsigned long  reserved_0  : 8;  /* bit[8-15] : 保留 */
        unsigned long  ls_dc_i_cpu : 8;  /* bit[16-23]: 当前burst直流I路上报 */
        unsigned long  reserved_1  : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : LS_TOA_RPT_EN 寄存器结构定义。地址偏移量:0x164，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_ls_toa_rpt_en : 1;  /* bit[0]   : LS去直流TOA上报使能，0表示关闭，1表示打开。 */
        unsigned long  reserved          : 31; /* bit[1-31]: 保留 */
    } reg;
 ...
 ***======================================================================***/
/*****************************************************************************
 结构名    : GBBP_CPU_INT_STA_UNION
 结构说明  : CPU_INT_STA 寄存器结构定义。地址偏移量:0x200，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  int_state_cpu00 : 1;  /* bit[0]    : TDMA帧中断请求，1表示中断请求，0表示无中断请求，其他bit描述同此。 */
        unsigned long  int_state_cpu01 : 1;  /* bit[1]    : GTC PAGE中断请求 */
        unsigned long  int_state_cpu02 : 1;  /* bit[2]    : 同步搜索中断请求 */
        unsigned long  int_state_cpu03 : 1;  /* bit[3]    : 译码数据上报中断请求 */
        unsigned long  int_state_cpu04 : 1;  /* bit[4]    : 时隙0中断请求,1有效 */
        unsigned long  int_state_cpu05 : 1;  /* bit[5]    : 时隙1中断请求 */
        unsigned long  int_state_cpu06 : 1;  /* bit[6]    : 时隙2中断请求 */
        unsigned long  int_state_cpu07 : 1;  /* bit[7]    : 时隙3中断请求 */
        unsigned long  int_state_cpu08 : 1;  /* bit[8]    : 时隙4中断请求 */
        unsigned long  int_state_cpu09 : 1;  /* bit[9]    : 时隙5中断请求 */
        unsigned long  int_state_cpu10 : 1;  /* bit[10]   : 时隙6中断请求 */
        unsigned long  int_state_cpu11 : 1;  /* bit[11]   : 时隙7中断请求 */
        unsigned long  int_state_cpu12 : 1;  /* bit[12]   : 可编程中断0请求 */
        unsigned long  int_state_cpu13 : 1;  /* bit[13]   : 可编程中断1请求 */
        unsigned long  int_state_cpu14 : 1;  /* bit[14]   : 可编程中断2请求 */
        unsigned long  int_state_cpu15 : 1;  /* bit[15]   : 可编程中断3请求 */
        unsigned long  int_state_cpu16 : 1;  /* bit[16]   : 可编程中断4请求 */
        unsigned long  int_state_cpu17 : 1;  /* bit[17]   : 可编程中断5请求 */
        unsigned long  int_state_cpu18 : 1;  /* bit[18]   : 可编程中断6请求 */
        unsigned long  int_state_cpu19 : 1;  /* bit[19]   : 可编程中断7请求 */
        unsigned long  reserved_0      : 4;  /* bit[20-23]: 保留 */
        unsigned long  int_state_cpu24 : 1;  /* bit[24]   : 时钟测量中断 */
        unsigned long  reserved_1      : 3;  /* bit[25-27]: 保留 */
        unsigned long  int_state_cpu28 : 1;  /* bit[28]   : 电平测量结束中断 */
        unsigned long  int_state_cpu29 : 1;  /* bit[29]   : 解调结束中断 */
...
/*****************************************************************************
 结构名    : GBBP_CPU_INT_MASK_UNION
 结构说明  : CPU_INT_MASK 寄存器结构定义。地址偏移量:0x204，初值:0x310FFFFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_int_mask00 : 1;  /* bit[0]    : TDMA帧中断屏蔽信号，1表示中断请求屏蔽，0表示中断不屏蔽，其他bit描述同此。 */
        unsigned long  cpu_int_mask01 : 1;  /* bit[1]    : GTC PAGE中断屏蔽寄存器 */
        unsigned long  cpu_int_mask02 : 1;  /* bit[2]    : 同步搜索中断屏蔽寄存器 */
        unsigned long  cpu_int_mask03 : 1;  /* bit[3]    : 译码数据上报中断屏蔽寄存器 */
        unsigned long  cpu_int_mask04 : 1;  /* bit[4]    : 时隙0中断屏蔽寄存器，1有效 */
        unsigned long  cpu_int_mask05 : 1;  /* bit[5]    : 时隙1中断屏蔽寄存器 */
        unsigned long  cpu_int_mask06 : 1;  /* bit[6]    : 时隙2中断屏蔽寄存器 */
        unsigned long  cpu_int_mask07 : 1;  /* bit[7]    : 时隙3中断屏蔽寄存器 */
        unsigned long  cpu_int_mask08 : 1;  /* bit[8]    : 时隙4中断屏蔽寄存器 */
        unsigned long  cpu_int_mask09 : 1;  /* bit[9]    : 时隙5中断屏蔽寄存器 */
        unsigned long  cpu_int_mask10 : 1;  /* bit[10]   : 时隙6中断屏蔽寄存器 */
        unsigned long  cpu_int_mask11 : 1;  /* bit[11]   : 时隙7中断屏蔽寄存器 */
        unsigned long  cpu_int_mask12 : 1;  /* bit[12]   : 可编程中断0屏蔽寄存器 */
        unsigned long  cpu_int_mask13 : 1;  /* bit[13]   : 可编程中断1屏蔽寄存器 */
        unsigned long  cpu_int_mask14 : 1;  /* bit[14]   : 可编程中断2屏蔽寄存器 */
        unsigned long  cpu_int_mask15 : 1;  /* bit[15]   : 可编程中断3屏蔽寄存器 */
        unsigned long  cpu_int_mask16 : 1;  /* bit[16]   : 可编程中断4屏蔽寄存器 */
        unsigned long  cpu_int_mask17 : 1;  /* bit[17]   : 可编程中断5屏蔽寄存器 */
        unsigned long  cpu_int_mask18 : 1;  /* bit[18]   : 可编程中断6屏蔽寄存器 */
        unsigned long  cpu_int_mask19 : 1;  /* bit[19]   : 可编程中断7屏蔽寄存器 */
        unsigned long  reserved_0     : 4;  /* bit[20-23]: 保留 */
        unsigned long  cpu_int_mask24 : 1;  /* bit[24]   : 时钟测量中断屏蔽寄存器 */
        unsigned long  reserved_1     : 3;  /* bit[25-27]: 保留 */
        unsigned long  cpu_int_mask28 : 1;  /* bit[28]   : 电平测量结束中断屏蔽寄存器 */
        unsigned long  cpu_int_mask29 : 1;  /* bit[29]   : 解调结束中断屏蔽寄存器 */
        unsigned long  reserved_2     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : GBBP_CPU_INT_CLR_UNION
 结构说明  : CPU_INT_CLR 寄存器结构定义。地址偏移量:0x208，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_int_clr00 : 1;  /* bit[0]    : TDMA帧中断清零信号，1表示中断请求清除，0表示中断请求不清除，其他bit描述同此。 */
        unsigned long  cpu_int_clr01 : 1;  /* bit[1]    : GTC PAGE中断清零信号 */
        unsigned long  cpu_int_clr02 : 1;  /* bit[2]    : 同步搜索中断清零信号 */
        unsigned long  cpu_int_clr03 : 1;  /* bit[3]    : 译码数据上报中断清零信号 */
        unsigned long  cpu_int_clr04 : 1;  /* bit[4]    : 时隙0中断清零信号，1有效 */
        unsigned long  cpu_int_clr05 : 1;  /* bit[5]    : 时隙1中断清零信号 */
        unsigned long  cpu_int_clr06 : 1;  /* bit[6]    : 时隙2中断清零信号 */
        unsigned long  cpu_int_clr07 : 1;  /* bit[7]    : 时隙3中断清零信号 */
        unsigned long  cpu_int_clr08 : 1;  /* bit[8]    : 时隙4中断清零信号 */
        unsigned long  cpu_int_clr09 : 1;  /* bit[9]    : 时隙5中断清零信号 */
        unsigned long  cpu_int_clr10 : 1;  /* bit[10]   : 时隙6中断清零信号 */
        unsigned long  cpu_int_clr11 : 1;  /* bit[11]   : 时隙7中断清零信号 */
        unsigned long  cpu_int_clr12 : 1;  /* bit[12]   : 可编程中断0清零信号 */
        unsigned long  cpu_int_clr13 : 1;  /* bit[13]   : 可编程中断1清零信号 */
        unsigned long  cpu_int_clr14 : 1;  /* bit[14]   : 可编程中断2清零信号 */
        unsigned long  cpu_int_clr15 : 1;  /* bit[15]   : 可编程中断3清零信号 */
        unsigned long  cpu_int_clr16 : 1;  /* bit[16]   : 可编程中断4清零信号 */
        unsigned long  cpu_int_clr17 : 1;  /* bit[17]   : 可编程中断5清零信号 */
        unsigned long  cpu_int_clr18 : 1;  /* bit[18]   : 可编程中断6清零信号 */
        unsigned long  cpu_int_clr19 : 1;  /* bit[19]   : 可编程中断7清零信号 */
        unsigned long  reserved_0    : 4;  /* bit[20-23]: 保留 */
        unsigned long  cpu_int_clr24 : 1;  /* bit[24]   : 时钟测量中断清零信号 */
        unsigned long  reserved_1    : 3;  /* bit[25-27]: 保留 */
        unsigned long  cpu_int_clr28 : 1;  /* bit[28]   : 电平测量结束中断清零信号 */
        unsigned long  cpu_int_clr29 : 1;  /* bit[29]   : 解调结束中断清零信号 */
        unsigned long  reserved_2    : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : GBBP_DSP_INT_STA_UNION
 结构说明  : DSP_INT_STA 寄存器结构定义。地址偏移量:0x210，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  int_state_dsp00 : 1;  /* bit[0]    : TDMA帧中断请求，1表示中断请求，0表示无中断请求，其他bit描述同此。 */
        unsigned long  int_state_dsp01 : 1;  /* bit[1]    : GTC PAGE中断请求 */
        unsigned long  int_state_dsp02 : 1;  /* bit[2]    : 同步搜索中断请求 */
        unsigned long  int_state_dsp03 : 1;  /* bit[3]    : 译码数据上报中断请求 */
        unsigned long  int_state_dsp04 : 1;  /* bit[4]    : 时隙0中断请求，1有效 */
        unsigned long  int_state_dsp05 : 1;  /* bit[5]    : 时隙1中断请求 */
        unsigned long  int_state_dsp06 : 1;  /* bit[6]    : 时隙2中断请求 */
        unsigned long  int_state_dsp07 : 1;  /* bit[7]    : 时隙3中断请求 */
        unsigned long  int_state_dsp08 : 1;  /* bit[8]    : 时隙4中断请求 */
        unsigned long  int_state_dsp09 : 1;  /* bit[9]    : 时隙5中断请求 */
        unsigned long  int_state_dsp10 : 1;  /* bit[10]   : 时隙6中断请求 */
        unsigned long  int_state_dsp11 : 1;  /* bit[11]   : 时隙7中断请求 */
        unsigned long  int_state_dsp12 : 1;  /* bit[12]   : 可编程中断0请求 */
        unsigned long  int_state_dsp13 : 1;  /* bit[13]   : 可编程中断1请求 */
        unsigned long  int_state_dsp14 : 1;  /* bit[14]   : 可编程中断2请求 */
        unsigned long  int_state_dsp15 : 1;  /* bit[15]   : 可编程中断3请求 */
        unsigned long  int_state_dsp16 : 1;  /* bit[16]   : 可编程中断4请求 */
        unsigned long  int_state_dsp17 : 1;  /* bit[17]   : 可编程中断5请求 */
        unsigned long  int_state_dsp18 : 1;  /* bit[18]   : 可编程中断6请求 */
        unsigned long  int_state_dsp19 : 1;  /* bit[19]   : 可编程中断7请求 */
        unsigned long  reserved_0      : 4;  /* bit[20-23]: 保留 */
        unsigned long  int_state_dsp24 : 1;  /* bit[24]   : CTU异系统测量中断0 */
        unsigned long  int_state_dsp25 : 1;  /* bit[25]   : CTU异系统测量中断1 */
        unsigned long  int_state_dsp26 : 1;  /* bit[26]   : CTU异系统测量中断2 */
        unsigned long  int_state_dsp27 : 1;  /* bit[27]   : 时钟测量中断 */
        unsigned long  int_state_dsp28 : 1;  /* bit[28]   : 电平测量结束中断 */
        unsigned long  int_state_dsp29 : 1;  /* bit[29]   : 解调结束中断 */
...
/*****************************************************************************
 结构名    : GBBP_DSP_INT_MASK_UNION
 结构说明  : DSP_INT_MASK 寄存器结构定义。地址偏移量:0x214，初值:0x3F0FFFFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dsp_int_mask00 : 1;  /* bit[0]    : TDMA帧中断屏蔽信号，1表示中断请求屏蔽，0表示中断不屏蔽，其他bit描述同此。 */
        unsigned long  dsp_int_mask01 : 1;  /* bit[1]    : GTC PAGE中断屏蔽寄存器 */
        unsigned long  dsp_int_mask02 : 1;  /* bit[2]    : 同步搜索中断屏蔽寄存器 */
        unsigned long  dsp_int_mask03 : 1;  /* bit[3]    : 译码数据上报中断屏蔽寄存器 */
        unsigned long  dsp_int_mask04 : 1;  /* bit[4]    : 时隙0中断屏蔽寄存器，1有效 */
        unsigned long  dsp_int_mask05 : 1;  /* bit[5]    : 时隙1中断屏蔽寄存器 */
        unsigned long  dsp_int_mask06 : 1;  /* bit[6]    : 时隙2中断屏蔽寄存器 */
        unsigned long  dsp_int_mask07 : 1;  /* bit[7]    : 时隙3中断屏蔽寄存器 */
        unsigned long  dsp_int_mask08 : 1;  /* bit[8]    : 时隙4中断屏蔽寄存器 */
        unsigned long  dsp_int_mask09 : 1;  /* bit[9]    : 时隙5中断屏蔽寄存器 */
        unsigned long  dsp_int_mask10 : 1;  /* bit[10]   : 时隙6中断屏蔽寄存器 */
        unsigned long  dsp_int_mask11 : 1;  /* bit[11]   : 时隙7中断屏蔽寄存器 */
        unsigned long  dsp_int_mask12 : 1;  /* bit[12]   : 可编程中断0屏蔽寄存器 */
        unsigned long  dsp_int_mask13 : 1;  /* bit[13]   : 可编程中断1屏蔽寄存器 */
        unsigned long  dsp_int_mask14 : 1;  /* bit[14]   : 可编程中断2屏蔽寄存器 */
        unsigned long  dsp_int_mask15 : 1;  /* bit[15]   : 可编程中断3屏蔽寄存器 */
        unsigned long  dsp_int_mask16 : 1;  /* bit[16]   : 可编程中断4屏蔽寄存器 */
        unsigned long  dsp_int_mask17 : 1;  /* bit[17]   : 可编程中断5屏蔽寄存器 */
        unsigned long  dsp_int_mask18 : 1;  /* bit[18]   : 可编程中断6屏蔽寄存器 */
        unsigned long  dsp_int_mask19 : 1;  /* bit[19]   : 可编程中断7屏蔽寄存器 */
        unsigned long  reserved_0     : 4;  /* bit[20-23]: 保留 */
        unsigned long  dsp_int_mask24 : 1;  /* bit[24]   : CTU异系统测量中断0屏蔽寄存器 */
        unsigned long  dsp_int_mask25 : 1;  /* bit[25]   : CTU异系统测量中断1屏蔽寄存器 */
        unsigned long  dsp_int_mask26 : 1;  /* bit[26]   : CTU异系统测量中断2屏蔽寄存器 */
        unsigned long  dsp_int_mask27 : 1;  /* bit[27]   : 时钟测量中断屏蔽寄存器 */
        unsigned long  dsp_int_mask28 : 1;  /* bit[28]   : 电平测量结束中断屏蔽寄存器 */
        unsigned long  dsp_int_mask29 : 1;  /* bit[29]   : 解调结束中断屏蔽寄存器 */
        unsigned long  reserved_1     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 结构名    : GBBP_DSP_INT_CLR_UNION
 结构说明  : DSP_INT_CLR 寄存器结构定义。地址偏移量:0x218，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dsp_int_clr00 : 1;  /* bit[0]    : TDMA帧中断清零信号，1表示中断请求清除，0表示中断请求不清除，其他bit描述同此。 */
        unsigned long  dsp_int_clr01 : 1;  /* bit[1]    : GTC PAGE中断清零信号 */
        unsigned long  dsp_int_clr02 : 1;  /* bit[2]    : 同步搜索中断清零信号 */
        unsigned long  dsp_int_clr03 : 1;  /* bit[3]    : 译码数据上报中断清零信号 */
        unsigned long  dsp_int_clr04 : 1;  /* bit[4]    : 时隙0中断清零信号，1有效 */
        unsigned long  dsp_int_clr05 : 1;  /* bit[5]    : 时隙1中断清零信号 */
        unsigned long  dsp_int_clr06 : 1;  /* bit[6]    : 时隙2中断清零信号 */
        unsigned long  dsp_int_clr07 : 1;  /* bit[7]    : 时隙3中断清零信号 */
        unsigned long  dsp_int_clr08 : 1;  /* bit[8]    : 时隙4中断清零信号 */
        unsigned long  dsp_int_clr09 : 1;  /* bit[9]    : 时隙5中断清零信号 */
        unsigned long  dsp_int_clr10 : 1;  /* bit[10]   : 时隙6中断清零信号 */
        unsigned long  dsp_int_clr11 : 1;  /* bit[11]   : 时隙7中断清零信号 */
        unsigned long  dsp_int_clr12 : 1;  /* bit[12]   : 可编程中断0清零信号 */
        unsigned long  dsp_int_clr13 : 1;  /* bit[13]   : 可编程中断1清零信号 */
        unsigned long  dsp_int_clr14 : 1;  /* bit[14]   : 可编程中断2清零信号 */
        unsigned long  dsp_int_clr15 : 1;  /* bit[15]   : 可编程中断3清零信号 */
        unsigned long  dsp_int_clr16 : 1;  /* bit[16]   : 可编程中断4清零信号 */
        unsigned long  dsp_int_clr17 : 1;  /* bit[17]   : 可编程中断5清零信号 */
        unsigned long  dsp_int_clr18 : 1;  /* bit[18]   : 可编程中断6清零信号 */
        unsigned long  dsp_int_clr19 : 1;  /* bit[19]   : 可编程中断7清零信号 */
        unsigned long  reserved_0    : 4;  /* bit[20-23]: 保留 */
        unsigned long  dsp_int_clr24 : 1;  /* bit[24]   : CTU异系统测量中断0清零信号 */
        unsigned long  dsp_int_clr25 : 1;  /* bit[25]   : CTU异系统测量中断1清零信号 */
        unsigned long  dsp_int_clr26 : 1;  /* bit[26]   : CTU异系统测量中断2清零信号 */
        unsigned long  dsp_int_clr27 : 1;  /* bit[27]   : 时钟测量中断清零信号 */
        unsigned long  dsp_int_clr28 : 1;  /* bit[28]   : 电平测量结束中断清零信号 */
        unsigned long  dsp_int_clr29 : 1;  /* bit[29]   : 解调结束中断清零信号 */
        unsigned long  reserved_1    : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_LUISE_AFC 寄存器结构定义。地址偏移量:0x258，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_luise_afc_en   : 1;  /* bit[0]    : Luise鉴频使能 */
        unsigned long  reserved_0         : 7;  /* bit[1-7]  : 保留 */
        unsigned long  cpu_single_tcxo_en : 1;  /* bit[8]    : 单TCXO使能信号，用于控制搜索前数据是否经过NCO纠偏 */
        unsigned long  reserved_1         : 7;  /* bit[9-15] : 保留 */
        unsigned long  luise_fed          : 16; /* bit[16-31]: Luise鉴频优化算法计算得到的频偏调整值 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_GDRX_SLEEP_POINT 寄存器结构定义。地址偏移量:0x25C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_TRANS_COMP 寄存器结构定义。地址偏移量:0x260，初值:0x00000010，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_trans_comp : 10; /* bit[0-9]  : 定时信息从ON区传输到OFF区，软件配置的定时信息补偿参数。此值要大于全部数据传输时延，单位QB，默认配置16QB。 */
...
/*****************************************************************************
 ...
 结构说明  : ADDR_RX_IQ_MISMATCH_REG0 寄存器结构定义。地址偏移量:0x270，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_iq_comp_amp0   : 10; /* bit[0-9]  : 第0组幅度校准软件配置值A；10比特有符号数。 */
        unsigned long  reserved_0         : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_iq_comp_phase0 : 11; /* bit[16-26]: 第0组相位校准软件配置值P；11比特有符号数。 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_RX_IQ_MISMATCH_REG1 寄存器结构定义。地址偏移量:0x274，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_iq_comp_amp1   : 10; /* bit[0-9]  : 第1组幅度校准软件配置值A；10比特有符号数。 */
        unsigned long  reserved_0         : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_iq_comp_phase1 : 11; /* bit[16-26]: 第1组相位校准软件配置值P；11比特有符号数。 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_RX_IQ_MISMATCH_REG2 寄存器结构定义。地址偏移量:0x278，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_iq_comp_amp2   : 10; /* bit[0-9]  : 第2组幅度校准软件配置值A；10比特有符号数。 */
        unsigned long  reserved_0         : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_iq_comp_phase2 : 11; /* bit[16-26]: 第2组相位校准软件配置值P；11比特有符号数。 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_RX_IQ_MISMATCH_REG3 寄存器结构定义。地址偏移量:0x27C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_iq_comp_amp3   : 10; /* bit[0-9]  : 第3组幅度校准软件配置值A；10比特有符号数。 */
        unsigned long  reserved_0         : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_iq_comp_phase3 : 11; /* bit[16-26]: 第3组相位校准软件配置值P；11比特有符号数。 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_HD35_PARA_REG 寄存器结构定义。地址偏移量:0x280，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_hd35_page_switch_en : 1;  /* bit[0]    : HD3/5初始配置参数配置RAM乒乓访问使能；1表示允许乒乓访问，0表示固定访问乒RAM空间；当该信号为1时，逻辑内部在TDMA帧头自动切换乒乓标志。 */
        unsigned long  reserved_0              : 15; /* bit[1-15] : 保留 */
        unsigned long  cpu_hd35_cal_bypass     : 1;  /* bit[16]   : HD3/5谐波消除功能旁路；0：表示谐波消除功能不旁路，但是否进行谐波消除还需要参考gsp_hd35_cal_en配置情况。1：表示谐波消除功能旁路，与V8R1版本时序完全一致。 */
        unsigned long  reserved_1              : 15; /* bit[17-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_SPI_RF_CFG 寄存器结构定义。地址偏移量:0x368，初值:0x80000400，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_spi_rd_start_addr  : 8;  /* bit[0-7]  : CPU接口配置SPI串口待发数据在SPI DATA RAM的起始位置，复位默认值为8'd0 */
        unsigned long  cpu_spi_trans_data_num : 5;  /* bit[8-12] : CPU接口配置本次需要发送的SPI串口数据数，00001表示一个数，10000表示16个数，复位默认值为5'b00100 */
        unsigned long  reserved               : 18; /* bit[13-30]: 保留 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_SPI_RF_RD 寄存器结构定义。地址偏移量:0x36C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_spi_rd_en : 1;  /* bit[0]   : CPU启动SPI数据发送脉冲 */
        unsigned long  reserved      : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_LINE_CTRL 寄存器结构定义。地址偏移量:0x364，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gtc_line_ctrl       : 28; /* bit[0-27] : 公共线控CPU接口配置，具体分配由NV项决定。 */
        unsigned long  reserved                : 3;  /* bit[28-30]: 保留 */
        unsigned long  cpu_gtc_line_ctrl_wr_en : 1;  /* bit[31]   : 28bit公共线控信号CPU写使能指示信号。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GTC_GSP_LINE_STATE_RPT 寄存器结构定义。地址偏移量:0x384，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_gsp_line_ctrl : 28; /* bit[0-27] : 公共线控实际线控状态，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN1_CPU 寄存器结构定义。地址偏移量:0x460，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_1d     : 3;  /* bit[0-2]  : 最近一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_1d          : 12; /* bit[8-19] : 最近一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_1d     : 3;  /* bit[24-26]: 最近一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_1d : 1;  /* bit[31]   : 最近一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN2_CPU 寄存器结构定义。地址偏移量:0x464，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_2d     : 3;  /* bit[0-2]  : 次近一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_2d          : 12; /* bit[8-19] : 次近一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_2d     : 3;  /* bit[24-26]: 次近一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_2d : 1;  /* bit[31]   : 次近一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN3_CPU 寄存器结构定义。地址偏移量:0x468，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_3d     : 3;  /* bit[0-2]  : 次次近一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_3d          : 12; /* bit[8-19] : 次次近一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_3d     : 3;  /* bit[24-26]: 次次近一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_3d : 1;  /* bit[31]   : 次次近一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN4_CPU 寄存器结构定义。地址偏移量:0x46C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_4d     : 3;  /* bit[0-2]  : '第四近一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_4d          : 12; /* bit[8-19] : '第四近一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_4d     : 3;  /* bit[24-26]: '第四近一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_4d : 1;  /* bit[31]   : 第四近一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_SOFT_RST 寄存器结构定义。地址偏移量:0x350，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gcipher_rst          : 1;  /* bit[0]    : 加解密模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gmod_rst             : 1;  /* bit[1]    : 上行调制模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gulcod_rst           : 1;  /* bit[2]    : 上行编码模块（除上行编码map模块）软复位信号，写1该模块复位。Bit2与bit3共同构成上行编码模块控制。 */
        unsigned long  cpu_gulcod_map_rst       : 1;  /* bit[3]    : 上行编码模块中map模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gagc_rst             : 1;  /* bit[4]    : 自动增益控制模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gaci_rst             : 1;  /* bit[5]    : 邻频检测模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gch_rst              : 1;  /* bit[6]    : 信道滤波模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gdldec_vtb_top_rst   : 1;  /* bit[7]    : 下行译码模块中viterbi模块软复位信号，写1该模块复位。bit7与bit8、bit9、bit10共同构成下行译码模块控制。 */
        unsigned long  cpu_gdldec_int_dpc_rst   : 1;  /* bit[8]    : 下行译码模块中去交织/交织、去打孔/打孔模块软复位信号，写1该模块复位。bit7与bit8、bit9、bit10共同构成下行译码模块控制。 */
        unsigned long  cpu_gdldec_valpp_ram_rst : 1;  /* bit[9]    : 下行译码模块中解调、译码软值存储/读取模块软复位信号，写1该模块复位。bit7与bit8、bit9、bit10共同构成下行译码模块控制。 */
        unsigned long  cpu_gdldec_top_rst       : 1;  /* bit[10]   : 下行译码模块中除去bit7、bit8、bit9剩下的其余模块软复位信号，写1该模块复位。bit7与bit8、bit9、bit10共同构成下行译码模块控制。 */
        unsigned long  cpu_gdldem_srch_rst      : 1;  /* bit[11]   : 下行解调模块（包括搜索部分和所有解调相关部分）软复位信号，写1该模块复位。 */
        unsigned long  cpu_gmod_post_rst        : 1;  /* bit[12]   : 上行调制后处理模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gapc_rst             : 1;  /* bit[13]   : 上行APC模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gtc_rst              : 1;  /* bit[14]   : GTC模块软复位信号，写1该模块复位。
                                                                     注意：该复位信号配置后，将会导致专用线控和公共线控均复位至0,。 */
        unsigned long  cpu_gtc_timing_rst       : 1;  /* bit[15]   : GTC定时模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_gdldem_prepro_rst    : 1;  /* bit[16]   : 解调预处理模块软复位信号，写1该模块复位。 */
        unsigned long  cpu_dump_g_rst           : 1;  /* bit[17]   : 采数模块软复位信号，写1该模块复位。 */
        unsigned long  reserved                 : 14; /* bit[18-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_CLK_CTRL 寄存器结构定义。地址偏移量:0x354，初值:0x00017FFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gcipher_clk_ctrl          : 1;  /* bit[0]    : 加解密模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gmod_clk_ctrl             : 1;  /* bit[1]    : 上行调制模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gulcod_clk_ctrl           : 1;  /* bit[2]    : 上行编码模块（除了上行编码map模块）CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。bit2与bit3构成上行编码模块。 */
        unsigned long  cpu_gulcod_map_clk_ctrl       : 1;  /* bit[3]    : 上行编码map模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gagc_clk_ctrl             : 1;  /* bit[4]    : 自动增益控制模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gaci_clk_ctrl             : 1;  /* bit[5]    : 邻频检测模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gch_clk_ctrl              : 1;  /* bit[6]    : 信道滤波莫开CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gdldec_vtb_top_clk_ctrl   : 1;  /* bit[7]    : 下行译码模块中的viterbi模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。bit7、bit8、bit9、bit10构成下行译码模块。 */
        unsigned long  cpu_gdldec_int_dpc_clk_ctrl   : 1;  /* bit[8]    : 下行译码模块中的交织/去交织、打孔/去打孔模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gdldec_valpp_ram_clk_ctrl : 1;  /* bit[9]    : 下行译码模块中的解调、译码软值存储/读取模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gdldec_top_clk_ctrl       : 1;  /* bit[10]   : 下行译码模块除了bit7、bit8、bit9剩下模块的CPU控制时钟生效指示，1表示有时钟，0表示没有时钟。 */
        unsigned long  cpu_gdldem_srch_clk_ctrl      : 1;  /* bit[11]   : 下行解调模块（包括搜索部分和所有解调相关部分）CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gmod_post_clk_ctrl        : 1;  /* bit[12]   : 上行调制后处理模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gapc_clk_ctrl             : 1;  /* bit[13]   : 上行APC模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  cpu_gtc_clk_ctrl              : 1;  /* bit[14]   : GTC模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  reserved_0                    : 1;  /* bit[15]   : 保留 */
        unsigned long  cpu_gdldem_prepro_clk_ctrl    : 1;  /* bit[16]   : 解调预处理模块CPU控制时钟生效指示，1表示有时钟；0表示没有时钟。 */
        unsigned long  reserved_1                    : 15; /* bit[17-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_CLK_MODE_SEL 寄存器结构定义。地址偏移量:0x358，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gcipher_ckg_mode_sel          : 1;  /* bit[0]    : 加解密模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gmod_ckg_mode_sel             : 1;  /* bit[1]    : 上行调制模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gulcod_ckg_mode_sel           : 1;  /* bit[2]    : 上行编码（除了map编码模块）模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。bit2与bit3构成上行编码模块。 */
        unsigned long  cpu_gulcod_map_ckg_mode_sel       : 1;  /* bit[3]    : 上行编码map编码模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gagc_ckg_mode_sel             : 1;  /* bit[4]    : 自动增益控制模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gaci_ckg_mode_sel             : 1;  /* bit[5]    : 邻频检测模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gch_ckg_mode_sel              : 1;  /* bit[6]    : 信道滤波模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gdldec_vtb_top_ckg_mode_sel   : 1;  /* bit[7]    : 下行译码模块中viterbi模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。bit7、bit8、bit9、bit10构成下行译码模块控制。 */
        unsigned long  cpu_gdldec_int_dpc_ckg_mode_sel   : 1;  /* bit[8]    : 下行译码模块中交织/去交织、打孔/去打孔模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gdldec_valpp_ram_ckg_mode_sel : 1;  /* bit[9]    : 下行译码模块中解调、译码软值存储/读取模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gdldec_top_ckg_mode_sel       : 1;  /* bit[10]   : 下行译码模块中除了bit7、bit8、bit9剩下的模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
        unsigned long  cpu_gdldem_srch_ckg_mode_sel      : 1;  /* bit[11]   : 下行解调（包括搜索部分和解调所有相关部分）模块自动时钟门控orCPU时钟门控选择信号，1表示CPU控制门控；0表示自动时钟门控。 */
...
/*****************************************************************************
 ...
 结构说明  : ADDR_CPU_AUTO_CLK_BYPASS 寄存器结构定义。地址偏移量:0x35C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gcipher_ckg_bypass          : 1;  /* bit[0]    : 加解密模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gmod_ckg_bypass             : 1;  /* bit[1]    : 上行调制模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gulcod_ckg_bypass           : 1;  /* bit[2]    : 上行编码模块（除去map编码模块）时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。bit2与bit3构成上行编码模块。 */
        unsigned long  cpu_gulcod_map_ckg_bypass       : 1;  /* bit[3]    : 上行编码模块中map模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gagc_ckg_bypass             : 1;  /* bit[4]    : 自动增益控制模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gaci_ckg_bypass             : 1;  /* bit[5]    : 邻频检测模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gch_ckg_bypass              : 1;  /* bit[6]    : 信道滤波模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gdldec_vtb_top_ckg_bypass   : 1;  /* bit[7]    : 下行译码模块中viterbi模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。bit7、bit8、bit9、bit10构成下行译码模块。 */
        unsigned long  cpu_gdldec_int_dpc_ckg_bypass   : 1;  /* bit[8]    : 下行译码模块中交织/去角质、打孔/去打孔模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gdldec_valpp_ram_ckg_bypass : 1;  /* bit[9]    : 下行译码模块中解调、译码软值存储/读取模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gdldec_top_ckg_bypass       : 1;  /* bit[10]   : 下行译码模块中除了bit、bit8、bit9剩下的模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gdldem_srch_ckg_bypass      : 1;  /* bit[11]   : 下行解调（包括搜索部分和所有解调相关部分）模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gmod_post_ckg_bypass        : 1;  /* bit[12]   : 上行调制后处理模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gapc_ckg_bypass             : 1;  /* bit[13]   : 上行APC模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  cpu_gtc_ckg_bypass              : 1;  /* bit[14]   : GTC模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  reserved_0                      : 1;  /* bit[15]   : 保留 */
        unsigned long  cpu_gdldem_prepro_ckg_bypass    : 1;  /* bit[16]   : 下行解调预处理模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  dump_clkgate_bypass_g           : 1;  /* bit[17]   : 采数模块时钟门控功能bypass，1表示时钟常开；0表示使用自动时钟门控或者CPU控制时钟门控。 */
        unsigned long  reserved_1                      : 14; /* bit[18-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GTC_CFG 寄存器结构定义。地址偏移量:0x360，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_page_switch_en_imi   : 1;  /* bit[0]   : 0：不切换指令RAM页，1：乒乓切换指令RAM页。复位后第一次配置时应该切换指令页。 */
        unsigned long  cpu_gtc_start_imi        : 1;  /* bit[1]   : 写1启动指令页执行，内部产生一个104M时钟脉冲，自清零，写0无意义。 */
        unsigned long  gtc_auto_run_imi         : 1;  /* bit[2]   : GTC指令在TDMA帧头处自动执行使能，默认为0。 */
        unsigned long  cpu_gtc_hold_page        : 1;  /* bit[3]   : 1表示允许修改正在执行的GTC指令页，需要修改时将其置1，修改完成后置0。 */
        unsigned long  gtc_pro_en_imi           : 1;  /* bit[4]   : GTC模块工作使能信号，先配置为该信号为高，然后再启动GTC。 */
        unsigned long  reserved_0               : 3;  /* bit[5-7] : 保留 */
        unsigned long  cpu_drx_test_mode_en_imi : 1;  /* bit[8]   : 1表示DRX测试模式使能，此时GTC时钟应不关闭，用于DRX唤醒后的定时维护情况的比对。正常使用下该信号应该被置0，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : GTC_STATE_RPT 寄存器结构定义。地址偏移量:0x374，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_idle           : 1;  /* bit[0]   : 1：表示GTC没有GTC指令执行；0表示GTC正在执行，测试用。 */
        unsigned long  gtc_wait           : 1;  /* bit[1]   : 1：表示GTC处于hold或者start状态，测试用。 */
        unsigned long  gtc_run            : 1;  /* bit[2]   : 1：表示GTC处于run运行状态，测试用。 */
        unsigned long  reserved_0         : 1;  /* bit[3]   : 保留 */
        unsigned long  gtc_page_switch_en : 1;  /* bit[4]   : GTC指令RAM乒乓切换使能上报，测试用。 */
        unsigned long  gtc_page_sel       : 1;  /* bit[5]   : 当前GTC指令RAM的乒乓标志上报，测试用。 */
...
/*****************************************************************************
 ...
 结构说明  : GTC_FRM_OFFSET_RPT 寄存器结构定义。地址偏移量:0x37C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_frm_offset : 13; /* bit[0-12] : TDMA定时与TimeBase时间偏差，单位qb，若frm_offset为N，则TimeBase计数到N-1且GTC内部计数器frac_cnt计数到95时，下一拍TDMA帧号加1，测试用。 */
        unsigned long  reserved       : 19; /* bit[13-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GTC_FRM_IT_OFFSET_RPT 寄存器结构定义。地址偏移量:0x380，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : CPU_GTC_T1_T2_T3_CNG 寄存器结构定义。地址偏移量:0x388，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gtc_t1_cnt : 11; /* bit[0-10] : 精简帧号维护机制中的T1初始值，该参数值与cpu_gtc_t1_cnt,cpu_gtc_t3_cnt,cpu_gtc_fn_low,cpu_gtc_fn_high一起用于GTC内部帧号维护寄存器的初始化，在GTC的TDMA帧边界处生效，所以应配置为下一帧的帧号的T1值。 */
        unsigned long  reserved_0     : 5;  /* bit[11-15]: 保留 */
        unsigned long  cpu_gtc_t2_cnt : 5;  /* bit[16-20]: 精简帧号维护机制中的T2初始值，该参数值与cpu_gtc_t2_cnt,cpu_gtc_t3_cnt,cpu_gtc_fn_low,cpu_gtc_fn_high一起用于GTC内部帧号维护寄存器的初始化，在GTC的TDMA帧边界处生效，所以应配置为下一帧的帧号的T1值。 */
        unsigned long  reserved_1     : 3;  /* bit[21-23]: 保留 */
        unsigned long  cpu_gtc_t3_cnt : 6;  /* bit[24-29]: 精简帧号维护机制中的T2初始值，该参数值与cpu_gtc_t1_cnt,cpu_gtc_t2_cnt,cpu_gtc_fn_low,cpu_gtc_fn_high一起用于GTC内部帧号维护寄存器的初始化，在GTC的TDMA帧边界处生效，所以应配置为下一帧的帧号的T1值。 */
        unsigned long  reserved_2     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GTC_T1_T2_T3_RPT_CPU 寄存器结构定义。地址偏移量:0x38C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 ...
 结构说明  : CPU_GTC_FRM_OFFSET_CFG 寄存器结构定义。地址偏移量:0x390，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  cpu_gtc_frm_wr_en_imi : 1;  /* bit[31]   : cpu_gtc_frm_offset
                                                                  cpu_gtc_frm_it_offset
                                                                  立即生效指示信号，逻辑自清零。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GTC_FN_CNG 寄存器结构定义。地址偏移量:0x394，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gtc_fn_low       : 11; /* bit[0-10] : CPU配置TDMA帧号低位0~26*51-1循环计数，CPU配置后，在帧边界处生效，所以应配置为下一帧的帧号。 */
        unsigned long  reserved_0           : 5;  /* bit[11-15]: 保留 */
        unsigned long  cpu_gtc_fn_high      : 11; /* bit[16-26]: CPU配置TDMA帧号高位0~2047，低位计满后，高位加1。CPU配置后，在帧边界处生效，所以应配置为下一帧的帧号。 */
        unsigned long  reserved_1           : 4;  /* bit[27-30]: 保留 */
        unsigned long  cpu_gtc_fn_wr_en_imi : 1;  /* bit[31]   : 帧号初始化信号，1有效，逻辑自清零。当T1、T2、T3、fn_low、fn_high、都写入后该信号才可以置1。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GTC_FN_RPT 寄存器结构定义。地址偏移量:0x398，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_fn_low  : 11; /* bit[0-10] : GTC此时帧号低位。 */
        unsigned long  reserved_0  : 5;  /* bit[11-15]: 保留 */
        unsigned long  gtc_fn_high : 11; /* bit[16-26]: GTC此时帧号高位。 */
        unsigned long  reserved_1  : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GTC_QB_RPT 寄存器结构定义。地址偏移量:0x39C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_tdma_qb_imi  : 13; /* bit[0-12] : 当前时刻TDMA的QB计数值，0~4999。 */
        unsigned long  reserved_0       : 3;  /* bit[13-15]: 保留 */
        unsigned long  gtc_timebase_imi : 13; /* bit[16-28]: 绝对时标QB上报，范围：0~4999，对应一帧的长度，该值只与复位时刻有关，测试用。 */
        unsigned long  reserved_1       : 3;  /* bit[29-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TIMEBASE_RPT 寄存器结构定义。地址偏移量:0x3A8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_timebase_imi    : 13; /* bit[0-12] : 绝对时标QB上报，范围：0~4999，对应一帧的长度，该值只与复位时刻有关，测试用。 */
        unsigned long  reserved_0          : 3;  /* bit[13-15]: 保留 */
        unsigned long  gtc_timebase_fn_low : 11; /* bit[16-26]: 绝对时标帧号上报，该值变化时刻在gtc_timebase_qb为4999处，计数范围0~26*51-1，测试用。 */
        unsigned long  reserved_1          : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_BLER_BER_CLR 寄存器结构定义。地址偏移量:0x300，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_bler_clr_imi : 1;  /* bit[0]   : 接收质量上报BLER清零信号，脉冲信号，cpu置1逻辑自清零 */
        unsigned long  reserved_0       : 3;  /* bit[1-3] : 保留 */
        unsigned long  cpu_ber_clr_imi  : 1;  /* bit[4]   : 接收质量上报BER清零信号，脉冲信号，cpu置1，逻辑自清零 */
        unsigned long  reserved_1       : 3;  /* bit[5-7] : 保留 */
        unsigned long  cpu_bler_mode    : 1;  /* bit[8]   : BLER统计模式控制，0表示每次译码CRC结果都参与BLER统计（即是HEAD，DATA都统计）
                                                            1表示只统计每次DATA的译码CRC结果BLER值 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_AMR_CB_INDEX 寄存器结构定义。地址偏移量:0x304，初值:0x0F0E0D0C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_amr0_cb_index : 7;  /* bit[0-6]  : AMR语音激活集合内codec_mode=00对应的AMR语音帧cb_index */
        unsigned long  reserved_0        : 1;  /* bit[7]    : 保留 */
        unsigned long  cpu_amr1_cb_index : 7;  /* bit[8-14] : AMR语音激活集合内codec_mode=01对应的AMR语音帧cb_index */
        unsigned long  reserved_1        : 1;  /* bit[15]   : 保留 */
        unsigned long  cpu_amr2_cb_index : 7;  /* bit[16-22]: AMR语音激活集合内codec_mode=10对应的AMR语音帧cb_index */
        unsigned long  reserved_2        : 1;  /* bit[23]   : 保留 */
        unsigned long  cpu_amr3_cb_index : 7;  /* bit[24-30]: AMR语音激活集合内codec_mode=11对应的AMR语音帧cb_index */
...
/*****************************************************************************
 ...
 结构说明  : CPU_AMR_ACTIVE_SET_NUM 寄存器结构定义。地址偏移量:0x308，初值:0x00000003，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_amr_active_set_num            : 2;  /* bit[0-1]  : AMR语音激活集内有效语音帧类型个数
                                                                              0 表示1个
                                                                              1 表示2个
                                                                              2 表示3个
                                                                              3 表示4个
                                                                              （当业务类型为GMSK WBAMR时，配置范围为0～2） */
        unsigned long  reserved_0                        : 2;  /* bit[2-3]  : 保留 */
        unsigned long  cpu_speech_bfi_thres              : 4;  /* bit[4-7]  : 语音帧BFI相关译码判决门限，配置范围0～8 */
        unsigned long  reserved_1                        : 8;  /* bit[8-15] : 保留 */
        unsigned long  cpu_amr_active_set_num_upflag_imi : 1;  /* bit[16]   : 当AMR激活集个数发生变化时，需要配置该信号为1 */
...
/*****************************************************************************
 ...
 结构说明  : DB_BLER_ERR_RPT 寄存器结构定义。地址偏移量:0x484，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  rxqual_db_bler_err : 16; /* bit[0-15] : DummyBurst导致误码计数上报 */
...
/*****************************************************************************
 ...
 结构说明  : SB_BLER_ERR_RPT 寄存器结构定义。地址偏移量:0x488，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  rxqual_sb_bler_err : 8;  /* bit[0-7] : SB误码计数上报 */
...
/*****************************************************************************
 ...
 结构说明  : DATA_BLER_ERR_RPT 寄存器结构定义。地址偏移量:0x48C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  rxqual_data_bler_err : 16; /* bit[0-15] : EDGE业务DATA误码计数上报 */
        unsigned long  reserved             : 16; /* bit[16-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG1 寄存器结构定义。地址偏移量:0x320，初值:0x10E40000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  conv_rate        : 4;  /* bit[0-3]  : 卷积编码率指示，
                                                             2=1/2,3=1/3,4=1/4……6=1/6，测试用 */
        unsigned long  conv_depth       : 1;  /* bit[4]    : 卷积编码记忆深度，0: 4;  1: 6，测试用 */
        unsigned long  vtb_codec_len    : 10; /* bit[5-14] : 码块译码后数据长度，即编码前数据长度，测试用 */
        unsigned long  vtb_cb_coded_len : 11; /* bit[15-25]: 码块编码后数据长度，测试用 */
        unsigned long  codec_type       : 2;  /* bit[26-27]: 码块译码类型，
                                                             00从0状态开始，到0状态结束；
                                                             01从0状态开始，到非0状态结束；
                                                             10从非0状态开始，到0状态结束；
                                                             11非0状态开始，到非0状态结束；
                                                             测试用 */
        unsigned long  punc_means       : 1;  /* bit[28]   : 打孔方式选择,0表示打孔，1表示不打孔，测试用 */
        unsigned long  vtb_codec_en     : 1;  /* bit[29]   : 1表示有卷积编码过程，测试用 */
        unsigned long  reserved         : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG2 寄存器结构定义。地址偏移量:0x324，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  g0_poly         : 7;  /* bit[0-6]  : 编码生成多项式0，测试用 */
        unsigned long  g1_poly         : 7;  /* bit[7-13] : 编码生成多项式1，测试用 */
        unsigned long  g2_poly         : 7;  /* bit[14-20]: 编码生成多项式2，测试用 */
        unsigned long  g3_poly         : 7;  /* bit[21-27]: 编码生成多项式3，测试用 */
        unsigned long  crc_handle_flag : 2;  /* bit[28-29]: CRC预处理业务标志信号
                                                            00 无预处理
                                                            01 重排序
                                                            10 USF预处理_1
                                                            11 USF预处理_2
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG3 寄存器结构定义。地址偏移量:0x328，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  g4_poly            : 7;  /* bit[0-6]  : 编码生成多项式4，测试用 */
        unsigned long  g5_poly            : 7;  /* bit[7-13] : 编码生成多项式5，测试用 */
        unsigned long  denominator_g_poly : 7;  /* bit[14-20]: 分母位置的编码生成多项式，测试用 */
        unsigned long  punc_rom_index     : 7;  /* bit[21-27]: 打孔图样的打孔表序号，测试用 */
        unsigned long  g_comb_index       : 4;  /* bit[28-31]: 编码生成多项式组合序号，测试用 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG4 寄存器结构定义。地址偏移量:0x32C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  interleaving_formula_index : 5;  /* bit[0-4]  : 交织公式序号，测试用 */
        unsigned long  vtb_k_start_pos            : 11; /* bit[5-15] : 卷积码块在交织中起始bit序号 */
        unsigned long  vtb_k_end_pos              : 11; /* bit[16-26]: 卷积码块在交织中结束bit序号，测试用 */
        unsigned long  interleave_en              : 1;  /* bit[27]   : 1表示有交织过程，测试用 */
        unsigned long  crc_exist_flag             : 1;  /* bit[28]   : 1表示存在CRC校验过程，测试用 */
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG5 寄存器结构定义。地址偏移量:0x330，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  infom_end_pos         : 10; /* bit[0-9]  : 信息bit结束位置，测试用 */
        unsigned long  reserved_0            : 1;  /* bit[10]   : 保留 */
        unsigned long  class2_bit_exist_flag : 1;  /* bit[11]   : 1表示存在CLASS2 bit，测试用 */
        unsigned long  class2_bit_start_pos  : 9;  /* bit[12-20]: CLASS2 bit起始位置，测试用 */
        unsigned long  trch_sort             : 2;  /* bit[21-22]: 编码业务大类指示
                                                                  00 非AFS和AHS的cs业务
                                                                  01 AFS或者AHS业务
                                                                  10 GPRS业务
                                                                  11 EGPRS业务
                                                                  测试用 */
        unsigned long  zero_fill_type        : 3;  /* bit[23-25]: 尾比特补零处理模式：
                                                                  bit25: 1表示存在填零处理
                                                                         0表示不存在填零处理
                                                                  bit24～bit23：
                                                                  00表示填4个零
                                                                  ...
                                                                  11表示填32个零
                                                                  测试用 */
        unsigned long  crc_type              : 4;  /* bit[26-29]: CRC长度指示，测试用 */
        unsigned long  reserved_1            : 1;  /* bit[30]   : 保留 */
        unsigned long  tail_exist_flag       : 1;  /* bit[31]   : 1表示存在尾比特填充操作
                                                                  0表示不存在
                                                                  ，测试用 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG6 寄存器结构定义。地址偏移量:0x334，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  punc_rom_base_addr : 12; /* bit[0-11] : 码块打孔信息存放起始位置，测试用 */
        unsigned long  cb_index           : 7;  /* bit[12-18]: 码块序号，测试用 */
        unsigned long  reserved_0         : 1;  /* bit[19]   : 保留 */
        unsigned long  dcu_usf_bit        : 3;  /* bit[20-22]: PS域USF bit 上报，测试用 */
        unsigned long  reserved_1         : 1;  /* bit[23]   : 保留 */
        unsigned long  cps_bit            : 5;  /* bit[24-28]: PS域的HEADER CPSbit 上报，测试用 */
        unsigned long  reserved_2         : 3;  /* bit[29-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_PARA_REG7 寄存器结构定义。地址偏移量:0x23C，初值:0x003F000F，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dcu_ps_codec_type  : 4;  /* bit[0-3]  : 最近的PS业务上报 */
        unsigned long  reserved_0         : 12; /* bit[4-15] : 保留 */
        unsigned long  dcu_amr_frame_type : 6;  /* bit[16-21]: 最近的AMR业务上报 */
...
/*****************************************************************************
 ...
 结构说明  : DEC_STATE_RPT1 寄存器结构定义。地址偏移量:0x338，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  trch_sort_state_cpu : 4;  /* bit[0-3]  : 译码业务大类判断状态机状态，测试用 */
        unsigned long  kn_pro_state_cpu    : 4;  /* bit[4-7]  : 业务类型已知子状态机状态，测试用 */
        unsigned long  harq_pro_state_cpu  : 3;  /* bit[8-10] : HARQ合并译码子状态机状态，测试用 */
        unsigned long  reserved_0          : 1;  /* bit[11]   : 保留 */
        unsigned long  ukn_afs_state_cpu   : 5;  /* bit[12-16]: AFS业务子状态机状态，测试用 */
        unsigned long  reserved_1          : 3;  /* bit[17-19]: 保留 */
        unsigned long  ukn_ahs_state_cpu   : 6;  /* bit[20-25]: AHS业务子状态机状态，测试用 */
        unsigned long  reserved_2          : 1;  /* bit[26]   : 保留 */
        unsigned long  ukn_ps_state_cpu    : 5;  /* bit[27-31]: PS业务子状态机状态，测试用 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DEC_STATE_RPT2 寄存器结构定义。地址偏移量:0x33C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  vtb_state_cpu        : 4;  /* bit[8-11] : VTB译码子状态机状态，测试用 */
        unsigned long  corr_state_cpu       : 2;  /* bit[12-13]: 相关译码子状态机状态，测试用 */
        unsigned long  reserved_1           : 2;  /* bit[14-15]: 保留 */
        unsigned long  interleave_state_cpu : 4;  /* bit[16-19]: 交织模块工作状态，测试用 */
        unsigned long  depunc_state_cpu     : 3;  /* bit[20-22]: 去打孔模块工作状态，测试用 */
        unsigned long  reserved_2           : 1;  /* bit[23]   : 保留 */
        unsigned long  ccu_state_cpu        : 4;  /* bit[24-27]: CCU工作状态，测试用 */
        unsigned long  reserved_3           : 3;  /* bit[28-30]: 保留 */
        unsigned long  dec_busy_cpu         : 1;  /* bit[31]   : 下行译码忙状态，测试用 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DEC_INT_TOTAL 寄存器结构定义。地址偏移量:0x348，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dec_int_cnt : 4;  /* bit[0-3]  : 译码中断次数计数器上报 */
        unsigned long  reserved_0  : 12; /* bit[4-15] : 保留 */
        unsigned long  dec_cnt     : 4;  /* bit[16-19]: 译码启动次数计数器上报 */
        unsigned long  reserved_1  : 12; /* bit[20-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : BFI_RSQ_METRIC_RPT 寄存器结构定义。地址偏移量:0x34C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  amr_rsq_metric         : 8;  /* bit[0-7]  : CS语音的RSQ_METRIC上报 */
        unsigned long  reserved_0             : 8;  /* bit[8-15] : 保留 */
        unsigned long  amr_pber               : 7;  /* bit[16-22]: CS语音的PBER上报 */
        unsigned long  reserved_1             : 8;  /* bit[23-30]: 保留 */
        unsigned long  speech_bfi_corr_result : 1;  /* bit[31]   : 1标识是语音帧相关判决为BFI；
                                                                   0标识是语音帧相关判决不是BFI */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : UL_CODE_STATE_RPT 寄存器结构定义。地址偏移量:0x3B0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  ul_code_state : 2;  /* bit[0-1] : 00表示IDLE（空闲状态）                                     01表示INIT（初始化状态）                                     10表示CODE（编码状态）                                     11表示INTE（交织状态）
                                                         测试用 */
        unsigned long  reserved_0    : 2;  /* bit[2-3] : 保留 */
        unsigned long  ul_crc_state  : 2;  /* bit[4-5] : 00表示IDLE（空闲状态）                                     01表示RECV（接收状态）                                     10表示CHECK（校验状态）                                     11无效状态
                                                         测试用 */
        unsigned long  reserved_1    : 26; /* bit[6-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : UL_CODE_RAM_RST 寄存器结构定义。地址偏移量:0x3B4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_ul_cod_ram_rst_imi : 1;  /* bit[0]   : 软件对编码模块内部RAM（编码交织后存储RAM）清零信号，只需开机后，配置一下即可，逻辑自清零 */
        unsigned long  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : UL_CODE_RAM_RST_CFG 寄存器结构定义。地址偏移量:0x3B8，初值:0x004D0000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_ul_cod_ram_rst_addr   : 7;  /* bit[0-6]  : 清零起始块地址 */
        unsigned long  reserved_0                : 9;  /* bit[7-15] : 保留 */
        unsigned long  cpu_ul_cod_ram_rst_length : 7;  /* bit[16-22]: 清零数据块长度 */
        unsigned long  reserved_1                : 9;  /* bit[23-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : WAKE_TEST_QB_FRAC_RPT 寄存器结构定义。地址偏移量:0x224，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gdrx_wake_frac     : 7;  /* bit[0-6]  : DRX唤醒切换时GTC此时FRAC计数（测试用，104M钟不断，测试GTC计数与DRX计数是否相同），测试用 */
        unsigned long  reserved_0         : 9;  /* bit[7-15] : 保留 */
        unsigned long  gdrx_wake_chip_cnt : 13; /* bit[16-28]: DRX唤醒切换时GTC此时gtc_timebase计数（测试用，104M钟不断，测试GTC计数与DRX计数是否相同），测试用 */
        unsigned long  reserved_1         : 3;  /* bit[29-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : WAKE_TEST_T1_T2_T3_RPT 寄存器结构定义。地址偏移量:0x228，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gdrx_wake_t1_cnt : 11; /* bit[0-10] : DRX唤醒切换时GTC此时T1计数（测试用，104M钟不断，测试GTC计数与DRX计数是否相同），测试用 */
        unsigned long  reserved_0       : 5;  /* bit[11-15]: 保留 */
        unsigned long  gdrx_wake_t2_cnt : 5;  /* bit[16-20]: DRX唤醒切换时GTC此时T2计数（测试用，104M钟不断，测试GTC计数与DRX计数是否相同），测试用 */
        unsigned long  reserved_1       : 3;  /* bit[21-23]: 保留 */
        unsigned long  gdrx_wake_t3_cnt : 6;  /* bit[24-29]: DRX唤醒切换时GTC此时T3计数（测试用，104M钟不断，测试GTC计数与DRX计数是否相同），测试用 */
        unsigned long  reserved_2       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : WAKE_GTC_FN_RPT 寄存器结构定义。地址偏移量:0x22C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gdrx_wake_nf_low  : 11; /* bit[0-10] : DRX唤醒切换时，此时GTC的FN_LOW计数值，用于DRX测试用 */
        unsigned long  reserved_0        : 5;  /* bit[11-15]: 保留 */
        unsigned long  gdrx_wake_nf_high : 11; /* bit[16-26]: DRX唤醒切换时，此时GTC的FN_HIGH计数值，用于DRX测试用 */
        unsigned long  reserved_1        : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_A5_LSB_SEQ_SEL 寄存器结构定义。地址偏移量:0x458，初值:0x00000100，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_a5_lsb_sequence_sel : 1;  /* bit[0]   : 内部A53加解密算法bit输出顺序配置，请配置为0 */
        unsigned long  reserved_0              : 3;  /* bit[1-3] : 保留 */
        unsigned long  cpu_deciph_dir          : 1;  /* bit[4]   : 内部A53解密算法bit输出顺序配置，请配置为0 */
        unsigned long  reserved_1              : 3;  /* bit[5-7] : 保留 */
        unsigned long  cpu_ciph_dir            : 1;  /* bit[8]   : 内部A53加密算法bit输出顺序配置，请配置为1 */
        unsigned long  reserved_2              : 23; /* bit[9-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_GAP_LENGTH 寄存器结构定义。地址偏移量:0x248，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_2g4_gap_length : 23; /* bit[0-22] : 2G下进行4G测量的GAP长度。单位是QB。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_GAP_STOP 寄存器结构定义。地址偏移量:0x24C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_2g4_gap_stop : 1;  /* bit[0]   : 2G下进行4G测量期间，GPHY提前停止occasion的信号，脉冲信号。GBBP收到该信号后，立即停止gap_cnt计数，并上报int2（出沟中断），并拉高通道控制指示信号wg_intrasys_valid_delay。自清零。 */
        unsigned long  cpu_2g4_int0_en  : 1;  /* bit[1]   : 如果下一帧需要启动2G测4G，则在当前帧的配置时隙，配置该信号为1，并配置cpu_int0_gen_qb。自清零。 */
        unsigned long  reserved         : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_DIST 寄存器结构定义。地址偏移量:0x250，初值:0x0003006C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_2g4_int0_int1_dist : 12; /* bit[0-11] : 2G测4G时，中断0和中断1的间隔时间。单位是QB。
                                                                   默认值是108QB（约100us） */
        unsigned long  reserved_0             : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_intrasys_delay   : 4;  /* bit[16-19]: g_intrasys_valid_delay相对于g_intrasys_valid的延迟时间。支持延迟1~3个SSI写操作周期，保证LTE的最后一个射频数据写完。写入一个SSI字，所需时钟周期是27*52.08 = 1406.16 ns，约1.5QB 。默认值配置3（QB）。 */
        unsigned long  reserved_1             : 12; /* bit[20-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_INT0_GEN_QB 寄存器结构定义。地址偏移量:0x254，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_2g4_int0_gen_qb  : 13; /* bit[0-12] : 如果下一帧需要启动2G测4G，则在当前帧的配置时隙，配置该信号，表示在下帧帧头之后cpu_2g4_int0_gen_qb个QB，产生中断0 */
        unsigned long  reserved_0           : 3;  /* bit[13-15]: 保留 */
        unsigned long  cpu_2g4_gap_stop_rpt : 2;  /* bit[16-17]: cpu_2g4_gap_stop信号触发的计数器，用于观测cpu_2g4_gap_stop信号是否生效，如果生效，则每次该计数器自加1，循环计数 */
        unsigned long  reserved_1           : 6;  /* bit[18-23]: 保留 */
        unsigned long  cpu_2g4_int0_rpt     : 2;  /* bit[24-25]: cpu_2g4_int0_en信号触发的计数器，用于观测cpu_2g4_int0_en信号是否生效，如果生效，则每次该计数器自加1，循环计数 */
        unsigned long  reserved_2           : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_INT0_TIMING 寄存器结构定义。地址偏移量:0x240，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  g_int0_timebase_qb : 13; /* bit[0-12] : 2G测4G时，中断0对应的timebase，单位是QB */
        unsigned long  reserved_0         : 3;  /* bit[13-15]: 保留 */
        unsigned long  g_int0_fn          : 11; /* bit[16-26]: 2G测4G时，中断0对应的FN低11位 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_2G4_INT2_TIMING 寄存器结构定义。地址偏移量:0x244，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  g_int2_timebase_qb : 13; /* bit[0-12] : 2G测4G时，中断2对应的timebase，单位是QB */
        unsigned long  reserved_0         : 3;  /* bit[13-15]: 保留 */
        unsigned long  g_int2_fn          : 11; /* bit[16-26]: 2G测4G时，中断2对应的FN低11位 */
        unsigned long  reserved_1         : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : FB_AFC_PHASE_THRESHOLD_CFG 寄存器结构定义。地址偏移量:0x230，初值:0x02F801F4，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_fb_afc_phase_min : 10; /* bit[0-9]  : FB-AFC算法相位估计值参考下限，典型值500。可配300,400,500。 */
        unsigned long  reserved_0           : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_fb_afc_phase_max : 10; /* bit[16-25]: FB-AFC算法相位估计值参考上限，典型值760。 */
        unsigned long  reserved_1           : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : FB_FCUT_THRESHOLD_CFG 寄存器结构定义。地址偏移量:0x234，初值:0x03FF0033，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_fb_afc_fc_low  : 10; /* bit[0-9]  : FB-AFC算法系数fcut的最小值，如果经过α滤波后的相位估计值小雨相位估计值参考下限，则系数fcut的值就等于此最小值。典型值51。 */
        unsigned long  reserved_0         : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_fb_afc_fc_high : 10; /* bit[16-25]: FB-AFC算法系数fcut的最大值，如果经过α滤波后的相位估计值大于相位估计值的参考上限，则系数fcut的值就等于此最大值。典型值1023。 */
        unsigned long  reserved_1         : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : FB_AFC_ALPHA_SEL 寄存器结构定义。地址偏移量:0x238，初值:0x03FF4A00，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_fb_numerator_sel : 2;  /* bit[0-1]  : FB-AFC算法α滤波系数选择：
                                                                 0：1/32；
                                                                 1：1/16；
                                                                 2：1/8；
                                                                 3：1/4。
                                                                 典型值1/32。 */
        unsigned long  reserved_0           : 6;  /* bit[2-7]  : 保留 */
        unsigned long  cpu_fb_stage_num     : 4;  /* bit[8-11] : Fcut值固定使用FCutInit的跟踪FB数码。可配范围：5~10。典型配置：10。 */
        unsigned long  cpu_fb_rshift_num    : 3;  /* bit[12-14]: 对称右移比特数，可配范围0~7。典型配置：4。 */
        unsigned long  reserved_1           : 1;  /* bit[15]   : 保留 */
        unsigned long  cpu_fcut_init        : 10; /* bit[16-25]: 一阶环路滤波器初始带宽，典型配置：1023。 */
        unsigned long  reserved_2           : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SRCH_OPT_CFG 寄存器结构定义。地址偏移量:0x480，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_srch_opt_en            : 1;  /* bit[0]    : 111搜索优化模式使能，1标志打开优化使能，0标志关闭优化使能，采用001 111搜索。 */
        unsigned long  reserved_0                 : 3;  /* bit[1-3]  : 保留 */
        unsigned long  cpu_sb_lock_fail_threshold : 2;  /* bit[4-5]  : 111优化算法中FB-AFC锁定下允许SB译码CRC错误的次数，取值范围0~3。 */
        unsigned long  reserved_1                 : 10; /* bit[6-15] : 保留 */
        unsigned long  cpu_sb_bsic_threshold      : 2;  /* bit[16-17]: 111优化算法中允许SB译码CRC但对BSIC值不同的总次数
                                                                       0：4次；
                                                                       1：5次；
                                                                       2：6次；
                                                                       3：7次。 */
        unsigned long  reserved_2                 : 6;  /* bit[18-23]: 保留 */
        unsigned long  sb_dec_bsic                : 6;  /* bit[24-29]: 本次SB译码BSIC上报。 */
...
/*****************************************************************************
 ...
 结构说明  : R2_RSSI1234_THRESHOLD 寄存器结构定义。地址偏移量:0x204，初值:0x00D3BFA3，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_r2_rssi1_threshold : 8;  /* bit[0-7]  : RSSI 两轮门限1，单位dBm，推荐-93 */
        unsigned long  cpu_r2_rssi2_threshold : 8;  /* bit[8-15] : RSSI 两轮门限2，单位dBm，推荐-65 */
        unsigned long  cpu_r2_rssi3_threshold : 8;  /* bit[16-23]: RSSI 两轮门限3，单位dBm，推荐-45 */
...
/*****************************************************************************
 ...
 结构说明  : R2_RSSI4567_THRESHOLD 寄存器结构定义。地址偏移量:0x208，初值:0xFFFFFFFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_r2_rssi4_threshold : 8;  /* bit[0-7]  : RSSI 两轮门限4，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r2_rssi5_threshold : 8;  /* bit[8-15] : RSSI 两轮门限5，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r2_rssi6_threshold : 8;  /* bit[16-23]: RSSI 两轮门限6，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r2_rssi7_threshold : 8;  /* bit[24-31]: RSSI 两轮门限7，单位dBm，暂不使用，默认值-1 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AGC_WAIT_LEN_GTH 寄存器结构定义。地址偏移量:0x20C，初值:0x00003008，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_agc_wait           : 5;  /* bit[0-4]  : 快速AGC能量计算每轮之间等待时间，单位symbol，默认8。 */
        unsigned long  reserved_0             : 3;  /* bit[5-7]  : 保留 */
        unsigned long  cpu_dcr_recv_bypass    : 1;  /* bit[8]    : 解调与搜索通道直流偏置数字细调环旁路功能，高电平有效，该信号有效时，表示数字细调环不对接受数据进行反馈处理。 */
        unsigned long  reserved_1             : 3;  /* bit[9-11] : 保留 */
        unsigned long  cpu_rssi_hypersis      : 4;  /* bit[12-15]: RSSI 磁滞范围，单位dBm，默认3。 */
        unsigned long  reserved_2             : 8;  /* bit[16-23]: 保留 */
        unsigned long  cpu_dcr_burst_mode     : 1;  /* bit[24]   : 解调通道直流偏置数字细调环旁路功能，高电平有效，该信号有效时，表示数字细调环不对接受数据进行反馈处理。 */
        unsigned long  reserved_3             : 6;  /* bit[25-30]: 保留 */
        unsigned long  cpu_fast_threshold_sel : 1;  /* bit[31]   : 快速AGC测量模式选择信号
                                                                   0：快速AGC测量模式按照测量轮数gsp_fast_agc_mode选择
                                                                   1：快速AGC测量模式按照测量门限gsp_agc_measure_mode选择 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : R3_RSSI1234_THRESHOLD 寄存器结构定义。地址偏移量:0x210，初值:0x00D3BFA3，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_r3_rssi1_threshold : 8;  /* bit[0-7]  : RSSI 三轮门限1，单位dBm，推荐-93 */
        unsigned long  cpu_r3_rssi2_threshold : 8;  /* bit[8-15] : RSSI 三轮门限2，单位dBm，推荐-65 */
        unsigned long  cpu_r3_rssi3_threshold : 8;  /* bit[16-23]: RSSI 三轮门限3，单位dBm，推荐-45 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : R3_RSSI4567_THRESHOLD 寄存器结构定义。地址偏移量:0x21C，初值:0xFFFFFFFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_r3_rssi4_threshold : 8;  /* bit[0-7]  : RSSI 三轮门限4，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r3_rssi5_threshold : 8;  /* bit[8-15] : RSSI 三轮门限5，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r3_rssi6_threshold : 8;  /* bit[16-23]: RSSI 三轮门限6，单位dBm，暂不使用，默认值为-1 */
        unsigned long  cpu_r3_rssi7_threshold : 8;  /* bit[24-31]: RSSI 三轮门限7，单位dBm，暂不使用，默认值为-1 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DC_IQ_REMOVE_RPT 寄存器结构定义。地址偏移量:0x220，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dc_iq_remove_cpu_i : 14; /* bit[0-13] : 多路数字细调环偏置寄存器经过截位与限幅后的输出，也就是当前档位的直流输出。其可以作为直流偏置校准的参考值。两个14bit信号分别占用IMI总线的[29:16]和[13:0]，低14bit为I路输出，高14bit为Q路输出。 */
        unsigned long  reserved_0         : 2;  /* bit[14-15]: 保留 */
        unsigned long  dc_iq_remove_cpu_q : 14; /* bit[16-29]: 多路数字细调环偏置寄存器经过截位与限幅后的输出，也就是当前档位的直流输出。其可以作为直流偏置校准的参考值。两个14bit信号分别占用IMI总线的[29:16]和[13:0]，低14bit为I路输出，高14bit为Q路输出。 */
        unsigned long  reserved_1         : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DC_IQ_BURST_REMOVE_RPT 寄存器结构定义。地址偏移量:0x224，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  agc_data_q_dcr : 14; /* bit[0-13] : 时隙前处理I路直流偏置上报 */
        unsigned long  reserved_0     : 2;  /* bit[14-15]: 保留 */
        unsigned long  agc_data_i_dcr : 14; /* bit[16-29]: 时隙前处理Q路直流偏置上报 */
        unsigned long  reserved_1     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_NEXT_GAIN 寄存器结构定义。地址偏移量:0x250，初值:0x01000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  aagc_next_gain_cpu : 3;  /* bit[0-2]  : AGC期望控制增益。在快速模式最后一轮和慢速模式下统计结束后上报给CPU。 */
        unsigned long  reserved_0         : 5;  /* bit[3-7]  : 保留 */
        unsigned long  agc_rssi_125db_cpu : 12; /* bit[8-19] : RSSI值，单位是0.125dBm，上报给CPU，该值已是空口的RSSI值。 */
        unsigned long  reserved_1         : 4;  /* bit[20-23]: 保留 */
        unsigned long  aagc_curr_gain     : 3;  /* bit[24-26]: 当前AAGC档位上报。 */
        unsigned long  reserved_2         : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_cal_flag  : 1;  /* bit[31]   : 快慢速测量标志。1表示当前时快速测量；0表示当前是慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : RSSI_QB_FRQ 寄存器结构定义。地址偏移量:0x254，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  rssi_qb  : 13; /* bit[0-12] : 测量中断时刻TDMA帧QB值。 */
        unsigned long  reserved_0: 3;  /* bit[13-15]: 保留 */
        unsigned long  rssi_frq : 12; /* bit[16-27]: 当前测量的RSSI对应的频点号，[27:26]为band号，band号与频段的关系由软件自己定义，[25:16]为band内的频点号，该值由GTC指令配置，{GSP_RSSI_FRQ_HIGH_ADDR,GSP_RSSI_FRQ_LOW_ADDR},BBP进行延时后于测量中断一起上报。 */
        unsigned long  reserved_1: 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DRSSI_ENERGY_RPT 寄存器结构定义。地址偏移量:0x258，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  drssi_energy_report_cpu : 23; /* bit[0-22] : DRSSI求对数运算前数据上报。 */
        unsigned long  reserved                : 9;  /* bit[23-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AGC_FAST1_2_RSSI_CPU 寄存器结构定义。地址偏移量:0x25C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  agc_rssi_fast1_125db_cpu : 12; /* bit[0-11] : RSSI值，单位0.125dBm，其就是空口信号能量，为快速测量第一轮RSSI上报。 */
        unsigned long  reserved_0               : 4;  /* bit[12-15]: 保留 */
        unsigned long  agc_rssi_fast2_125db_cpu : 12; /* bit[16-27]: RSSI值，单位0.125dBm，其就是空口信号能量，为快速测量第二轮RSSI上报。 */
        unsigned long  reserved_1               : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AGC_DEC_INT_T3_FN 寄存器结构定义。地址偏移量:0x214，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  agc_int_tdma_fn : 6;  /* bit[0-5]  : AGC测量中断所在TDMA帧号模51计数值 */
        unsigned long  reserved_0      : 10; /* bit[6-15] : 保留 */
        unsigned long  dec_int_tdma_fn : 6;  /* bit[16-21]: NB业务译码中断所在TDMA帧号模51计数值 */
        unsigned long  reserved_1      : 10; /* bit[22-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DEM_INT_FN_QB 寄存器结构定义。地址偏移量:0x218，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dem_int_tdma_qb : 13; /* bit[0-12] : 解调中断所在TDMA QB计数值 */
        unsigned long  reserved_0      : 3;  /* bit[13-15]: 保留 */
        unsigned long  dem_int_tdma_fn : 6;  /* bit[16-21]: 解调中断所在TDMA帧号模51计数值 */
        unsigned long  reserved_1      : 10; /* bit[22-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_EXT_LINE_CTRL 寄存器结构定义。地址偏移量:0xE04，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gtc_ext_line_ctrl           : 8;  /* bit[0-7] : 定向线控CPU接口配置，其中
                                                                           bit0对应rf_tcvr_on,即射频芯片工作使能信号
                                                                           bit1对应rf_tx_en,即射频上行发送工作使能信号
                                                                           bit2对应rf_rst_n,即射频复位控制信号
                                                                           bit3对应abb_rxa_en,即ABB RXA通道使能信号
        ...
        unsigned long  cpu_gtc_ext_line_ctrl_wr_en_imi : 1;  /* bit[31]  : 8bit定向线控信号写使能指示信号 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GSP_EXT_LINE_STATE_RPT 寄存器结构定义。地址偏移量:0xE08，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_gsp_ext_line_ctrl : 7;  /* bit[0-6] : 定向线控实际状态，测试用。
                                                                 bit0对应rf_tcvr_on,即射频芯片工作使能信号
                                                                 bit1对应rf_tx_en,即射频上行发送工作使能信号
                                                                 bit2对应rf_rst_n,即射频复位控制信号
                                                                 bit3对应abb_rxa_en,即ABB RXA通道使能信号
...
/*****************************************************************************
 ...
 结构说明  : CPU_LINE01_SEL_CFG 寄存器结构定义。地址偏移量:0xE0C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_ext_line01_sel           : 4;  /* bit[0-3] : bit0对应主模MIPI和从模MIPI通道控制选择；
                                                                        bit1对应AUXDAC0和AUXDAC1控制选择；
                                                                        bit2对应ABB CH0与ABB CH1通道控制选择，由于V9R1不存在两个ABB通道，因此该配置默认配置为0，无需改动；
                                                                        bit3对应主模RFIC与从模RFIC通道控制选择。
                                                                        G为主模时，配置为4’d0；G为从模时，配置为4’d9。 */
        unsigned long  reserved                     : 27; /* bit[4-30]: 保留 */
        unsigned long  cpu_ext_line01_sel_wr_en_imi : 1;  /* bit[31]  : cpu_line01_sel_ctrl生效出发信号，即当此信号写为1后，cpu_line01_sel_ctrl对应的配置生效，逻辑自清零。
                                                                        注：要求bit[3:0]事先配置号。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_LINE01_SEL_STATE_RPT 寄存器结构定义。地址偏移量:0xE10，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_line01_sel_ctrl : 4;  /* bit[0-3] : 通道选择信号实际状态，测试用。
                                                               bit0：gtc_mipi01_sel；
                                                               bit1：gtc_auxdac01_sel；
                                                               bit2：gtc_abb01_sel；
                                                               bit3：gtc_rf01_sel。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_OFC_RXCM_REG 寄存器结构定义。地址偏移量:0x360，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  cpu_agc_page_switch_en : 1;  /* bit[31]  : AGC模块配置前向通道增益调整值和RXCORR参数存储RAM和DC_OFFSET存储RAM TDMA帧头乒乓切换使能
                                                                  1表示允许乒乓切换
                                                                  0表示不允许乒乓切换，固定为乒页；当该信号为1时，逻辑内部在TDMA帧头自动切换乒乓标志。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_SAMPLE_REG 寄存器结构定义。地址偏移量:0x36C，初值:0x00000020，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  cpu_sample_sel_imi       : 2;  /* bit[4-5]  : bit1:1表示时硬件自判决模式，0表示时软件控制模式。当bit为0时，bit0意义才生效。样点组内奇偶选择信号，0表示选中样点组内偶路数据，1表示选中样点组内奇路数据。用于8PSK解调和搜索。2'b11配置时保留值，请勿配置。在搜索模式下请勿配置为2'bx1模式。 */
        unsigned long  reserved_1               : 2;  /* bit[6-7]  : 保留 */
        unsigned long  cpu_sample_sel_group_imi : 1;  /* bit[8]    : 采样点组选择配置，该信号需要用帧头锁存。
                                                                     0：表示选择1个symbol中的1/3样点组；
                                                                     1：表示选择1个symbol中的2/4样点组。 */
        unsigned long  reserved_2               : 3;  /* bit[9-11] : 保留 */
        unsigned long  cpu_dcr_bypass           : 1;  /* bit[12]   : 测量通道直流偏置数字细调环旁路功能，高电平有效。
                                                                     该信号有效时，相当于数字细调环不对接收数据进行反馈处理。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_AGC_RAM_SWITCH_IND 寄存器结构定义。地址偏移量:0x370，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_agc_ram_switch_ind : 1;  /* bit[0]   : AGC直流偏执RAM和通道增益RAM手动切换指示信号，该信号为脉冲信号，自清零。 */
        unsigned long  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : DAGC_MULFACTOR_FIX 寄存器结构定义。地址偏移量:0x37C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  agc_drssi_25db_cpu      : 9;  /* bit[0-8]  : DRSSI值上报，其对应为ABB输出信号的能量，单位0.25dBm。 */
        unsigned long  reserved_0              : 7;  /* bit[9-15] : 保留 */
        unsigned long  cpu_soft_agc_drssi_25db : 9;  /* bit[16-24]: 软件强制配置的DRSSI值，单位0.25dBm。 */
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN1_SPI_DATA 寄存器结构定义。地址偏移量:0x584，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain1_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第1档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN2_SPI_DATA 寄存器结构定义。地址偏移量:0x588，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain2_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第2档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN3_SPI_DATA 寄存器结构定义。地址偏移量:0x58C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain3_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第3档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN4_SPI_DATA 寄存器结构定义。地址偏移量:0x590，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain4_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第4档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN5_SPI_DATA 寄存器结构定义。地址偏移量:0x594，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain5_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第5档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN6_SPI_DATA 寄存器结构定义。地址偏移量:0x598，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain6_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第6档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN7_SPI_DATA 寄存器结构定义。地址偏移量:0x59C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain7_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第7档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_MAIN_GAIN8_SPI_DATA 寄存器结构定义。地址偏移量:0x5A0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_main_gain8_spi_data : 24; /* bit[0-23] : 主集天线控制增益模式下第8档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved                : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN1_SPI_DATA 寄存器结构定义。地址偏移量:0x5A4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain1_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第1档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN2_SPI_DATA 寄存器结构定义。地址偏移量:0x5A8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain2_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第2档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN3_SPI_DATA 寄存器结构定义。地址偏移量:0x5AC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain3_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第3档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN4_SPI_DATA 寄存器结构定义。地址偏移量:0x5B0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain4_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第4档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN5_SPI_DATA 寄存器结构定义。地址偏移量:0x5B4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain5_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第5档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN6_SPI_DATA 寄存器结构定义。地址偏移量:0x5B8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain6_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第6档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN7_SPI_DATA 寄存器结构定义。地址偏移量:0x5BC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain7_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第7档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_DIV_GAIN8_SPI_DATA 寄存器结构定义。地址偏移量:0x5C0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_div_gain8_spi_data : 24; /* bit[0-23] : 分集天线控制增益模式下第8档SPI控制字，具体SPI控制字组合方式请参见相关射频手册。主分集控制字选择请配置gsp_rf_gain_word_sel。 */
        unsigned long  reserved               : 8;  /* bit[24-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : NB_AFC_LOOP_SWITCH 寄存器结构定义。地址偏移量:0x340，初值:0x80000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_nb_afc_switch           : 1;  /* bit[0]   : 一阶环与二阶环选择控制信号，
                                                                       0：选择一阶环；
                                                                       1：选择二阶环。 */
        unsigned long  cpu_nb_afc_slow_fast_switch : 1;  /* bit[1]   : 二阶环快慢速阶段控制，
                                                                       0：表示采用慢速跟踪；
                                                                       1：表示采用快速跟踪。 */
        unsigned long  reserved                    : 29; /* bit[2-30]: 保留 */
        unsigned long  cpu_nb_afc_sel              : 1;  /* bit[31]  : NB-AFC控制方式选择。
                                                                       0：GTC控制；
                                                                       1：CPU控制；
                                                                       默认CPU控制。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_AFC_K_VALUE 寄存器结构定义。地址偏移量:0xE00，初值:0x00000054，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_afc_k_factor : 10; /* bit[0-9]  : AFC K值调整，默认值为10’d84，TCXO方案下保持默认值，DCXO方案下根据实际系统进行调整。 */
        unsigned long  reserved         : 22; /* bit[10-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_NB_AFC_LOOP_SLOW 寄存器结构定义。地址偏移量:0xE14，初值:0x00024661，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_shiftr_kint_slow : 2;  /* bit[0-1]  : 慢速调整阶段环路滤波器系数Kint的右移位数。
                                                                 0:8
                                                                 1:9
                                                                 2:10
                                                                 3:11
                                                                 默认配置:1 */
        unsigned long  reserved_0           : 2;  /* bit[2-3]  : 保留 */
        unsigned long  cpu_shiftr_ki_slow   : 3;  /* bit[4-6]  : 慢速调整阶段环路滤波器系数Ki的右移位数。
                                                                 0:1
                                                                 1:2
                                                                 2:3
                                                                 3:4
        ...
        unsigned long  cpu_shiftl_kp_slow   : 3;  /* bit[8-10] : 慢速调整阶段环路滤波器系数Kp的右移位数。
                                                                 0:7
                                                                 1:6
                                                                 2:5
                                                                 3:4
        ...
        unsigned long  cpu_shiftr_ka_slow   : 3;  /* bit[12-14]: 慢速调整阶段环路滤波器系数Ka的右移位数。
                                                                 0：07；
                                                                 1：08；
                                                                 2：09；
                                                                 3：10；
        ...
        unsigned long  cpu_ka_slow          : 3;  /* bit[16-18]: 慢速调整阶段环路滤波器系数Ka。
                                                                 0：16'd33141；
                                                                 1：16'd22094；
                                                                 2：16'd7365；
                                                                 3：16'd4419；
                                                                 ...
                                                                 7：16'd2209。
                                                                 默认配置：2。 */
        unsigned long  reserved_4           : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_NB_AFC_LOOP_FAST 寄存器结构定义。地址偏移量:0xE18，初值:0x00023651，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_shiftr_kint_fast : 2;  /* bit[0-1]  : 快速调整阶段环路滤波器系数Kint的右移位数。
                                                                 0:8
                                                                 1:9
                                                                 2:10
                                                                 3:11
                                                                 默认配置:1 */
        unsigned long  reserved_0           : 2;  /* bit[2-3]  : 保留 */
        unsigned long  cpu_shiftr_ki_fast   : 3;  /* bit[4-6]  : 快速调整阶段环路滤波器系数Ki的右移位数。
                                                                 0:1
                                                                 1:2
                                                                 2:3
                                                                 3:4
                                                                 ...
                                                                 默认配置:1 */
        unsigned long  reserved_1           : 1;  /* bit[7]    : 保留 */
        unsigned long  cpu_shiftl_kp_fast   : 3;  /* bit[8-10] : 快速调整阶段环路滤波器系数Kp的左移位数。
                                                                 0:7
                                                                 1:6
                                                                 2:5
                                                                 3:4
                                                                 ...
                                                                 默认配置:6 */
        unsigned long  reserved_2           : 1;  /* bit[11]   : 保留 */
        unsigned long  cpu_shiftr_ka_fast   : 3;  /* bit[12-14]: 快速调整阶段环路滤波器系数Ka的右移位数。
                                                                 0：07；
                                                                 1：08；
                                                                 2：09；
                                                                 3：10；
                                                                 ...
                                                                 默认配置：3。 */
        unsigned long  reserved_3           : 1;  /* bit[15]   : 保留 */
        unsigned long  cpu_ka_fast          : 3;  /* bit[16-18]: 快速调整阶段环路滤波器系数Ka。
                                                                 0:16’d33141
                                                                 1:16’d22094
                                                                 2:16’d7365
                                                                 3:16’d4419
...
/*****************************************************************************
 ...
 结构说明  : ADDR_DEM_INT_FRQ 寄存器结构定义。地址偏移量:0x0E2C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dem_int_rssi_frq : 12; /* bit[0-11] : 本次解调中断时刻对应的频点 */
        unsigned long  reserved         : 20; /* bit[12-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_DEC_INT_FREQ 寄存器结构定义。地址偏移量:0x0E30，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dec_int_rssi_frq : 12; /* bit[0-11] : 本次译码中断上报时刻对应的频点信息 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  dec_int_tdma_qb  : 13; /* bit[16-28]: 本次译码中断上报时可对应的TDMA QB信息 */
        unsigned long  reserved_1       : 3;  /* bit[29-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_SRCH_INT_TDMA_QB 寄存器结构定义。地址偏移量:0x0E34，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  srch_tdma_qb     : 13; /* bit[0-12] : 本次搜索中断上报时刻对应的TDMA QB */
        unsigned long  reserved_0       : 3;  /* bit[13-15]: 保留 */
        unsigned long  srch_int_tdma_fn : 6;  /* bit[16-21]: [21:16] 6’b0 RO 本次中断上报时刻对应的TDMA帧号（gtc_t3_cnt） */
        unsigned long  reserved_1       : 10; /* bit[22-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY4 寄存器结构定义。地址偏移量:0x32C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_4d_cpu : 31; /* bit[0-30]: 读取时刻前第五近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                    : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY4 寄存器结构定义。地址偏移量:0x330，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_4d_cpu : 26; /* bit[0-25] : 读取时刻前第五近burst对应的干扰能量值，无符号数。 */
        unsigned long  reserved                      : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA4 寄存器结构定义。地址偏移量:0x298，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    {
        unsigned long  reserved_0            : 14; /* bit[0-13] : 保留 */
        unsigned long  mod_type_5d           : 2;  /* bit[14-15]: 读取时刻第五近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻第五近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_5d         : 3;  /* bit[20-22]: 读取时刻第五近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_1            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_5d     : 1;  /* bit[24]   : 读取时刻第五近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_5d     : 2;  /* bit[28-29]: 读取时刻前的第五近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_3            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻第五近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_CARRIER_ENERGY5 寄存器结构定义。地址偏移量:0x334，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_carrier_energy_5d_cpu : 31; /* bit[0-30]: 读取时刻前第六近burst对应的载波能量值，无符号数。 */
        unsigned long  reserved                    : 1;  /* bit[31]  : 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_INTERFERE_ENERGY5 寄存器结构定义。地址偏移量:0x338，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  valpp_interfere_energy_5d_cpu : 26; /* bit[0-25] : 读取时刻前第六近burst对应的干扰能量值，无符号数。 */
        unsigned long  reserved                      : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : VALPP_DEM_TYPE_TOA5 寄存器结构定义。地址偏移量:0x33C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    {
        unsigned long  reserved_0            : 14; /* bit[0-13] : 保留 */
        unsigned long  mod_type_6d           : 2;  /* bit[14-15]: 读取时刻第六近BURST的调制方式，
                                                                  0：GSKM；
                                                                  1：8PSK；
                                                                  2：DummyBurst。 */
        unsigned long  nb_pos_adj_cpu        : 4;  /* bit[16-19]: 读取时刻第六近解调burst对应的NB位置调整量，是补码表示的有符号数，负数表示向前调整，正数表示向后调整，范围：-4~+4。 */
        unsigned long  demod_slot_6d         : 3;  /* bit[20-22]: 读取时刻第六近解调burst对应的时隙号，该时隙号由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_1            : 1;  /* bit[23]   : 保留 */
        unsigned long  nserv_cell_ind_6d     : 1;  /* bit[24]   : 读取时刻第六近burst是否为非服务区指示，1表示非服务区，0表示服务区，默认值为0。该值由PHY通过GTC指令配置下来，BBP延时至解调中断处进行上报。 */
        unsigned long  reserved_2            : 3;  /* bit[25-27]: 保留 */
        unsigned long  mod_type_first_6d     : 2;  /* bit[28-29]: 读取时刻前的第六近BURST对应的一次判决的调制方式，
                                                                  0：GMSK调制；
                                                                  1：8PSK调制；
                                                                  2：DummyBurst。
                                                                  该寄存器测试使用。 */
        unsigned long  reserved_3            : 1;  /* bit[30]   : 保留 */
        unsigned long  demod_info_valid_flag : 1;  /* bit[31]   : 读取时刻第六近解调信息有效标志，当完成一次NB解调时，该标志置1,CPU读取完该BURST解调上报信息后，应该对该bit清零，指示该信息已经读取。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_JITTER_CORR_CFG1 寄存器结构定义。地址偏移量:0x3B4，初值:0x80000303，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_jitter_on_ci_thresh : 3;  /* bit[0-2]  : 该门限用于解调模块内部，判决是否做纠偏 对应链路信号名CIThreshold，默认值10。
                                                                    可选值7,8,9,10,11,12,13，
                                                                    CPU数值对应关系：0-6。 */
        unsigned long  reserved_0              : 5;  /* bit[3-7]  : 保留 */
        unsigned long  cpu_energy_thresh       : 3;  /* bit[8-10] : 解调模块用，纠偏状态第一个子状态，判决是否满足纠偏条件. 对应链路信号名 EnergyThreshold：，默认值12。含义：通过信道估计计算全部能量和部分能量。可选值9,10, 11,12,13,14,15，
                                                                    CPU数值对应关系：0-6。 */
        unsigned long  reserved_1              : 12; /* bit[11-22]: 保留 */
        unsigned long  cpu_sin_factor          : 1;  /* bit[23]   : SB频偏值计算因子，0表示系数为1.25，1表示系数为1 */
        unsigned long  reserved_2              : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_sb_freq_corr_en     : 1;  /* bit[30]   : SB纠偏使能信号，0表示关闭频偏检测及纠偏，1表示打开。
                                                                    V9R1/V3R3不支持该功能，必须配置为0。 */
        unsigned long  cpu_freq_corr_en        : 1;  /* bit[31]   : NB纠偏使能信号，0表示关闭频偏检测及纠偏，1表示打开。默认为0。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : PHI_DEV_CPU 寄存器结构定义。地址偏移量:0x3B8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  phi_dev_cpu : 15; /* bit[0-14] : JITTER ON消除算法当前频偏上报 */
        unsigned long  reserved    : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_JITTER_CORR_CFG2 寄存器结构定义。地址偏移量:0x3BC，初值:0x80140702，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_snr_thresh     : 3;  /* bit[0-2]  : 对应于链路中的SNR_THRES，用于计算纠偏范围 fr_off_lim_act，以及调整参数, 默认值100, 取值范围90 95 100 105 110,CPU数值对应0～4 */
        unsigned long  reserved_0         : 5;  /* bit[3-7]  : 保留 */
        unsigned long  cpu_froff_lim_step : 4;  /* bit[8-11] : 对应于链路中的FrOffLim_STEP，取值范围5 6 7 8 9，默认值是7 */
        unsigned long  reserved_1         : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_frmoff_lim     : 5;  /* bit[16-20]: 软件和芯片都用，对偏差限幅。对应链路信号 FrOffLim 。默认值20，可选值14,16,18,20,22, 24； */
        unsigned long  reserved_2         : 10; /* bit[21-30]: 保留 */
        unsigned long  cpu_feed_back_en   : 1;  /* bit[31]   : NB频偏校准范围继承使能，默认值是1。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_TSC_SWITCH_EN 寄存器结构定义。地址偏移量:0x3C4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_tsc_page_switch_en : 1;  /* bit[0]   : 软件规避模式下响应解调中断后读取训练序列数据上报RAM的上报机制控制,多时隙下需使用乒乓操作模式
                                                                  1表示CPU访问训练序列数据上报RAM采用乒乓RAM访问模式，
                                                                  0表示CPU访问训练序列数据上报RAM采用非乒乓RAM访问模式 */
        unsigned long  reserved               : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER0_P0_P1 寄存器结构定义。地址偏移量:0x800，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter0_p0_i : 14; /* bit[0-13] : 滤波器0，I路参数p0，默认值：14'd0。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter0_p1_i : 14; /* bit[16-29]: 滤波器0，I路参数p1，默认值：14'd0。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER0_P2_P3 寄存器结构定义。地址偏移量:0x804，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter0_p2_i : 14; /* bit[0-13] : 滤波器0，I路参数p2，默认值：14'd0。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter0_p3_i : 14; /* bit[16-29]: 滤波器0，I路参数p3，默认值：14'd0。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER0_P4_P5 寄存器结构定义。地址偏移量:0x808，初值:0x10000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter0_p4_i : 14; /* bit[0-13] : 滤波器0，I路参数p4，默认值：14'd0。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter0_p5_i : 14; /* bit[16-29]: 滤波器0，I路参数p5，默认值：14'd4096。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER3_P0_P1 寄存器结构定义。地址偏移量:0x80C，初值:0x3F8F3F59，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter3_p0_i : 14; /* bit[0-13] : 滤波器3，I路参数p0，默认值：-14'd167。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter3_p1_i : 14; /* bit[16-29]: 滤波器3，I路参数p1，默认值：-14'd113。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER3_P2_P3 寄存器结构定义。地址偏移量:0x810，初值:0x03FA3EEF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter3_p2_i : 14; /* bit[0-13] : 滤波器3，I路参数p2，默认值：-14'd273。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter3_p3_i : 14; /* bit[16-29]: 滤波器3，I路参数p3，默认值：14'd1018。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER3_P4_P5 寄存器结构定义。地址偏移量:0x814，初值:0x08B40179，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter3_p4_i : 14; /* bit[0-13] : 滤波器3，I路参数p4，默认值：14'd377。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter3_p5_i : 14; /* bit[16-29]: 滤波器3，I路参数p5，默认值：14'd2228。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P0_P1_I 寄存器结构定义。地址偏移量:0x818，初值:0x00A80011，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p0_i : 14; /* bit[0-13] : 滤波器1，I路参数p0，默认值：14'd17。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p1_i : 14; /* bit[16-29]: 滤波器1，I路参数p1，默认值：14'd168。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P2_P3_I 寄存器结构定义。地址偏移量:0x81C，初值:0x00B90016，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p2_i : 14; /* bit[0-13] : 滤波器1，I路参数p2，默认值：14'd22。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p3_i : 14; /* bit[16-29]: 滤波器1，I路参数p3，默认值：14'd185。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P4_P5_I 寄存器结构定义。地址偏移量:0x820，初值:0x06CA045C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p4_i : 14; /* bit[0-13] : 滤波器1，I路参数p4，默认值：14'd1116。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p5_i : 14; /* bit[16-29]: 滤波器1，I路参数p5，默认值：14'd1738。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P0_P1_Q 寄存器结构定义。地址偏移量:0x824，初值:0x00DB0006，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p0_q : 14; /* bit[0-13] : 滤波器1，Q路参数p0，默认值：14'd6。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p1_q : 14; /* bit[16-29]: 滤波器1，Q路参数p1，默认值：14'd219。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P2_P3_Q 寄存器结构定义。地址偏移量:0x828，初值:0x3E8700DB，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p2_q : 14; /* bit[0-13] : 滤波器1，Q路参数p2，默认值：14'd219。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p3_q : 14; /* bit[16-29]: 滤波器1，Q路参数p3，默认值：-14'd377。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_FILTER1_P4_P5_Q 寄存器结构定义。地址偏移量:0x82C，初值:0x00003D4A，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_filter1_p4_q : 14; /* bit[0-13] : 滤波器1，Q路参数p4，默认值：-14'd694。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_filter1_p5_q : 14; /* bit[16-29]: 滤波器1，Q路参数p5，默认值：14'd0。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GACI_DATA_BYPASS 寄存器结构定义。地址偏移量:0x880，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gaci_data_bypass : 1;  /* bit[0]   : 1：dagc输入数据不经滤波器处理直接输出
                                                                0：dagc输入数据经滤波器处理后输出 */
        unsigned long  reserved             : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GACI_PARA 寄存器结构定义。地址偏移量:0x884，初值:0x00010003，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gaci_tpower : 3;  /* bit[0-2]  : 判决可配置门限
                                                            3’b000:   2
                                                            3’b001:   3
                                                            3’b010:   4
                                                            3’b011:   5
                                                            ...
                                                            默认值:   5 */
        unsigned long  reserved_0      : 13; /* bit[3-15] : 保留 */
        unsigned long  cpu_gaci_taci   : 3;  /* bit[16-18]: 判决可配置门限
                                                            3’b000:   5
                                                            3’b001:   6
                                                            3’b010:   7
                                                            3’b011:   8
...
/*****************************************************************************
 ...
 结构说明  : GACI_INDEX_CPU 寄存器结构定义。地址偏移量:0x8A0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gaci_index_cpu : 2;  /* bit[0-1] : 输出邻频检测结果，上报CPU四种可能的干扰状态：
                                                          2’b00：无干扰
                                                          2’b01：+200Khz干扰
                                                          2’b10：-200Khz干扰
                                                          2’b11： 200Khz干扰 */
...
/*****************************************************************************
 ...
 结构说明  : GACI_RACI_CPU 寄存器结构定义。地址偏移量:0x8A4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  raci_cpu : 26; /* bit[0-25] : GACI参数，由ematrix_03_cpu_cpu与ematrix_12_cpu产生 */
        unsigned long  reserved : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GACI_RPOWER_CPU 寄存器结构定义。地址偏移量:0x8A8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  rpower_cpu : 26; /* bit[0-25] : GACI参数，在EMATRIX状态下产生的判决参数，由经过高通后数据求能量产生。 */
        unsigned long  reserved   : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GACI_EMATRIX_03_CPU 寄存器结构定义。地址偏移量:0x8AC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  ematrix_03_cpu : 26; /* bit[0-25] : GACI参数，在EMATRIX状态下产生的判决参数，由经过高通后数据求相关产生。 */
        unsigned long  reserved       : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GACI_EMATRIX_12_CPU 寄存器结构定义。地址偏移量:0x8B0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  ematrix_12_cpu : 26; /* bit[0-25] : GACI参数，在EMATRIX状态下产生的判决参数，由经过高通后数据求相关产生。 */
        unsigned long  reserved       : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GACI_AVG_ALL_CPU 寄存器结构定义。地址偏移量:0x8B4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  avg_all_cpu : 21; /* bit[0-20] : GACI未经过高通处理，原输入数据能量，在ENERGY1状态产生 */
...
/*****************************************************************************
 ...
 结构说明  : GACI_AVG_HP_CPU 寄存器结构定义。地址偏移量:0x8B8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  avg_hp_cpu : 21; /* bit[0-20] : GACI经过高通处理，原输入数据能量，在ENERGY2状态产生 */
        unsigned long  reserved   : 11; /* bit[21-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_AMR_CRC_PRO_NUM_CFG 寄存器结构定义。地址偏移量:0x3CC，初值:0x00000003，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_amr_crc_prot_num : 2;  /* bit[0-1] : AMR带内bit优化算法中针对SPEECH CRC的保护次数，配置范围0～3，代表保护次数为1～4，默认值为3
                                                                （当业务类型为GMSK WBAMR时，配置范围为0～2） */
        unsigned long  reserved             : 30; /* bit[2-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P0_PRIOR_REG_CFG 寄存器结构定义。地址偏移量:0x3D0，初值:0x001FFFEB，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p0_prior : 21; /* bit[0-20] : AMR带内bit优化算法中00对应的先验概率 */
        unsigned long  reserved     : 11; /* bit[21-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P1_PRIOR_REG_CFG 寄存器结构定义。地址偏移量:0x3D4，初值:0x001FFAA0，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p1_prior : 21; /* bit[0-20] : AMR带内bit优化算法中01对应的先验概率 */
        unsigned long  reserved     : 11; /* bit[21-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P2_PRIOR_REG_CFG 寄存器结构定义。地址偏移量:0x3D8，初值:0x001FFFD6，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p2_prior : 21; /* bit[0-20] : AMR带内bit优化算法中10对应的先验概率 */
        unsigned long  reserved     : 11; /* bit[21-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P3_PRIOR_REG_CFG 寄存器结构定义。地址偏移量:0x3DC，初值:0x001FFAA0，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p3_prior : 21; /* bit[0-20] : AMR带内bit优化算法中11对应的先验概率
                                                         AFS下算法推荐配置为-6000，AHS下算法推荐配置为-4000 */
        unsigned long  reserved     : 11; /* bit[21-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CMI_P01_PRIOR_PRE_RPT 寄存器结构定义。地址偏移量:0x380，初值:0x00010001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mappre_0_cmi : 16; /* bit[0-15] : CMI带内bit 0对应的先验概率上报 */
        unsigned long  mappre_1_cmi : 16; /* bit[16-31]: CMI带内bit 1对应的先验概率上报 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CMI_P23_PRIOR_PRE_RPT 寄存器结构定义。地址偏移量:0x384，初值:0x00010001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mappre_2_cmi : 16; /* bit[0-15] : CMI带内bit 2对应的先验概率上报 */
        unsigned long  mappre_3_cmi : 16; /* bit[16-31]: CMI带内bit 3对应的先验概率上报 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CMC_P01_PRIOR_PRE_RPT 寄存器结构定义。地址偏移量:0x388，初值:0x00010001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mappre_0_cmc : 16; /* bit[0-15] : CMC带内bit 0对应的先验概率上报 */
        unsigned long  mappre_1_cmc : 16; /* bit[16-31]: CMC带内bit 1对应的先验概率上报 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CMC_P23_PRIOR_PRE_RPT 寄存器结构定义。地址偏移量:0x38C，初值:0x00010001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mappre_2_cmc : 16; /* bit[0-15] : CMC带内bit 2对应的先验概率上报 */
        unsigned long  mappre_3_cmc : 16; /* bit[16-31]: CMC带内bit 3对应的先验概率上报 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P01_MAPPRE_CFG 寄存器结构定义。地址偏移量:0x390，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p0_mappre : 16; /* bit[0-15] : CMC或者CMI 带内bit 0对应的历史先验概率值，用于恢复GBBP的CMC或者CMI先验概率 */
        unsigned long  cpu_p1_mappre : 16; /* bit[16-31]: CMC或者CMI 带内bit 1对应的历史先验概率值，用于恢复GBBP的CMC或者CMI先验概率 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_P23_MAPPRE_CFG 寄存器结构定义。地址偏移量:0x394，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_p2_mappre : 16; /* bit[0-15] : CMC或者CMI 带内bit 2对应的历史先验概率值，用于恢复GBBP的CMC或者CMI先验概率 */
        unsigned long  cpu_p3_mappre : 16; /* bit[16-31]: CMC或者CMI 带内bit 3对应的历史先验概率值，用于恢复GBBP的CMC或者CMI先验概率 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_CMC_CMI_LOAD_EN 寄存器结构定义。地址偏移量:0x398，初值:0x00360000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_cmi_cmc_mappre_load_en_imi : 1;  /* bit[0]    : 1标识需要做加载CMI或者CMC的历史先验概率，该信号配置之前需要软件先配置CPU_P01_MAPPRE_CFG，CPU_P23_MAPPRE_CFG寄存器 */
        unsigned long  cpu_cmi_cmc_mappre_load_mode   : 1;  /* bit[1]    : 0标识加载CMI的历史先验概率，1标识加载CMC的历史先验概率 */
        unsigned long  cpu_nodata_judge_mode          : 1;  /* bit[2]    : 1标识采用C02通过状态来判决NODATA的模式
                                                                           0标识采用V3 AMR相关译码的判决方式。 */
        unsigned long  reserved_0                     : 5;  /* bit[3-7]  : 保留 */
        unsigned long  cpu_cmc_cmi_rpt                : 1;  /* bit[8]    : 1标识当前译码中断所在周期是CMC周期
                                                                           0标识当前译码中断所在周期是CMI周期。 */
        unsigned long  reserved_1                     : 7;  /* bit[9-15] : 保留 */
        unsigned long  cpu_amr_corr_thres             : 14; /* bit[16-29]: AMR判决算法中绝对门限，AFS推荐值为233，AHS推荐值为230 */
        unsigned long  reserved_2                     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AMR_INFO1_RPT 寄存器结构定义。地址偏移量:0x3F8，初值:0x20003F3F，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dcu_amr_frame_type : 6;  /* bit[0-5]  : AMR译码帧类型上报 */
        unsigned long  reserved_0         : 2;  /* bit[6-7]  : 保留 */
        unsigned long  max_sum_frame_type : 6;  /* bit[8-13] : AMR相关最大帧类型上报 */
        unsigned long  reserved_1         : 2;  /* bit[14-15]: 保留 */
        unsigned long  corr_max_sum       : 14; /* bit[16-29]: AMR相关最大帧类型相关累加和上报 */
        unsigned long  reserved_2         : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AMR_INFO2_RPT 寄存器结构定义。地址偏移量:0x3FC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  abs_sum_g_corr_max_sum    : 1;  /* bit[0]   : AMR判决算法公式上报 */
        unsigned long  abs_sum_le_corr_rat_sum   : 1;  /* bit[1]   : AMR判决算法公式上报 */
        unsigned long  abs_sum_le_corr_onset_sum : 1;  /* bit[2]   : AMR判决算法公式上报 */
        unsigned long  reserved                  : 29; /* bit[3-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_AMR_CORR_COEFF_CFG 寄存器结构定义。地址偏移量:0x3E0，初值:0x0000000A，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_amr_corr_coeff : 4;  /* bit[0-3] : AFS/AHS 相关译码判决公式门限参数，配置范围0～15，推荐配置为10 */
        unsigned long  reserved           : 28; /* bit[4-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CODEC_WR_CONFLICT_CNT 寄存器结构定义。地址偏移量:0x718，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  codec_conflict_cnt_cpu    : 8;  /* bit[0-7]  : [3:0] 编码过程中启动了下行译码配置冲突计数器上报
                                                                      [7:4]：译码过程中启动了上行编码配置冲突计数器上报 */
        unsigned long  reserved                  : 8;  /* bit[8-15] : 保留 */
        unsigned long  valpp_wr_conflict_cnt_cpu : 16; /* bit[16-31]: VALPP RAM单口访问冲突计数器
                                                                      [31:28] DEM和CARRY过程发生读，写冲突
                                                                      [27:20]  DEMAP和MAP过程发生读，写冲突
                                                                      [23:20] DEMAP和CARRY过程发生读，写冲突
                                                                      [19:16] DEMAP和DEM模块发生读，写冲突 */
...
/*****************************************************************************
 ...
 结构说明  : ADDR_HARQ_MODE 寄存器结构定义。地址偏移量:0xA00，初值:0x00010001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_harq_external_mode : 1;  /* bit[0]    : HARQ内置模式与外置模式选择信号，1表示使用外置模式，0表示使用内置模式。 */
        unsigned long  reserved_0             : 15; /* bit[1-15] : 保留 */
        unsigned long  cpu_harq_ddr_mode      : 1;  /* bit[16]   : HARQ外置模式下，是否根据CRC结果对外置DDR进行访问，1表示不管CRC结果，强行将数据存入HARQ MEM，0表示根据CRC结果将数据存入HARQ MEM。 */
        unsigned long  reserved_1             : 15; /* bit[17-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_HARQ_INIT_EN 寄存器结构定义。地址偏移量:0xA04，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_harq_init_en : 1;  /* bit[0]   : HARQ外置模式下，异常复位信号，脉冲信号，写1复位。 */
        unsigned long  reserved         : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_DDR_HARQ_CFG 寄存器结构定义。地址偏移量:0xA10，初值:0x00000008，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  g_beat_num       : 4;  /* bit[0-3]  : HARQ外置模式下，DDR每次写FIFO的burst长度。 */
        unsigned long  reserved_0       : 12; /* bit[4-15] : 保留 */
        unsigned long  dec_int_type_cpu : 4;  /* bit[16-19]: HARQ外置模式下，译码中断异常状态上报值。
                                                             1’b1：译码超时
                                                             1’b0：译码未超时 */
        unsigned long  reserved_1       : 12; /* bit[20-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_TX_RRC_PILTER_EN 寄存器结构定义。地址偏移量:0xA14，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_tx_rrc_filter_en : 1;  /* bit[0]   : 数字滤波器使能信号，用来控制调制后数据是否经过16阶数字滤波器；默认值：0。 */
        unsigned long  reserved             : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_HARQ_RAM_WR_EN_BYPASS 寄存器结构定义。地址偏移量:0xA18，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_harq_ram_wr_en_bypass : 1;  /* bit[0]   : HARQ外置模式下，Harq Ram写使能超时保护旁路信号。此信号生效表示Harq Ram写使能不做超时保护。默认值为0，表示进行超时保护。 */
        unsigned long  reserved                  : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_TIMING_GET_TRIGGER 寄存器结构定义。地址偏移量:0xA20，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_timing_get_trigger   : 1;  /* bit[0]    : GBBP定时锁定启动信号，写1有效，自清零，该信号有效时，GBBP启动定时锁存。 */
        unsigned long  reserved_0               : 15; /* bit[1-15] : 保留 */
        unsigned long  cpu_timing_get_state_clr : 1;  /* bit[16]   : GBBP定时锁定状态清零信号，写1有效，自清零，该信号有效时，timing_get_state状态清零 */
        unsigned long  reserved_1               : 15; /* bit[17-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TIMING_GET_FN_RPT 寄存器结构定义。地址偏移量:0xA24，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  timing_get_fn_low   : 11; /* bit[0-10] : GTC此时实际帧号低位 */
        unsigned long  reserved_0          : 5;  /* bit[11-15]: 保留 */
        unsigned long  timing_get_fn_high  : 11; /* bit[16-26]: GTC此时实际帧号高位 */
        unsigned long  reserved_1          : 4;  /* bit[27-30]: 保留 */
        unsigned long  timing_get_fn_state : 1;  /* bit[31]   : 定时锁定状态上报，当cpu_timing_get_state_clr有效时该比特上报自行清零。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TIMING_GET_TIMEBASE_RPT 寄存器结构定义。地址偏移量:0xA28，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  timing_get_tdma_qb  : 13; /* bit[0-12] : 当前时刻TDMA的QB计数值 */
        unsigned long  reserved_0          : 3;  /* bit[13-15]: 保留 */
        unsigned long  timing_get_timebase : 13; /* bit[16-28]: 绝对时标QB上报，计数范围0~4999，对应一帧的长度。该值只与复位时刻有关，测试用 */
        unsigned long  reserved_1          : 3;  /* bit[29-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : LOOPC_MODE_CFG 寄存器结构定义。地址偏移量:0x3F0，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_loopc_mode : 1;  /* bit[0]   : 1标识：LoopC环回时，偷帧bit位置固定返回1’b0。
                                                          0标识：LoopC环回时，偷帧bit位置返回解调软值的符号位。 */
        unsigned long  reserved       : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : COD_CBINDEX_RPT 寄存器结构定义。地址偏移量:0x3F4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cod_cnt             : 4;  /* bit[0-3]  : 上行编码次数上报 */
        unsigned long  reserved_0          : 4;  /* bit[4-7]  : 保留 */
        unsigned long  gsp_ul_cb_start_pos : 2;  /* bit[8-9]  : 上行编码块起始位置上报 */
        unsigned long  reserved_1          : 6;  /* bit[10-15]: 保留 */
        unsigned long  gsp_ul_cb1_index    : 7;  /* bit[16-22]: 上行编码块的cbindex上报 */
        unsigned long  reserved_2          : 9;  /* bit[23-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_IQ_MOD_DTA 寄存器结构定义。地址偏移量:0x3C8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_q_mod_data : 12; /* bit[0-11] : 上行发射校准时强制Q路调制输出为该配置数据 */
        unsigned long  reserved_0     : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_i_mod_data : 12; /* bit[16-27]: 上行发射校准时强制I路调制输出为该配置数据 */
        unsigned long  reserved_1     : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TX_DATA_MULFACTOR 寄存器结构定义。地址偏移量:0x374，初值:0x03FF0399，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gmsk_tx_data_mulfactor : 10; /* bit[0-9]  : GMSK上行调制数据缩放因子，缩放幅度默认约为921/1024=0.9。 */
        unsigned long  reserved_0                 : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_psk_tx_data_mulfactor  : 10; /* bit[16-25]: 8PSK上行调制数据缩放因子，缩放幅度默认约为1023/1024=1。 */
        unsigned long  reserved_1                 : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : SLOT_DCR_RSSI_THRESHOLD 寄存器结构定义。地址偏移量:0x378，初值:0x00000B50，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_slot_dcr_rssi_threshold : 12; /* bit[0-11] : 时隙去直流启动门限，即时隙去直流是否启动取决于当前时隙的RSSI大小。当大于该门限时，如果配置时隙去直流模式，反之则不启动。默认门限-12'd1200，相当于-150dBm。由于空口接收信号不可能小于该值，相当于默认不屏蔽启动时隙去直流。 */
        unsigned long  reserved                    : 20; /* bit[12-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MOD_BIT0_RPT 寄存器结构定义。地址偏移量:0x3A0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  map_bit_0cpu : 30; /* bit[0-29] : GMSK待调制数据（编码后、调制前）上报，0～29比特，顺序为从低到高 */
        unsigned long  reserved     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MOD_BIT1_RPT 寄存器结构定义。地址偏移量:0x3A4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  map_bit_1cpu : 30; /* bit[0-29] : GMSK待调制数据（编码后、调制前）上报，30～59比特，顺序为从低到高 */
        unsigned long  reserved     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MOD_BIT2_RPT 寄存器结构定义。地址偏移量:0x3A8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  map_bit_2cpu : 30; /* bit[0-29] : GMSK待调制数据（编码后、调制前）上报，60～89比特，顺序为从低到高 */
        unsigned long  reserved     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MOD_BIT3_RPT 寄存器结构定义。地址偏移量:0x3AC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  map_bit_3cpu : 30; /* bit[0-29] : GMSK待调制数据（编码后、调制前）上报，90～119比特，顺序为从低到高 */
        unsigned long  reserved     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : MOD_BIT4_RPT 寄存器结构定义。地址偏移量:0x3B0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  map_bit_4cpu : 30; /* bit[0-29] : GMSK待调制数据（编码后、调制前）上报，120～147比特，顺序为从低到高。编码后最多148比特，[29:27]无意义 */
        unsigned long  reserved     : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TX_IQ_MISMATCH_COMP 寄存器结构定义。地址偏移量:0x8BC，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_tx_amp_comp   : 10; /* bit[0-9]  : GSM TX IQ Mismatch幅值校正因子，有符号数。 */
        unsigned long  reserved_0          : 6;  /* bit[10-15]: 保留 */
        unsigned long  cpu_g_tx_phase_comp : 10; /* bit[16-25]: GSM TX IQ Mismatch相位校正因子，有符号数。 */
        unsigned long  reserved_1          : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TX_IQ_DC_OFFSET_COMP 寄存器结构定义。地址偏移量:0x8C0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_tx_dc_offset_i : 12; /* bit[0-11] : GSM TX IQ Mismatch I路直流偏置补偿值，有符号数。注：减法处理。 */
        unsigned long  reserved_0           : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_tx_dc_offset_q : 12; /* bit[16-27]: GSM TX IQ Mismatch Q路直流偏置补偿值，有符号数。注：减法处理。 */
        unsigned long  reserved_1           : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TX_DIG_RMAP_MODE_SEL 寄存器结构定义。地址偏移量:0x8C4，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gmsk_digramp_en    : 1;  /* bit[0]    : gmsk数字爬坡使能信号。
                                                                   1表示gmsk使用数字爬坡；0表示gmsk不使用数字爬坡。 */
        unsigned long  reserved_0             : 7;  /* bit[1-7]  : 保留 */
        unsigned long  cpu_8psk_digramp_en    : 1;  /* bit[8]    : 8psk数字爬坡使能信号。
                                                                   1表示8psk使用数字爬坡；0表示8psk不使用数字爬坡。
                                                                   默认值为1。 */
        unsigned long  reserved_1             : 7;  /* bit[9-15] : 保留 */
        unsigned long  cpu_ramp_default_value : 10; /* bit[16-25]: 数字爬坡时，下坡结束后的apc_ramp默认值。
                                                                   默认值为0。
                                                                   调试用。 */
        unsigned long  reserved_2             : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_APC_SWITCH_EN 寄存器结构定义。地址偏移量:0x3C0，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_apc_page_switch_en : 1;  /* bit[0]    : GAPC爬坡系数配置RAM乒乓访问使能，1表示允许乒乓访问，0表示固定访问帧0系数空间；当该信号为1时，逻辑内部在TDMA帧头自动切换乒乓标志 */
        unsigned long  reserved_0             : 15; /* bit[1-15] : 保留 */
        unsigned long  pa_target_cpu          : 10; /* bit[16-25]: 上行使用的gsp_pa_target值上报 */
        unsigned long  reserved_1             : 6;  /* bit[26-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TEST_PIN_SEL_LOW 寄存器结构定义。地址偏移量:0x700，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  agc_test_pin_sel  : 4;  /* bit[0-3]  : 16组AGC模块的测试引脚选择信号 */
        unsigned long  mau_test_pin_sel  : 4;  /* bit[4-7]  : 16组MAU模块的测试引脚选择信号 */
        unsigned long  srch_test_pin_sel : 4;  /* bit[8-11] : 16组SRCH模块的测试引脚选择信号 */
        unsigned long  dem_test_pin_sel  : 4;  /* bit[12-15]: 16组VTB_DEM模块的测试选择信号引脚 */
        unsigned long  dec_test_pin_sel  : 4;  /* bit[16-19]: 16组DEC模块的测试引脚选择信号 */
        unsigned long  cod_test_pin_sel  : 4;  /* bit[20-23]: 16组COD模块的测试引脚选择信号 */
        unsigned long  mod_test_pin_sel  : 4;  /* bit[24-27]: 16组MOD模块的测试引脚选择信号 */
        unsigned long  gtc_test_pin_sel  : 4;  /* bit[28-31]: 16组GTC模块的测试引脚选择信号 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TEST_PIN_SEL_HIGH 寄存器结构定义。地址偏移量:0x704，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  prefilter_test_pin_sel  : 4;  /* bit[0-3]  : 16组PREFILTER模块的测试引脚选择信号 */
        unsigned long  preprocess_test_pin_sel : 4;  /* bit[4-7]  : 16组PREPROCESS模块的测试引脚选择信号 */
        unsigned long  apc_test_pin_sel        : 4;  /* bit[8-11] : 16组APC模块的测试引脚选择信号 */
        unsigned long  reserved_0              : 4;  /* bit[12-15]: 保留 */
        unsigned long  grif_test_pin_sel       : 4;  /* bit[16-19]: 16组GRIF模块的测试引脚选择信号 */
        unsigned long  deciph_test_pin_sel     : 4;  /* bit[20-23]: 16组A5 DECIPH模块的测试引脚选择信号 */
        unsigned long  ciph_test_pin_sel       : 4;  /* bit[24-27]: 16组A5 CIPH模块的测试引脚选择信号 */
        unsigned long  reserved_1              : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : TEST_MODULE_SEL 寄存器结构定义。地址偏移量:0x710，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gbbp_module_test_sel_low  : 5;  /* bit[0-4] : 0：选择AGC模块的测试引脚
                                                                     1：选择乘累加模块的测试引脚
                                                                     2：选择搜索模块的测试引脚
                                                                     3：选择解调模块的测试引脚
                                                                     4：选择译码模块的测试引脚
                                                                     ...
                                                                     13：选择GRIF模块的测试引脚
                                                                     14：选择A5 CIPH模块的测试引脚 */
        unsigned long  gbbp_module_test_sel_high : 3;  /* bit[5-7] : 0表示可以选择DAGC输出数据采样的相关控制信号
                                                                     1表示可以选择AGC输入数据采样的相关控制信号
                                                                     2表示可以选择DAGC输出和解调后软值数据采样的相关控制信号
                                                                     3表示可以选择DAGC输出和AGC输入数据采样的相关控制信号
                                                                     4表示可以观察解调，译码启动信号和中断信号 */
...
/*****************************************************************************
 ...
 结构说明  : GSP_START_TDMA_QB_RPT 寄存器结构定义。地址偏移量:0x714，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  gsp_start_tdma_qb    : 13; /* bit[0-12] : 对应GTC解析出的各个启动信号所在tdma_qb值上报。 */
        unsigned long  reserved             : 15; /* bit[13-27]: 保留 */
        unsigned long  cpu_sample_start_sel : 4;  /* bit[28-31]: 4'd0: gsp_agc_fast_start信号对应的gtc_tdma_qb采样值
                                                                 4'd1: gsp_agc_slow_start信号对应的gtc_tdma_qb采样值
                                                                 4'd2: gsp_srch_start信号对应的gtc_tdma_qb采样值
                                                                 4'd3: gsp_demod_start信号对应的gtc_tdma_qb采样值
                                                                 4'd4: gsp_rx_start信号对应的gtc_tdma_qb采样值
...
/*****************************************************************************
 ...
 结构说明  : ERR_TRIG 寄存器结构定义。地址偏移量:0x764，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  err_trig : 1;  /* bit[0]   : 罗分trigger信号，用于平台问题定位使用。 */
        unsigned long  reserved : 31; /* bit[1-31]: 保留 */
    } reg;
} GBBP_ERR_TRIG_UNION;
...
/*****************************************************************************
 ...
 结构说明  : GBBP_EDGE_VERSION 寄存器结构定义。地址偏移量:0x768，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  edge_flag : 1;  /* bit[0]   : V2R1版本，该bit必须为1，测试用 */
        unsigned long  reserved  : 31; /* bit[1-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY5 寄存器结构定义。地址偏移量:0x29C，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_5d : 19; /* bit[0-18] : 第五近的一个BURST解调前粗测C值上报，测试用 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY5 寄存器结构定义。地址偏移量:0x300，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_5d : 15; /* bit[0-14] : 第五近的一个BURST解调前粗测I值上报，测试用 */
        unsigned long  reserved   : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_CARRIER_ENERGY6 寄存器结构定义。地址偏移量:0x304，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_c_6d : 19; /* bit[0-18] : 第六近的一个BURST解调前粗测C值上报，测试用 */
        unsigned long  reserved   : 13; /* bit[19-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : GROSS_INTERFERE_ENERGY6 寄存器结构定义。地址偏移量:0x308，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  thres_i_6d : 15; /* bit[0-14] : 第六近的一个BURST解调前粗测I值上报，测试用 */
        unsigned long  reserved   : 17; /* bit[15-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN5_CPU 寄存器结构定义。地址偏移量:0x290，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_5d     : 3;  /* bit[0-2]  : 第五近一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_5d          : 12; /* bit[8-19] : 第五近一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_5d     : 3;  /* bit[24-26]: 第五近一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_5d : 1;  /* bit[31]   : 第五近一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : AAGC_GAIN6_CPU 寄存器结构定义。地址偏移量:0x294，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  next_gain_6d     : 3;  /* bit[0-2]  : 最远一个时隙AGC期望控制增益。 */
        unsigned long  reserved_0       : 5;  /* bit[3-7]  : 保留 */
        unsigned long  rssi_6d          : 12; /* bit[8-19] : 最远一个时隙AGC RSSI值，单位0.125dBm，上报给CPU。该值已是空口的RSSI值。 */
        unsigned long  reserved_1       : 4;  /* bit[20-23]: 保留 */
        unsigned long  curr_gain_6d     : 3;  /* bit[24-26]: 最远一个时隙AAGC档位上报。 */
        unsigned long  reserved_2       : 4;  /* bit[27-30]: 保留 */
        unsigned long  agc_fast_flag_6d : 1;  /* bit[31]   : 最远一个时隙快慢速测量标志上报。1表示当前为快速测量，0表示当前为慢速测量。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GDUMP_GEN_CONFIG 寄存器结构定义。地址偏移量:0x004，初值:0x00000013，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dump_fifo_watermarker_g : 3;  /* bit[0-2] : FIFO水线深度选择。
                                                                   0：表示水线深度2；
                                                                   1：表示水线深度4；
                                                                   2：表示水线深度8；
                                                                   3：表示水线深度16；
                                                                   ...
                                                                   SOC水线深度支持1~16 */
        unsigned long  reserved_0              : 1;  /* bit[3]   : 保留 */
        unsigned long  cpu_sample_data_sel     : 3;  /* bit[4-6] : 采样数据源选择。
                                                                   0：选择采用信道滤波器输入数据；
                                                                   1：选择采用信道滤波器输出数据；
                                                                   2：选择采用AGC输入数据；
                                                                   3：选择采用AGC去直流后且用于测量的数据；
                                                                   ...
                                                                   7： */
        unsigned long  reserved_1              : 1;  /* bit[7]   : 保留 */
        unsigned long  cpu_sample_config_sel   : 1;  /* bit[8]   : 采数模块配置类型选择。
                                                                   0：选择使用GTC配置接口
                                                                   1：选择使用CPU配置接口
                                                                   默认配置为0。 */
        unsigned long  reserved_2              : 22; /* bit[9-30]: 保留 */
        unsigned long  dump_en_g               : 1;  /* bit[31]  : 采数模块总是能，并控制时钟门控，无论哪种模式采数，首先要配置此信号有效，高电平表示该功能打开。 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GDUMP_SAM_LOW_TIMING 寄存器结构定义。地址偏移量:0x00C，初值:0x00001FFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dump_gtc_tdma_qb : 13; /* bit[0-12] : 可配启动时刻采数模式下，采数起始位置，35'h7ffffffff表示立即启动。该配置为35bit中[12:0]，默认值为立即启动模式。 */
        unsigned long  reserved         : 19; /* bit[13-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GDUMP_SAM_HIGH_TIMING 寄存器结构定义。地址偏移量:0x010，初值:0x07FF07FF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  dump_gtc_fn_low  : 11; /* bit[0-10] : 可配启动时刻采数模式下，采数起始位置，35'h7ffffffff表示立即启动。该配置为35bit中[23:13]，默认值为立即启动模式。 */
        unsigned long  reserved_0       : 5;  /* bit[11-15]: 保留 */
        unsigned long  dump_gtc_fn_high : 11; /* bit[16-26]: 可配启动时刻采数模式下，采数起始位置，35'h7ffffffff表示立即启动。该配置为35bit中[34:24]，默认值为立即启动模式。 */
        unsigned long  reserved_1       : 5;  /* bit[27-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CPU_GDUMP_RECV_CONFIG 寄存器结构定义。地址偏移量:0x014，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_rx_start : 1;  /* bit[0]    : CPU配置采样数据启动信号。 */
        unsigned long  reserved_0   : 7;  /* bit[1-7]  : 保留 */
        unsigned long  cpu_rx_stop  : 1;  /* bit[8]    : CPU配置采样数据停止信号，当采样数据个数无限长时，用该信号停止采数。 */
        unsigned long  reserved_1   : 7;  /* bit[9-15] : 保留 */
        unsigned long  cpu_fifo_clr : 1;  /* bit[16]   : CPU配置异步FIFO清零信号。 */
        unsigned long  reserved_2   : 15; /* bit[17-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_1REG 寄存器结构定义。地址偏移量:0x294，初值:0x0FFD0001，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h0_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数0,12bit有符号数 */
        unsigned long  reserved_0      : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h1_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数1,12bit有符号数 */
        unsigned long  reserved_1      : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_2REG 寄存器结构定义。地址偏移量:0x298，初值:0x0FFA0FFA，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h2_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数2,12bit有符号数 */
        unsigned long  reserved_0      : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h3_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数3,12bit有符号数 */
        unsigned long  reserved_1      : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_3REG 寄存器结构定义。地址偏移量:0x29C，初值:0x00060FFF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h4_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数4,12bit有符号数 */
        unsigned long  reserved_0      : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h5_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数5,12bit有符号数 */
        unsigned long  reserved_1      : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_4REG 寄存器结构定义。地址偏移量:0x2A0，初值:0x000C000C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h6_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数6,12bit有符号数 */
        unsigned long  reserved_0      : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h7_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数7,12bit有符号数 */
        unsigned long  reserved_1      : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_5REG 寄存器结构定义。地址偏移量:0x2A4，初值:0x0FF40002，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h8_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数8,12bit有符号数 */
        unsigned long  reserved_0      : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h9_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数9,12bit有符号数 */
        unsigned long  reserved_1      : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_6REG 寄存器结构定义。地址偏移量:0x2A8，初值:0x0FEB0FE9，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h10_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数10,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h11_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数11,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_7REG 寄存器结构定义。地址偏移量:0x2AC，初值:0x00160FFD，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h12_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数12,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h13_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数13,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_8REG 寄存器结构定义。地址偏移量:0x2B0，初值:0x00220027，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h14_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数14,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h15_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数15,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_9REG 寄存器结构定义。地址偏移量:0x2B8，初值:0x0FDB0004，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h16_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数16,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h17_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数17,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_10REG 寄存器结构定义。地址偏移量:0x2C4，初值:0x0FC90FBF，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h18_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数18,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h19_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数19,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_11REG 寄存器结构定义。地址偏移量:0x2C8，初值:0x00400FFC，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h20_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数20,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h21_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数21,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_12REG 寄存器结构定义。地址偏移量:0x2CC，初值:0x005D006E，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h22_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数22,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h23_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数23,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_13REG 寄存器结构定义。地址偏移量:0x2D0，初值:0x0F890005，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h24_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数24,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h25_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数25,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_14REG 寄存器结构定义。地址偏移量:0x2D4，初值:0x0F490F31，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h26_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数26,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h27_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数27,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_15REG 寄存器结构定义。地址偏移量:0x2D8，初值:0x01300FFB，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h28_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数28,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h29_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数29,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_16REG 寄存器结构定义。地址偏移量:0x2DC，初值:0x03AE0293，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h30_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数30,12bit有符号数 */
        unsigned long  reserved_0       : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_ch_h31_ext : 12; /* bit[16-27]: GSM下行信道滤波配置系数31,12bit有符号数 */
        unsigned long  reserved_1       : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_CH_PARA_17REG 寄存器结构定义。地址偏移量:0x2E0，初值:0x00000419，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_ch_h32_ext : 12; /* bit[0-11] : GSM下行信道滤波配置系数32,12bit有符号数 */
        unsigned long  reserved         : 20; /* bit[12-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_1REG 寄存器结构定义。地址偏移量:0x31C，初值:0x0FD80FEC，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h0_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数0,12bit有符号数 */
        unsigned long  reserved_0        : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h1_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数1,12bit有符号数 */
        unsigned long  reserved_1        : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_2REG 寄存器结构定义。地址偏移量:0x320，初值:0x0FE80FD0，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h2_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数2,12bit有符号数 */
        unsigned long  reserved_0        : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h3_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数3,12bit有符号数 */
        unsigned long  reserved_1        : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_3REG 寄存器结构定义。地址偏移量:0x324，初值:0x004C0018，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h4_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数4,12bit有符号数 */
        unsigned long  reserved_0        : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h5_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数5,12bit有符号数 */
        unsigned long  reserved_1        : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_4REG 寄存器结构定义。地址偏移量:0x328，初值:0x0038005C，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h6_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数6,12bit有符号数 */
        unsigned long  reserved_0        : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h7_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数7,12bit有符号数 */
        unsigned long  reserved_1        : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_5REG 寄存器结构定义。地址偏移量:0x32C，初值:0x0F780FE0，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h8_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数8,12bit有符号数 */
        unsigned long  reserved_0        : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h9_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数9,12bit有符号数 */
        unsigned long  reserved_1        : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_6REG 寄存器结构定义。地址偏移量:0x330，初值:0x0F700F40，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h10_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数10,12bit有符号数 */
        unsigned long  reserved_0         : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h11_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数11,12bit有符号数 */
        unsigned long  reserved_1         : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_7REG 寄存器结构定义。地址偏移量:0x334，初值:0x01480028，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h12_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数12,12bit有符号数 */
        unsigned long  reserved_0         : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h13_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数13,12bit有符号数 */
        unsigned long  reserved_1         : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_8REG 寄存器结构定义。地址偏移量:0x338，初值:0x037C0284，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h14_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数14,12bit有符号数 */
        unsigned long  reserved_0         : 4;  /* bit[12-15]: 保留 */
        unsigned long  cpu_g_32ch_h15_ext : 12; /* bit[16-27]: GSM下行32阶信道滤波配置系数15,12bit有符号数 */
        unsigned long  reserved_1         : 4;  /* bit[28-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_G_32CH_PARA_9REG 寄存器结构定义。地址偏移量:0x33C，初值:0x000003D8，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_g_32ch_h16_ext : 12; /* bit[0-11] : GSM下行32阶信道滤波配置系数16,12bit有符号数 */
        unsigned long  reserved           : 20; /* bit[12-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : CLIP_MODE_SEL 寄存器结构定义。地址偏移量:0x2E8，初值:0x00000000，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_gain0_clip_mode_sel : 2;  /* bit[0-1]  : ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_0              : 2;  /* bit[2-3]  : 保留 */
        unsigned long  cpu_gain1_clip_mode_sel : 2;  /* bit[4-5]  : ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_1              : 2;  /* bit[6-7]  : 保留 */
        unsigned long  cpu_gain2_clip_mode_sel : 2;  /* bit[8-9]  : ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_2              : 2;  /* bit[10-11]: 保留 */
        unsigned long  cpu_gain3_clip_mode_sel : 2;  /* bit[12-13]: ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_3              : 2;  /* bit[14-15]: 保留 */
        unsigned long  cpu_gain4_clip_mode_sel : 2;  /* bit[16-17]: ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_4              : 2;  /* bit[18-19]: 保留 */
        unsigned long  cpu_gain5_clip_mode_sel : 2;  /* bit[20-21]: ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_5              : 2;  /* bit[22-23]: 保留 */
        unsigned long  cpu_gain6_clip_mode_sel : 2;  /* bit[24-25]: ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_6              : 2;  /* bit[26-27]: 保留 */
        unsigned long  cpu_gain7_clip_mode_sel : 2;  /* bit[28-29]: ABB下行接收滤波器输出数据截位限幅处理模式选择。2'd0：输出数据右移12bit后限幅至14bit；2'd1：输出数据右移11bit后限幅至14bit；2'd2：输出数据右移10bit后限幅至14bit；默认配置2'd1。 */
        unsigned long  reserved_7              : 2;  /* bit[30-31]: 保留 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_MEM_CTRL1 寄存器结构定义。地址偏移量:0x018，初值:0x03500057，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mem_ctrl_d_1rw2rw_w1 : 16; /* bit[0-15] : 1w2rw双口RAM延时控制 */
        unsigned long  mem_ctrl_d_1w2r_w1   : 16; /* bit[16-31]: 1w2r双口RAM延时控制 */
    } reg;
...
/*****************************************************************************
 ...
 结构说明  : ADDR_MEM_CTRL2 寄存器结构定义。地址偏移量:0x01C，初值:0x00601020，宽度:32
 寄存器说明: 
*****************************************************************************/
typedef union
{
    ...
    struct
    {
        unsigned long  mem_ctrl_s_w1 : 16; /* bit[0-15] : 单口RAM延时控制 */
        unsigned long  rom_ctrl      : 8;  /* bit[16-23]: ROM延时控制 */
        unsigned long  reserved      : 8;  /* bit[24-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  rf_ssi_afc_ch_info  : 2;  /* bit[30-31]: 使用晶体AFC方案时的通道指示。
                                                                00：表示将该条SSI发送到channel0；
                                                                01：表示发送到channel1；
                                                                10：表示发送到channel2；
                                                                11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  rf_ssi_wrone_end_cpu     : 1;  /* bit[28-28]: 使用CPU方式将一个RF-SSI配置是否发送至BBP COMM模块的状态信号，测试用。
                                                                     0：表示结束，1表示未结束。 */
        unsigned long  reserved_1               : 1;  /* bit[29]   : 保留 */
        unsigned long  rf_ssi_wrone_ch_info     : 2;  /* bit[30-31]: GDSP使用CPU方式配置一个RF-SSI的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  cpu_rfic_ssi_rd0_ch_info : 2;  /* bit[30-31]: SSI回读配置数据0的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd1_ch_info : 2;  /* bit[30-31]: SSI回读配置数据1的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd2_ch_info : 2;  /* bit[30-31]: SSI回读配置数据2的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd3_ch_info : 2;  /* bit[30-31]: SSI回读配置数据3的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd4_ch_info : 2;  /* bit[30-31]: SSI回读配置数据4的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd5_ch_info : 2;  /* bit[30-31]: SSI回读配置数据5的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd6_ch_info : 2;  /* bit[30-31]: SSI回读配置数据6的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  reserved                 : 6;  /* bit[24-29]: 保留 */
        unsigned long  cpu_rfic_ssi_rd7_ch_info : 2;  /* bit[30-31]: SSI回读配置数据7的通道指示。
                                                                     00：表示将该条SSI发送到channel0；
                                                                     01：表示发送到channel1；
                                                                     10：表示发送到channel2；
                                                                     11：表示发送到channel3； */
...
typedef union
{
    ...
    struct
    {
        unsigned long  cpu_mipi_cmd_ini_addr : 7;  /* bit[0-6]  : 软件方式配置MIPI请求时，配置寄存器组的首地址。 */
        unsigned long  reserved_0            : 1;  /* bit[7]    : 保留 */
        unsigned long  cpu_mipi_cmd_num      : 7;  /* bit[8-14] : 软件方式配置MIPI请求时，配置寄存器的个数。配置范围：1～127。 */
        unsigned long  reserved_1            : 1;  /* bit[15]   : 保留 */
...
typedef union
{
    ...
    struct
    {
        unsigned long  data_fifo_rst       : 1;  /* bit[0-0] : fifo复位信号，在FIFO状态异常时，配置为1，进行清零 */
        unsigned long  data_fifo_full_rpt  : 1;  /* bit[1-1] : FIFO满信号上报 */
        unsigned long  data_fifo_empty_rpt : 1;  /* bit[2-2] : FIFO空信号上报 */
        unsigned long  reserved            : 29; /* bit[3-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned long  g_rfic_ssi_ram_addr    : 8;  /* bit[16-23]: g本频或强配的rfic-ssi RAM。
                                                                   数据：
                                                                   [23:16]：rfic的寄存器地址； */
        unsigned long  g_rfic_ssi_ram_ch_info : 2;  /* bit[24-25]: g本频或强配的rfic-ssi RAM。
                                                                   数据通道指示。 */
        unsigned long  reserved               : 6;  /* bit[26-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned long  gtc_cfg_data : 16; /* bit[0-15] : GTC指令配置RAM，每个32bit中只有低16bit有效。 */
        unsigned long  reserved     : 16; /* bit[16-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned long  ul_map_cfg_data : 30; /* bit[0-29] : CPU下发的待调制数据，低30bit有效 */
        unsigned long  reserved        : 2;  /* bit[30-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned long  dc_offset_rfic_i : 14; /* bit[0-13] : 直流偏执调整值粗调值存储RAM访问地址，一个地址表示28bit，其中低16bit中的14bit表示I路，高16bit中的14bit为Q路。配置的14bit为有符号数。 */
        unsigned long  reserved_0       : 2;  /* bit[14-15]: 保留 */
        unsigned long  dc_offset_rfic_q : 14; /* bit[16-29]: 直流偏执调整值粗调值存储RAM访问地址，一个地址表示28bit，其中低16bit中的14bit表示I路，高16bit中的14bit为Q路。配置的14bit为有符号数。 */
        unsigned long  reserved_1       : 2;  /* bit[30-31]: 保留 */
    } reg;
...
typedef union
{
    ...
    struct
    {
        unsigned long  channel_gain_rfic : 11; /* bit[0-10] : 前向通道增益调整值存储RAM。CHANNEL_GAIN参考配置参见表19，此表在实际使用时，需要进行实测后得出。 */
