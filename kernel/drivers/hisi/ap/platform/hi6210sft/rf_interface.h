...
#define HAL_RF_TDD_CONFIG1_ADDR                             ( 0x00 )            /* TDD Datapath Configuration */
#define HAL_RF_TDD_CONFIG2_ADDR                             ( 0x01 )            /* TDD Datapath Configuration */
#define HAL_RF_FDD_TX_CONFIG_ADDR                           ( 0x02 )            /* FDD TX Operational Mode and Band Selection */
#define HAL_RF_TX_AGC_ADDR                                  ( 0x03 )            /* TX Gain Control */
#define HAL_RF_FDD_RX_CONFIG_ADDR                           ( 0x04 )            /* FDD RX Datapath Configuration */
#define HAL_RF_RX_MAIN_AGC_ADDR                             ( 0x05 )            /* RX Main Gain Control */
#define HAL_RF_RX_DVTY_AGC_ADDR                             ( 0x06 )            /* RXIF Diversity Gain Control */
#define HAL_RF_RX_MAIN_DCOC_VALUE_ADDR                      ( 0x07 )            /* RX Main DCOC Offset/Correction Value */
#define HAL_RF_RX_DVTY_DCOC_VALUE_ADDR                      ( 0x08 )            /* RX Diversity DCOC Offset/Correction Value */
#define HAL_RF_RX_MAIN_IIP2_CAL_ADDR                        ( 0x09 )            /* RX Main IIP2 Calibration */
#define HAL_RF_RX_DVTY_IIP2_CAL_ADDR                        ( 0x0A )            /* RX Diversity IIP2 Calibration */
#define HAL_RF_CFIX_ADDR                                    ( 0x0B )            /* RF CFIX */
#define HAL_RF_REG10H_ADDR                                  ( 0x10 )
#define HAL_RF_REG11H_ADDR                                  ( 0x11 )
#define HAL_RF_TX_FEEDBACK_CONTROL_ADDR                     ( 0x12 )            /* TX Feeedback control register  */
#define HAL_RF_TX_FEEDBACK_DATA_1_ADDR                      ( 0x13 )            /* TX Feedback ADC readback data */
#define HAL_RF_OPERATING_BANDGROUP_ADDR                     ( 0x14 )            /* Transceiver Operating Band */
#define HAL_RF_RX_TX_TUNING_ADDR                            ( 0x15 )            /* RX / TX Datapath Tuning */
#define HAL_RF_XO_AFC_CTL_ADDR                              ( 0x16 )            /* XTAL Frequency Calibration  */
#define HAL_RF_RXRF_LNA_CTUNE_LUT_LB_ADDR                   ( 0x17 )            /* LNA Input Capacitor Tuning Look Up Table 1 for Low Band RF */
#define HAL_RF_RXRF_LNA_CTUNE_LUT_HB_ADDR                   ( 0x18 )            /* LNA Input Capacitor Tuning Look Up Table 1 for High Band RF */
#define HAL_RF_RXRF_LNA_CTUNE_LUT_UHB_ADDR                  ( 0x19 )            /* LNA Input Capacitor Tuning Look Up Table 2 for UltraHigh Band RF */
#define HAL_RF_RXRF_TANKTUNE_LUT_ADDR                       ( 0x1A )            /* RX Balun Tuning LUT */
#define HAL_RF_TXRF_LOADTUNE_LUT_1_ADDR                     ( 0x1B )            /* TX Load  Tuning LUT */
#define HAL_RF_TXRF_LOADTUNE_LUT_2_ADDR                     ( 0x1C )            /* TX Load  Tuning LUT */
#define HAL_RF_TXRF_LOADTUNE_LUT_3_ADDR                     ( 0x1D )            /* TX Load  Tuning LUT */
#define HAL_RF_TXRF_LOADTUNE_LUT_4_ADDR                     ( 0x1E )            /* TX Load  Tuning LUT */
#define HAL_RF_TXRF_LOADTUNE_LUT_5_ADDR                     ( 0x1F )            /* TX Load  Tuning LUT */
#define HAL_RF_RFIC_IO_CTRL_ADDR                            ( 0x20 )            /* RFIC Digital IO Control */

/********************  Transceiver Misc Controls ******************* *****/
#define HAL_RF_RFIC_CLK_CTRL_ADDR                           ( 0x21 )            /* RFIC Clock Domain Control */
#define HAL_RF_GPIO_CTRL_ADDR                               ( 0x22 )            /* GPIO control */
#define HAL_RF_GPIO_STATUS_ADDR                             ( 0x23 )            /* GPIO Status */
#define HAL_RF_RFIC_DEBUG_CFG_ADDR                          ( 0x24 )            /* RFIC Debug Controls */
#define HAL_RF_RFIC_CHIP_ID_ADDR                            ( 0x25 )            /* Chip ID register */
#define HAL_RF_RFIC_PULSEGEN_ADDR                           ( 0x26 )            /* Pulse generator for debug or other use */
#define HAL_RF_RFIC_TESTSEL1_ADDR                           ( 0x27 )            /* Control IO muxing for TESTMUX */
#define HAL_RF_RFIC_TESTSEL2_ADDR                           ( 0x28 )            /* Control IO muxing for Digital test mux which feeds the analog testmux */
#define HAL_RF_RFIC_TESTMUX_ADDR                            ( 0x29 )            /* TESTMUX */
#define HAL_RF_RFIC_ANALOG_TESTMUX_ADDR                     ( 0x2A )            /* Analog TestMux Select */

/********************  Top Calibration Control **************************/
#define HAL_RF_REXTCAL_CTRL_ADDR                            ( 0x2B )            /* CAL_TOP BandGap and R-Cal Control  */
#define HAL_RF_REXTCAL_DATA_ADDR                            ( 0x2C )            /* R-Cal Engine Status Bits (read-only) */
#define HAL_RF_RCCAL_CTRL_ADDR                              ( 0x2D )            /* RC Calibration Control for RX and TX path */
#define HAL_RF_RCCAL_DATA_ADDR                              ( 0x2E )            /* RC Calibration words to RX and TX path */

/******************** TDD Registers *************************************/
#define HAL_RF_TDD_2G_FSM_TIME_ADDR                         ( 0x30 )            /* TDD Sequencer Timer Values for 2G Mode */
#define HAL_RF_TDD_3G4G_FSM_TIME_ADDR                       ( 0x31 )             /* TDD Sequencer Timer Values for 3G/4G Mode */

/******************** TX Registers *************************************/
#define HAL_RF_TX_EN_ADDR                                   ( 0x38 )            /* TX Debug Configuration : Enable & mode selection */
#define HAL_RF_TX_BIAS_CFG_ADDR                             ( 0x39 )            /* TX Configuration : RF Tuned Circuit Control */
#define HAL_RF_TX_FSM_TIME_ADDR                             ( 0x3A )            /* TX State Machine Timer Values */
#define HAL_RF_TX_DEBUG_CFG_ADDR                            ( 0x3B )            /* TX Test Control and Debug Mode Override */
#define HAL_RF_TX_FEEDBACK_DEBUG_ADDR                       ( 0x3C )            /* Non-user controls for the TX FB circuits */
#define HAL_RF_TX_SPARE_1_ADDR                              ( 0x3D )            /* Spare register for TX Analog/RF control */
...
/****************** IRCAL Control **************************************/
#define HAL_RF_IRCAL_PHASE_CORRECTION_ADDR                  ( 0x50 )            /* IRCAL phase correction values */

/****************** RX Registers **************************************/
#define HAL_RF_RX_DEBUG_ADDR                                ( 0x60 )            /* RX Datapath Controls - Bandgap and LDO Enables */
#define HAL_RF_RX_CTRL_ADDR                                 ( 0x61 )            /* RX Datapath Controls -  Mixer/DCOC */
#define HAL_RF_RX_LNA_ADDR                                  ( 0X62 )
#define HAL_RF_RX_FREQUENCY_CONTROL_ADDR                    ( 0x63 )            /* RX Frequency/Bandwidth Control */
#define HAL_RF_RX_2G_FSM_TIME_ADDR                          ( 0x64 )            /* RX DC Offset Correction (RESERVED in Hi6360V110) */
#define HAL_RF_RX_3G4G_FSM_TIME_ADDR                        ( 0x65 )            /* RX DC Offset Correction (RESERVED in Hi6360V110) */
#define HAL_RF_RX_MAIN_LNA_ADDR                             ( 0x68 )            /* RXRF main path LNA settings */
#define HAL_RF_RX_MAIN_DCOC_OUT_ADDR                        ( 0x69 )            /* The computed DC output offset of the I and Q channel of RX A (RESERVED in Hi6360V110) */
#define HAL_RF_RX_DVTY_LNA_ADDR                             ( 0x70 )            /* RXRF Diversity path LNA settings */
#define HAL_RF_RX_DVTY_DCOC_OUT_ADDR                        ( 0x71 )            /* The computed DC output offset of the I and Q channel of RX B (RESERVED in Hi6360V110) */
#define HAL_RF_RX_SPARE0_REG_ADDR                           ( 0x78 )            /* RX Spare Register for analog use */
#define HAL_RF_RX_SPARE1_REG_ADDR                           ( 0x79 )            /* RX Spare Register for digital use */

/****************** FNPLL-TX Registers ********************************/
#define HAL_RF_PLLTX_MODE_ADDR                              ( 0x80 )            /* PLL Calibration/Mode Register  */
#define HAL_RF_PLLTX_FREQ1_ADDR                             ( 0x81 )            /* TX Frequency Register 1 (must write FREQ2 to trigger data transfer to FREQ1 and FREQ2) */
#define HAL_RF_PLLTX_FREQ2_ADDR                             ( 0x82 )            /* TX Frequency Register 2 (triggers write to both FREQ1 and FREQ2) */
#define HAL_RF_PLLTX_PWR_LDO_ADDR                           ( 0x83 )            /* TX PLL LDO voltage selection field(s) */
#define HAL_RF_PLLTX_PWR_VCO_ADDR                           ( 0x84 )            /* TX PLL VCO VReg Configuration */
#define HAL_RF_PLLTX_CTRL_FSM_ADDR                          ( 0x85 )            /* TX PLL Sequencer Sub-Block Control */
#define HAL_RF_PLLTX_VCO_ATEMP_ADDR                         ( 0x86 )            /* TX VCO ATEMP Mode Control Register  */
#define HAL_RF_PLLTX_CP_ADDR                                ( 0x87 )            /* Tx Charge Pump settings */
#define HAL_RF_PLLTX_LPF_ADDR                               ( 0x89 )            /* TX Loop filter switch control.  There are 5 switches in each loop filter.  0: Switch open, 1: Switch closed */
#define HAL_RF_PLLTX_CTL_ADDR                               ( 0x8A )            /* TX PLL Loop Controller Configuration */
#define HAL_RF_PLLTX_RCCAL_ADDR                             ( 0x8B )            /* Tx RC Calibration settings */
#define HAL_RF_PLLTX_CT_1_ADDR                              ( 0x8C )            /* Tx Coarse tuning settings, register 1 */
#define HAL_RF_PLLTX_CT_2_ADDR                              ( 0x8D )            /* TX Coarse tuning settings, register 2 */
#define HAL_RF_PLLTX_CT_3_ADDR                              ( 0x8E )            /* TX Coarse tuning settings, register 3 */
#define HAL_RF_PLLTX_KVCAL_1_ADDR                           ( 0x8F )            /* TX Kv calibration settings, register 1 */
#define HAL_RF_PLLTX_KVCAL_2_ADDR                           ( 0x90 )            /* TX Kv calibration settings, register 2 */
#define HAL_RF_PLLTX_PHZ_SLIP_ADDR                          ( 0x91 )            /* TX PLL Phase Slipper Control */
#define HAL_RF_PLLTX_CTC_ADDR                               ( 0x92 )            /* TX PLL Coarse Tune Check Thresholds */
#define HAL_RF_PLLTX_WAIT_TIME_ADDR                         ( 0x93 )            /* TX PLL WarmUp and Lock Times */
#define HAL_RF_PLLTX_TEST_1_ADDR                            ( 0x98 )            /* PLL Test Mux and Feedback Control */
#define HAL_RF_PLLTX_TEST_2_ADDR                            ( 0x99 )            /* PLL Control signals to pause the loop state machines at a specified state. */
#define HAL_RF_PLLTX_VCO_COUNT_RD_ADDR                      ( 0xA0 )            /* TX LFSR BIST count readback */
#define HAL_RF_PLLTX_FREQERRFLAG_RD_ADDR                    ( 0xA1 )            /* TX LFSR BIST frequency error flag */
#define HAL_RF_PLLTX_RC_VAL_RD_ADDR                         ( 0xA2 )            /* Tx RC calibration values */
#define HAL_RF_PLLTX_KV_FREQ_RD_ADDR                        ( 0xA3 )            /* TX Kv compensation F0 Frequency Measurement */
#define HAL_RF_PLLTX_KV_CP_VAL_RD_ADDR                      ( 0xA4 )            /* Kv compensation result: charge pump value */
#define HAL_RF_PLLTX_CT_VAL_RD_ADDR                         ( 0xA5 )            /* TX Coarse Tuning Result */
#define HAL_RF_PLLTX_RSM_STATE_RD_ADDR                      ( 0xA6 )            /* PLL State Machine State */
#define HAL_RF_PLLTX_SPARE0_REG_ADDR                        ( 0xA7 )            /* control register */

/****************** FNPLL-RX Registers ******************************/
#define HAL_RF_PLLRX_MODE_ADDR                              ( 0xC0 )            /* PLL Calibration/Mode Register  */
#define HAL_RF_PLLRX_FREQ1_ADDR                             ( 0xC1 )            /* RX Frequency Register 1 (must write FREQ2 to trigger data transfer to FREQ1 and FREQ2) */
#define HAL_RF_PLLRX_FREQ2_ADDR                             ( 0xC2 )            /* RX Frequency Register 2 (triggers write to both FREQ1 and FREQ2) */
#define HAL_RF_PLLRX_PWR_LDO_ADDR                           ( 0xC3 )            /* RX PLL LDO voltage selection field(s) */
#define HAL_RF_PLLRX_PWR_VCO_ADDR                           ( 0xC4 )            /* RX PLL VCO VReg Configuration */
#define HAL_RF_PLLRX_CTRL_FSM_ADDR                          ( 0xC5 )            /* RX PLL Sequencer Sub-Block Control */
#define HAL_RF_PLLRX_VCO_ATEMP_ADDR                         ( 0xC6 )            /* RX Charge Pump settings */
#define HAL_RF_PLLRX_CP_ADDR                                ( 0xC7 )            /* RX Charge Pump settings */
#define HAL_RF_PLLRX_LPF_ADDR                               ( 0xC9 )            /* RX Loop filter switch control.  There are 5 switches in each loop filter.  0: Switch open, 1: Switch closed */
#define HAL_RF_PLLRX_CTL_ADDR                               ( 0xCA )            /* RX PLL Loop Controller Configuration */
#define HAL_RF_PLLRX_RCCAL_ADDR                             ( 0xCB )            /* RX RC Calibration settings */
#define HAL_RF_PLLRX_CT_1_ADDR                              ( 0xCC )            /* RX coarse tuning settings, register 1 */
#define HAL_RF_PLLRX_CT_2_ADDR                              ( 0xCD )            /* RX Coarse tuning settings, register 2 */
#define HAL_RF_PLLRX_CT_3_ADDR                              ( 0xCE )            /* RX Coarse tuning settings, register 3 */
#define HAL_RF_PLLRX_KVCAL_1_ADDR                           ( 0xCF )            /* RX Kv calibration settings, register 1 */
#define HAL_RF_PLLRX_KVCAL_2_ADDR                           ( 0xD0 )            /* RX Kv calibration settings, register 2 */
#define HAL_RF_PLLRX_PHZ_SLIP_ADDR                          ( 0xD1 )            /* TX PLL Phase Slipper Control */
#define HAL_RF_PLLRX_CTC_ADDR                               ( 0xD2 )            /* RX PLL Coarse Tune Check Thresholds */
#define HAL_RF_PLLRX_WAIT_TIME_ADDR                         ( 0xD3 )            /* RX PLL WarmUp and Lock Times */
#define HAL_RF_PLLRX_TEST_1_ADDR                            ( 0xD8 )            /* PLL Test Mux and Feedback Control */
#define HAL_RF_PLLRX_TEST_2_ADDR                            ( 0xD9 )            /* PLL Control signals to pause the loop state machines at a specified state. */
#define HAL_RF_PLLRX_VCO_COUNT_RD_ADDR                      ( 0xE0 )            /* RX LFSR BIST count readback */
#define HAL_RF_PLLRX_FREQERRFLAG_RD_ADDR                    ( 0xE1 )            /* RX LFSR BIST frequency error flag readback */
#define HAL_RF_PLLRX_RC_VAL_RD_ADDR                         ( 0xE2 )            /* RX RC calibration values */
#define HAL_RF_PLLRX_KV_FREQ_RD_ADDR                        ( 0xE3 )            /* RX Kv compensation F0 Frequency Measurement */
#define HAL_RF_PLLRX_KV_CP_VAL_RD_ADDR                      ( 0xE4 )            /* Kv compensation result: charge pump value */
#define HAL_RF_PLLRX_CT_VAL_RD_ADDR                         ( 0xE5 )            /* RX Coarse Tuning Result */
#define HAL_RF_PLLRX_RSM_STATE_RD_ADDR                      ( 0xE6 )            /* PLL State Machine State */
#define HAL_RF_PLLRX_SPARE0_REG_ADDR                        ( 0xE7 )            /* control register */
...
/*****************************************************************************
 枚举名    : RF_RX_MAIN_CHANNEL_ID_ENUM_UINT16
 枚举说明  :
*****************************************************************************/
/*定义RF_CHANNEL_ID*/
...
/*****************************************************************************
 枚举名    : RF_RX_DVTY_CHANNEL_ID_ENUM_UINT16
 枚举说明  :
*****************************************************************************/
/*定义RF_CHANNEL_ID*/
...
/*****************************************************************************
 枚举名    : RF_TX_CHANNEL_ID_ENUM_UINT16
...
/*****************************************************************************
 联合名    : HAL_RF_FDD_TX_CONFIG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_FDD_RX_CONFIG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_MAIN_DCOC_VALUE_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_DVTY_DCOC_VALUE_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_MAIN_IIP2_CAL_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_DVTY_IIP2_CAL_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_TX_FEEDBACK_CONTROL_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_TX_FEEDBACK_DATA_1_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_OPERATING_BANDGROUP_UNION
 联合说明  : 寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_XO_AFC_CTL_ADDR_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RFIC_IO_CTRL_ADDR_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_MODE_V210_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_MODE_V210_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_2G_FSM_TIME_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_FDD_RX_CONFIG_V210_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_RX_IIP2_LO_CAL_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_TX_FEEDBACK_CONTROL_V210_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_TX_FEEDBACK_DEBUG2_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_TDD_3G4G_FSM_TIME_REG_UNION
 联合说明  : 3G4G定时器寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_TX_FSM_TIME_REG_UNION
 联合说明  : 发送定时器寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_TX_BIAS_CFG_REG_UNION
 联合说明  : 发送bias寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_RX_FSM_TIME_REG_UNION
 联合说明  : 发送bias寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_RX_MAIN_LNA_REG_UNION
 联合说明  : 接收主通道寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_RX_DVTY_LNA_REG_UNION
 联合说明  : 接收分通道寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_PWR_LDO_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_PWR_VCO_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_CTL_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_KVCAL_1_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_WAIT_TIME_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_PWR_LDO_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_CTL_REG_UNION
 联合说明  : 接收PLL CTL寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_KVCAL_1_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_WAIT_TIME_REG_UNION
 联合说明  : 接收PLL等待时间寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_PWR_VCO_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_CTRL_FSM_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_VCO_ATEMP_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_CT_1_REG_UNION
 联合说明  : 接收PLL功率CT寄存器定义
*****************************************************************************/
typedef union
{
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_LFSR_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_LFSR_REG_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLRX_KVCAL_1_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_KVCAL_1_UNION
...
/*****************************************************************************
 联合名    : HAL_RF_PLLTX_KVCAL_2_UNION
