 ...
 ****************************************************************************/
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_START_UNION
 结构说明  : DSP_START 寄存器结构定义。地址偏移量:0x0000，初值:0x00000000，宽度:32
 寄存器说明: HKADC启动配置
*****************************************************************************/
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_CFG_UNION
 结构说明  : DSP_CFG 寄存器结构定义。地址偏移量:0x0004，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_WR_NUM_UNION
 结构说明  : WR_NUM 寄存器结构定义。地址偏移量:0x0008，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_WAIT_TIME_UNION
 结构说明  : DSP_WAIT_TIME 寄存器结构定义。地址偏移量:0x000C，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_TIMEOUT_ERR_CLR_UNION
 结构说明  : TIMEOUT_ERR_CLR 寄存器结构定义。地址偏移量:0x0010，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_TIMEOUT_ERR_UNION
 结构说明  : TIMEOUT_ERR 寄存器结构定义。地址偏移量:0x0018，初值:0x00000000，宽度:32
 寄存器说明: HKADC超时上报
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_START_CLR_UNION
 结构说明  : DSP_START_CLR 寄存器结构定义。地址偏移量:0x001C，初值:0x00000000，宽度:32
 寄存器说明: HKADC启动清除上报
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_WR01_DATA_UNION
 结构说明  : WR01_DATA 寄存器结构定义。地址偏移量:0x0020，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_WR23_DATA_UNION
 结构说明  : WR23_DATA 寄存器结构定义。地址偏移量:0x0024，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_WR45_DATA_UNION
 结构说明  : WR45_DATA 寄存器结构定义。地址偏移量:0x0028，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_WR67_DATA_UNION
 结构说明  : WR67_DATA 寄存器结构定义。地址偏移量:0x002C，初值:0x00000000，宽度:32
 寄存器说明: HKADC参数配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DELAY01_UNION
 结构说明  : DELAY01 寄存器结构定义。地址偏移量:0x0030，初值:0x00000000，宽度:32
 寄存器说明: HKADC延迟配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DELAY23_UNION
 结构说明  : DELAY23 寄存器结构定义。地址偏移量:0x0034，初值:0x00000000，宽度:32
 寄存器说明: HKADC延迟配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DELAY45_UNION
 结构说明  : DELAY45 寄存器结构定义。地址偏移量:0x0038，初值:0x00000000，宽度:32
 寄存器说明: HKADC延迟配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DELAY6_UNION
 结构说明  : DELAY6 寄存器结构定义。地址偏移量:0x003C，初值:0x00000000，宽度:32
 寄存器说明: HKADC延迟配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD0_DATA_UNION
 结构说明  : DSP_RD0_DATA 寄存器结构定义。地址偏移量:0x0040，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD1_DATA_UNION
 结构说明  : DSP_RD1_DATA 寄存器结构定义。地址偏移量:0x0044，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD2_DATA_UNION
 结构说明  : DSP_RD2_DATA 寄存器结构定义。地址偏移量:0x0048，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD3_DATA_UNION
 结构说明  : DSP_RD3_DATA 寄存器结构定义。地址偏移量:0x004C，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD4_DATA_UNION
 结构说明  : DSP_RD4_DATA 寄存器结构定义。地址偏移量:0x0050，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD5_DATA_UNION
 结构说明  : DSP_RD5_DATA 寄存器结构定义。地址偏移量:0x0054，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD6_DATA_UNION
 结构说明  : DSP_RD6_DATA 寄存器结构定义。地址偏移量:0x0058，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DSP_RD7_DATA_UNION
 结构说明  : DSP_RD7_DATA 寄存器结构定义。地址偏移量:0x005C，初值:0x00000000，宽度:32
 寄存器说明: HKADC数据回读
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_OP_INTERVAL_UNION
 结构说明  : OP_INTERVAL 寄存器结构定义。地址偏移量:0x0060，初值:0x00000000，宽度:32
 寄存器说明: HKADC操作间隔时间配置
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_OP_INTERVAL_BYPASS_UNION
 结构说明  : OP_INTERVAL_BYPASS 寄存器结构定义。地址偏移量:0x0064，初值:0x00000001，宽度:32
 寄存器说明: 
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  op_interval_bypass_en : 1;  /* bit[0]   : op_interval功能bypass使能：(建议软件在IDLE态配置）
                                                                0：使用op_interval功能
...
/*****************************************************************************
 结构名    : SOC_HKADC_CHANNEL_EN_UNION
 结构说明  : CHANNEL_EN 寄存器结构定义。地址偏移量:0x0068，初值:0x00000007，宽度:32
 寄存器说明: HKADC通道使能
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_DBG_INFO_UNION
 结构说明  : DBG_INFO 寄存器结构定义。地址偏移量:0x00D0，初值:0x00000000，宽度:32
 寄存器说明: HKADC 测试数据
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        unsigned int  arb_info : 32; /* bit[0-31]: 状态信号组合的上报寄存器:
                                                   ...
                                                   [4]:同步后的通道0req
                                                   [5]:同步后的通道1 req
                                                   [6]:dsp_grant 软件通道允许grant信号
                                                   [8:7]:通道1grant 信号，通道0grant信号
                                                   [12:9]:软件操作状态机state
                                                   [14:13]:ssi_ip时钟下降沿读ssi单线数据状态机state
                                                   [16:15]:ssi_ip时钟上升沿读ssi单线数据状态机state
                                                   [19:17]:ssi_ip读写操作状态机state */
    } reg;
...
/*****************************************************************************
 结构名    : SOC_HKADC_FINSH_RAW_INT_UNION
 结构说明  : FINSH_RAW_INT 寄存器结构定义。地址偏移量:0x0100，初值:0x00000000，宽度:32
 寄存器说明: HKADC 操作完成原始中断
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_FINSH_MSK_INT_UNION
 结构说明  : FINSH_MSK_INT 寄存器结构定义。地址偏移量:0x0104，初值:0x00000000，宽度:32
 寄存器说明: HKADC操作完成屏蔽后中断
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_FINSH_INT_CLR_UNION
 结构说明  : FINSH_INT_CLR 寄存器结构定义。地址偏移量:0x0108，初值:0x00000000，宽度:32
 寄存器说明: HKADC操作完成中断清除
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
...
/*****************************************************************************
 结构名    : SOC_HKADC_FINSH_INT_MSK_UNION
 结构说明  : FINSH_INT_MSK 寄存器结构定义。地址偏移量:0x010C，初值:0x00000000，宽度:32
 寄存器说明: HKADC操作完成中断屏蔽
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
