...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  schedule_strategy : 1;  /* bit[13]   : 上下行通道调度策略选择。
...
/*****************************************************************************
 ...
 结构说明  : CH0_ADQ0_STAT 寄存器结构定义。地址偏移量:0x0214，初值:0x0005，宽度:32
 寄存器说明: 上行通道ADQ0状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  ul_adq0_buf_epty     : 1;  /* bit[2]   : 上行通道内部AD Buffer0空标志。该标志等于1表示内部AD Buffer0缓存了0个AD。 */
        unsigned int  ul_adq0_buf_full     : 1;  /* bit[3]   : 上行通道内部AD Buffer0满标志。该标志等于1表示内部AD Buffer0缓存了2个AD。 */
...
/*****************************************************************************
 ...
 结构说明  : CH0_ADQ1_STAT 寄存器结构定义。地址偏移量:0x0224，初值:0x0005，宽度:32
 寄存器说明: 上行通道ADQ1状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0           : 1;  /* bit[1]   : 保留. */
        unsigned int  ul_adq1_buf_epty     : 1;  /* bit[2]   : 上行通道内部AD Buffer1空标志。该标志等于1表示内部AD Buffer1缓存了0个AD。 */
        unsigned int  ul_adq1_buf_full     : 1;  /* bit[3]   : 上行通道内部AD Buffer1满标志。该标志等于1表示内部AD Buffer1缓存了2个AD。 */
...
/*****************************************************************************
 ...
 结构说明  : CH1_ADQ0_STAT 寄存器结构定义。地址偏移量:0x0294，初值:0x0005，宽度:32
 寄存器说明: 下行通道ADQ0状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0           : 1;  /* bit[1]   : 保留. */
        unsigned int  dl_adq0_buf_epty     : 1;  /* bit[2]   : 下行通道内部AD Buffer0空标志。该标志等于1表示内部AD Buffer0缓存了0个AD。 */
        unsigned int  dl_adq0_buf_full     : 1;  /* bit[3]   : 下行通道内部AD Buffer0满标志。该标志等于1表示内部AD Buffer0缓存了2个AD。 */
...
/*****************************************************************************
 ...
 结构说明  : CH1_ADQ1_STAT 寄存器结构定义。地址偏移量:0x02A4，初值:0x0005，宽度:32
 寄存器说明: 下行通道ADQ1状态寄存器
*****************************************************************************/
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    ...
    struct
    {
        ...
        unsigned int  reserved_0           : 1;  /* bit[1]   : 保留. */
        unsigned int  dl_adq1_buf_epty     : 1;  /* bit[2]   : 下行通道内部AD Buffer1空标志。该标志等于1表示内部AD Buffer1缓存了0个AD。 */
        unsigned int  dl_adq1_buf_full     : 1;  /* bit[3]   : 下行通道内部AD Buffer1满标志。该标志等于1表示内部AD Buffer1缓存了2个AD。 */
