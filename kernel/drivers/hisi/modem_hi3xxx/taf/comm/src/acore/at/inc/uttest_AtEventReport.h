...
extern VOS_VOID AT_PhnEvtGetDomainAttachState(
           VOS_UINT8 ucIndex,
...
extern VOS_VOID AT_PhnEvtSetMtPowerDown(
           VOS_UINT8 ucIndex,
           TAF_PHONE_EVENT_INFO_STRU  *pEvent
       );
extern VOS_VOID AT_PhnEvtSetPrefPlmnType(
           VOS_UINT8 ucIndex,
           TAF_PHONE_EVENT_INFO_STRU  *pEvent
       );
...
extern VOS_VOID AT_PhnEvtTestSyscfg(
           VOS_UINT8                           ucIndex,
           TAF_PHONE_EVENT_INFO_STRU          *pEvent
       );
...
extern VOS_VOID AT_PhSendNeedPuk( VOS_VOID );
extern VOS_VOID AT_PhSendPinReady( VOS_VOID );
...
extern VOS_VOID AT_QryParaRspCsqlvlExtProc (
           TAF_UINT8                           ucIndex,
           TAF_UINT8                           OpId,
           TAF_VOID                           *pPara
       );
...
extern VOS_VOID AT_RcvMmInfoInd(
        VOS_UINT8                           ucIndex,
        TAF_PHONE_EVENT_INFO_STRU          *pEvent);
