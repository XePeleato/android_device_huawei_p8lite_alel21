...
/* Added by f62575 for AT Project, 2011-10-26, begin */
...
/* Added by f62575 for AT Project, 2011-10-26, end */
...
TEST_F(Test_At_QryAppWronReg, Test_At_QryAppWronReg_001)
{
    ...
    MOCKER(Taf_ParaQuery)
        .stubs()
        .with(any(),any(),eq((TAF_PARA_TYPE)TAF_PH_REGISTER_TIME_VALUE_PARA),any())
        .will(returnValue((VOS_UINT32)TAF_FAILURE));
...
class Test_AT_QryAnQuery: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_AT_QryAnQuery, Test_AT_QryAnQuery_001)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    MOCKER(Taf_ParaQuery)
        .stubs()
        .with(any(),any(),eq((TAF_PARA_TYPE)TAF_PH_ANQUERY_VALUE_PARA),any())
        .will(returnValue((VOS_UINT32)TAF_FAILURE));

    /* 调用被测函数 */
    ulRst = AT_QryAnQuery(ucIndex);
...
TEST_F(Test_AT_QryAnQuery, Test_AT_QryAnQuery_002)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    /* 结果验证 */
    ASSERT_EQ(AT_WAIT_ASYNC_RETURN, ulRst);
    ASSERT_EQ(AT_CMD_ANQUERY_READ, gastAtClientTab[ucIndex].CmdCurrentOpt);
...
class Test_At_QryApHplmn: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_At_QryApHplmn, Test_At_QryApHplmn_001)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    MOCKER(Taf_ParaQuery)
        .stubs()
        .with(any(),any(),eq((TAF_PARA_TYPE)TAF_PH_HOMEPLMN_VALUE_PARA),any())
        .will(returnValue((VOS_UINT32)TAF_FAILURE));

    /* 调用被测函数 */
    ulRst = At_QryApHplmn(ucIndex);
...
TEST_F(Test_At_QryApHplmn, Test_At_QryApHplmn_002)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    /* 结果验证 */
    ASSERT_EQ(AT_WAIT_ASYNC_RETURN, ulRst);
    ASSERT_EQ(AT_CMD_HOMEPLMN_READ, gastAtClientTab[ucIndex].CmdCurrentOpt);
...
class Test_At_QryCSNR: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_At_QryCSNR, Test_At_QryCSNR_001)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    MOCKER(Taf_ParaQuery)
        .stubs()
        .with(any(),any(),eq((TAF_PARA_TYPE)TAF_PH_CSNR_VALUE_PARA),any())
        .will(returnValue((VOS_UINT32)TAF_FAILURE));

    /* 调用被测函数 */
    ulRst = At_QryCSNR(ucIndex);
...
TEST_F(Test_At_QryCSNR, Test_At_QryCSNR_002)
{
    /* 变量定义 */
    VOS_UINT32                          ulRst;
    VOS_UINT8                           ucIndex;
    ...
    /* 结果验证 */
    ASSERT_EQ(AT_WAIT_ASYNC_RETURN, ulRst);
    ASSERT_EQ(AT_CMD_CSNR_QUERY, gastAtClientTab[ucIndex].CmdCurrentOpt);
...
class Test_AT_QryCipherPara: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_AT_QryCipherPara, Test_AT_QryCipherPara_001)
{
    /*变量定义*/
    VOS_UINT32                          ulRst = 0;
    MN_MMA_CIPHER_QRY_REQ_STRU          stCipherQryReq = {0};
    ...
    MOCKER(MN_FillAndSndAppReqMsg)
        ...
        .with(eq(gastAtClientTab[ucIndex].usClientId),
              ...
              eq((VOS_UINT16)TAF_MSG_MMA_CIPHER_INFO),
              mirror((void *)&stCipherQryReq, sizeof(MN_MMA_CIPHER_QRY_REQ_STRU)),
              eq((VOS_UINT32)sizeof(MN_MMA_CIPHER_QRY_REQ_STRU)),
              eq((VOS_UINT32)WUEPS_PID_MMA))
        .will(returnValue((VOS_UINT32)AT_SUCCESS));

    /* 调用消息入口函数 */
    ulRst = AT_QryCipherPara(ucIndex);

    /* 结果验证*/
    EXPECT_EQ(AT_WAIT_ASYNC_RETURN, ulRst);
    EXPECT_EQ(AT_CMD_CIPERQRY_READ, gastAtClientTab[ucIndex].CmdCurrentOpt);

    /* 检查调用时, 需要在用例结束位置加上这句 */
    GlobalMockObject::verify();

}
TEST_F(Test_AT_QryCipherPara, Test_AT_QryCipherPara_002)
{
    /*变量定义*/
    VOS_UINT32                          ulRst = 0;
    MN_MMA_CIPHER_QRY_REQ_STRU          stCipherQryReq = {0};
...
class Test_AT_QryLocinfoPara: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_AT_QryLocinfoPara, Test_AT_QryLocinfoPara_001)
{
    /*变量定义*/
    VOS_UINT32                          ulRst = 0;
    MN_MMA_LOCATION_INFO_REQ_STRU       stLocInfoReq = {0};
    ...
    MOCKER(MN_FillAndSndAppReqMsg)
        ...
        .with(eq(gastAtClientTab[ucIndex].usClientId),
              eq(gastAtClientTab[ucIndex].opId ),
              eq((VOS_UINT16)TAF_MSG_MMA_LOCATION_INFO),
              mirror((void *)&stLocInfoReq, sizeof(MN_MMA_LOCATION_INFO_REQ_STRU)),
              eq((VOS_UINT32)sizeof(MN_MMA_LOCATION_INFO_REQ_STRU)),
              eq((VOS_UINT32)WUEPS_PID_MMA))
        .will(returnValue((VOS_UINT32)AT_SUCCESS));

    /* 调用消息入口函数 */
    ulRst = AT_QryLocinfoPara(ucIndex);

    /* 结果验证*/
    EXPECT_EQ(AT_WAIT_ASYNC_RETURN, ulRst);
    EXPECT_EQ(AT_CMD_LOCINFO_READ, gastAtClientTab[ucIndex].CmdCurrentOpt);

    /* 检查调用时, 需要在用例结束位置加上这句 */
    GlobalMockObject::verify();

}
TEST_F(Test_AT_QryLocinfoPara, Test_AT_QryLocinfoPara_002)
{
    /*变量定义*/
    VOS_UINT32                          ulRst = 0;
    MN_MMA_LOCATION_INFO_REQ_STRU       stLocInfoReq = {0};
...
/* Added by f62575 for , 2012-08-30 Begin */
/*****************************************************************************
...
/* Added by f62575 for , 2012-08-30 End   */
...
TEST_F(Test_At_QryMmPlmnInfoPara, Test_At_QryMmPlmnInfoPara_001)
{
    ...
    MOCKER(Taf_ParaQuery)
        .expects(exactly(1))
        .with(eq((VOS_UINT16)ucIndex), any(), eq((TAF_PARA_TYPE)TAF_MM_PLMN_INFO_QRY_PARA), any())
        .will(returnValue((VOS_UINT32)AT_SUCCESS));
...
class Test_At_QryPlmnPara: public ::testing::Test
{
public:
    void SetUp()
    {
...
TEST_F(Test_At_QryPlmnPara, Test_At_QryPlmnPara_001)
{
    // 变量声明
    VOS_UINT32                          ulRet;
    VOS_UINT8                           ucIndex = 0;
    ...
    MOCKER(Taf_ParaQuery)
        .expects(exactly(1))
        .with(eq((VOS_UINT16)ucIndex), any(), eq((TAF_PARA_TYPE)TAF_PH_PLMN_QRY_PARA), any())
        .will(returnValue((VOS_UINT32)AT_SUCCESS));

    // 调用被测函数
    ulRet = At_QryPlmnPara(ucIndex);

    // 执行检查
    EXPECT_EQ(AT_WAIT_ASYNC_RETURN, ulRet);
    EXPECT_EQ(gastAtClientTab[ucIndex].CmdCurrentOpt, AT_CMD_PLMN_QRY);

    GlobalMockObject::verify();
}


TEST_F(Test_At_QryPlmnPara, Test_At_QryPlmnPara_002)
{
    // 变量声明
    VOS_UINT32                          ulRet;
    VOS_UINT8                           ucIndex = 0;
...
TEST_F(Test_AT_QryUserSrvStatePara, Test_AT_QryUserSrvStatePara_001)
{
    ...
    MOCKER(Taf_ParaQuery)
        .expects(exactly(1))
        .with(eq(gastAtClientTab[ucIndex].usClientId), eq(ucOpId), eq((TAF_PARA_TYPE)TAF_PH_USER_SRV_STATE_QRY_PARA), any())
        .will(returnValue((VOS_UINT32)TAF_SUCCESS));
