...
#define TLSLEEP_DFS_BUS_150M
#define TLSLEEP_DFS_DDR_150M
#define TLSLEEP_DFS_CCPU_600M

#define TLSLEEP_DFS_BUS_75M
#define TLSLEEP_DFS_DDR_75M
#define TLSLEEP_DFS_CCPU_150M

#define TLSLEEP_DfsQosRequest(qos_id, req_value, req_id)            (0)
#define TLSLEEP_DfsQosRelease(qos_id, req_id)                       (0)
#define TLSLEEP_DfsQosUpdate(qos_id, req_id, req_value)             (0)
#else
#define  mspsleep_print_info(fmt,...)
