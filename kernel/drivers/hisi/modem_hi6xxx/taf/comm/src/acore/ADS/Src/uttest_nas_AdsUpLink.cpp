...
/*****************************************************************************
类名     : Test_ADS_UL_RcvCdsStopSendDataInd
功能描述 : ADS_UL_RcvCdsStopSendDataInd UT工程类
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新生成类
*****************************************************************************/
class Test_ADS_UL_RcvCdsStopSendDataInd: public ::testing::Test
{
public:
    void SetUp()
	{
        ...
        stPdpStatusInd.ulSenderPid   = I0_WUEPS_PID_TAF;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsStopSendDataInd_001
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_STOP_SENDDATA_IND消息，Modem0，RabId5
预期结果          : g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_0].astAdsUlQueue[5].ucRabSndPermitFlg置为VOS_FALSE，定时器TI_ADS_UL_SEND停止，回复ID_CDS_ADS_STOP_SENDDATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsStopSendDataInd,Test_ADS_UL_RcvCdsStopSendDataInd_001)
{
    ADS_TIMER_STATUS_ENUM_UINT8         enTimerStatus;
    CDS_ADS_STOP_SENDDATA_IND_STRU      stCdsAdsStopSendDataInd;
    CDS_ADS_STOP_SENDDATA_RSP_STRU      stCdsAdsStopSendDataRsp;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
    ADS_PDP_STATUS_IND_STRU          stPdpStatusInd;

    pAdsUlCtx = ADS_GetUlCtx(ADS_INSTANCE_INDEX_0);

    /* 构造ID_CDS_ADS_STOP_SENDDATA_IND消息 */
    stCdsAdsStopSendDataInd.ulSenderPid   = UEPS_PID_CDS;
    stCdsAdsStopSendDataInd.ulReceiverPid = ACPU_PID_ADS_UL;
    stCdsAdsStopSendDataInd.enMsgId       = ID_CDS_ADS_STOP_SENDDATA_IND;
    stCdsAdsStopSendDataInd.enModemId     = MODEM_ID_0;
    stCdsAdsStopSendDataInd.ucRabId       = 5;

    /* 需要匹配的CDS_ADS_STOP_SENDDATA_RSP_STRU消息 */
    stCdsAdsStopSendDataRsp.ulSenderPid   = ACPU_PID_ADS_UL;
    stCdsAdsStopSendDataRsp.ulReceiverPid = UEPS_PID_CDS;
    stCdsAdsStopSendDataRsp.enMsgId       = ID_CDS_ADS_STOP_SENDDATA_RSP;
    stCdsAdsStopSendDataRsp.enModemId     = MODEM_ID_0;
    stCdsAdsStopSendDataRsp.ucRabId       = 5;

    /* VOS_SendMsg 发送ID_CDS_ADS_STOP_SENDDATA_RSP消息*/
    MOCKER(Ps_SendMsg)
        .expects(exactly(1))
        .with(any(), any(), eq(ACPU_PID_ADS_UL))
    ...
    /* 调用上行的消息入口函数 */
    ADS_UL_ProcMsg((MsgBlock *)&stCdsAdsStopSendDataInd);

    EXPECT_EQ(VOS_FALSE, pAdsUlCtx->astAdsUlQueue[5].ucRabSndPermitFlg);

    enTimerStatus = ADS_GetTimerStatus(ACPU_PID_ADS_UL, TI_ADS_UL_SEND);

    EXPECT_EQ(ADS_TIMER_STATUS_STOP, enTimerStatus);
    EXPECT_EQ(VOS_FALSE, pAdsUlCtx->ucModemSndPermitFlg);
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsStopSendDataInd_003
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_STOP_SENDDATA_IND消息，Modem0，RabId5
                    g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_0].astAdsUlQueue[6].ucRabSndPermitFlg为VOS_TRUE
预期结果          : g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_0].astAdsUlQueue[5].ucRabSndPermitFlg置为VOS_FALSE，定时器TI_ADS_UL_SEND停止，回复ID_CDS_ADS_STOP_SENDDATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsStopSendDataInd,Test_ADS_UL_RcvCdsStopSendDataInd_003)
{
    ADS_TIMER_STATUS_ENUM_UINT8         enTimerStatus;
    CDS_ADS_STOP_SENDDATA_IND_STRU      stCdsAdsStopSendDataInd;
    CDS_ADS_STOP_SENDDATA_RSP_STRU      stCdsAdsStopSendDataRsp;
    ...
    pAdsUlCtx->astAdsUlQueue[6].ucRabSndPermitFlg = VOS_TRUE;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsStopSendDataInd_002
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_STOP_SENDDATA_IND消息，Modem0，RabId5
预期结果          : g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_1].astAdsUlQueue[5].ucRabSndPermitFlg置为VOS_FALSE，定时器TI_ADS_UL_SEND停止，回复ID_CDS_ADS_STOP_SENDDATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsStopSendDataInd,Test_ADS_UL_RcvCdsStopSendDataInd_002)
{
    ADS_TIMER_STATUS_ENUM_UINT8         enTimerStatus;
    CDS_ADS_STOP_SENDDATA_IND_STRU      stCdsAdsStopSendDataInd;
    CDS_ADS_STOP_SENDDATA_RSP_STRU      stCdsAdsStopSendDataRsp;
    ...
    stCdsAdsStopSendDataInd.ulReceiverPid = ACPU_PID_ADS_UL;
    stCdsAdsStopSendDataInd.enMsgId       = ID_CDS_ADS_STOP_SENDDATA_IND;
    stCdsAdsStopSendDataInd.enModemId     = MODEM_ID_1;
    stCdsAdsStopSendDataInd.ucRabId       = 5;
    ...
    stCdsAdsStopSendDataRsp.ulReceiverPid = UEPS_PID_CDS;
    stCdsAdsStopSendDataRsp.enMsgId       = ID_CDS_ADS_STOP_SENDDATA_RSP;
    stCdsAdsStopSendDataRsp.enModemId     = MODEM_ID_1;
    stCdsAdsStopSendDataRsp.ucRabId       = 5;
...
/*****************************************************************************
类名     : Test_ADS_UL_RcvCdsStartSendDataInd
功能描述 : ADS_UL_RcvCdsStartSendDataInd UT工程类
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新生成类
*****************************************************************************/
class Test_ADS_UL_RcvCdsStartSendDataInd: public ::testing::Test
{
public:
    void SetUp()
	{
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsStartSendDataInd_001
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_START_SENDDATA_IND消息
预期结果          : g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_0].astAdsUlQueue[5].ucRabSndPermitFlg置为VOS_TRUE，回复ID_CDS_ADS_START_SENDDATA_RSP消息，发送ID_ADS_UL_DATA_READY消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsStartSendDataInd,Test_ADS_UL_RcvCdsStartSendDataInd_001)
{
    CDS_ADS_START_SENDDATA_IND_STRU     stCdsAdsStartSendDataInd;
    CDS_ADS_START_SENDDATA_RSP_STRU     stCdsAdsStartSendDataRsp;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;

    pAdsUlCtx = ADS_GetUlCtx(ADS_INSTANCE_INDEX_0);

    /* 构造ID_CDS_ADS_START_SENDDATA_IND消息 */
    stCdsAdsStartSendDataInd.ulSenderPid   = UEPS_PID_CDS;
    stCdsAdsStartSendDataInd.ulReceiverPid = ACPU_PID_ADS_UL;
    stCdsAdsStartSendDataInd.enMsgId       = ID_CDS_ADS_START_SENDDATA_IND;
    stCdsAdsStartSendDataInd.enModemId     = MODEM_ID_0;
    stCdsAdsStartSendDataInd.ucRabId       = 5;

    /* 需要匹配的CDS_ADS_START_SENDDATA_RSP_STRU消息 */
    stCdsAdsStartSendDataRsp.ulSenderPid   = ACPU_PID_ADS_UL;
    stCdsAdsStartSendDataRsp.ulReceiverPid = UEPS_PID_CDS;
    stCdsAdsStartSendDataRsp.enMsgId       = ID_CDS_ADS_START_SENDDATA_RSP;
    stCdsAdsStartSendDataRsp.enModemId     = MODEM_ID_0;
    stCdsAdsStartSendDataRsp.ucRabId       = 5;

    /* VOS_SendMsg 发送ID_CDS_ADS_START_SENDDATA_RSP消息*/
    MOCKER(Ps_SendMsg)
        .expects(exactly(1))
        .with(any(), any(), eq(ACPU_PID_ADS_UL))
        .will(returnValue((VOS_UINT32)VOS_OK));
    ...
    /* 调用上行的消息入口函数 */
    ADS_UL_ProcMsg((MsgBlock *)&stCdsAdsStartSendDataInd);

    EXPECT_EQ(VOS_TRUE, pAdsUlCtx->astAdsUlQueue[5].ucRabSndPermitFlg);

    EXPECT_EQ(VOS_TRUE, ADS_UL_GET_MODEM_SND_PERMIT_FLAG(ADS_INSTANCE_INDEX_0));
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsStartSendDataInd_002
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_START_SENDDATA_IND消息
预期结果          : g_stAdsCtx.astAdsSpecCtx[ADS_INSTANCE_INDEX_1].astAdsUlQueue[5].ucRabSndPermitFlg置为VOS_TRUE，回复ID_CDS_ADS_START_SENDDATA_RSP消息，发送ID_ADS_UL_DATA_READY消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsStartSendDataInd,Test_ADS_UL_RcvCdsStartSendDataInd_002)
{
    CDS_ADS_START_SENDDATA_IND_STRU     stCdsAdsStartSendDataInd;
    CDS_ADS_START_SENDDATA_RSP_STRU     stCdsAdsStartSendDataRsp;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
    ...
    EXPECT_EQ(VOS_TRUE, ADS_UL_GET_MODEM_SND_PERMIT_FLAG(ADS_INSTANCE_INDEX_1));
...
#endif
/*****************************************************************************
类名     : Test_ADS_UL_RcvCdsClearDataInd
功能描述 : ADS_UL_RcvCdsClearDataInd UT工程类
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新生成类
*****************************************************************************/
class Test_ADS_UL_RcvCdsClearDataInd: public ::testing::Test
{
public:
    void SetUp()
	{
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_001
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列已创建，且队列中有5个缓存数据）
预期结果          : 队列清空，释放数据，回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_001)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_PDP_STATUS_IND_STRU          stPdpStatusInd;
    VOS_UINT32                          i;
    IMM_ZC_STRU                        *pstData;
    VOS_UINT8                           ucRabId;
    ...
    /* 构造ID_CDS_ADS_CLEAR_DATA_IND消息 */
    stClearDataInd.ulSenderPid   = UEPS_PID_CDS;
    stClearDataInd.ulReceiverPid = ACPU_PID_ADS_UL;
    stClearDataInd.enMsgId       = ID_CDS_ADS_CLEAR_DATA_IND;
    stClearDataInd.enModemId     = MODEM_ID_0;
    stClearDataInd.ucRabId       = 5;

    /* 释放队列中的数据 */
    MOCKER(kfree_skb)
        .expects(exactly(5));

    /* VOS_SendMsg 发送ID_CDS_ADS_CLEAR_DATA_RSP消息*/
    MOCKER(Ps_SendMsg)
        .expects(exactly(1))
        .with(any(), any(), eq(ACPU_PID_ADS_UL))
        .will(returnValue((VOS_UINT32)VOS_OK));

    ADS_UL_ProcMsg((struct MsgCB *)(&stClearDataInd));
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_002
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列已创建，且队列中无缓存数据）
预期结果          : 队列为空，无数据释放，回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_002)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_PDP_STATUS_IND_STRU          stPdpStatusInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_003
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列未创建）
预期结果          : 队列不存在，不回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_003)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_004
测试用例标题      : Modem0，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为ADS_RAB_ID_INVALID
预期结果          : 不回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_004)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
    ...
    stClearDataInd.enMsgId       = ID_CDS_ADS_CLEAR_DATA_IND;
    stClearDataInd.enModemId     = MODEM_ID_0;
    stClearDataInd.ucRabId       = ADS_RAB_ID_INVALID;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_005
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列已创建，且队列中有5个缓存数据）
预期结果          : 队列清空，释放数据，回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_005)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_PDP_STATUS_IND_STRU          stPdpStatusInd;
    VOS_UINT32                          i;
    ...
    stClearDataInd.ulReceiverPid = ACPU_PID_ADS_UL;
    stClearDataInd.enMsgId       = ID_CDS_ADS_CLEAR_DATA_IND;
    stClearDataInd.enModemId     = MODEM_ID_1;
    stClearDataInd.ucRabId       = 5;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_006
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列已创建，且队列中无缓存数据）
预期结果          : 队列为空，无数据释放，回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_006)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_PDP_STATUS_IND_STRU          stPdpStatusInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_007
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为5（预置条件：RabId为5的队列未创建）
预期结果          : 队列不存在，不回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_007)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
...
/*******************************************************************
测试用例编号      : Test_ADS_UL_RcvCdsClearDataInd_008
测试用例标题      : Modem1，ADS上行处理ID_CDS_ADS_CLEAR_DATA_IND消息，RabId为ADS_RAB_ID_INVALID
预期结果          : 不回复ID_CDS_ADS_CLEAR_DATA_RSP消息
修改历史     :
1.日   期  : 2011-12-10
作   者  :   l60609
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_ADS_UL_RcvCdsClearDataInd,Test_ADS_UL_RcvCdsClearDataInd_008)
{
    CDS_ADS_CLEAR_DATA_IND_STRU         stClearDataInd;
    ADS_UL_CTX_STRU                    *pAdsUlCtx;
...
TEST_F(Test_ADS_UL_RcvTiDsFlowStatsExpired,Test_ADS_UL_RcvTiDsFlowStatsExpired_001)
{
    ...
    stTimerMsg.ulSenderPid   = VOS_PID_TIMER;
    stTimerMsg.ulReceiverPid = ACPU_PID_ADS_UL;
    stTimerMsg.ulName        = TI_ADS_DSFLOW_STATS_0;

    ADS_UL_ProcMsg((struct MsgCB *)(&stTimerMsg));
    ADS_GetCurrentRate(&ulUlBpsRate,&ulDlBpsRate);

    enTimerStatus = ADS_GetTimerStatus(ACPU_PID_ADS_UL, TI_ADS_DSFLOW_STATS_0);
...
#endif
class Test_ADS_UL_IsSendPermit: public ::testing::Test
{
public:
    void SetUp()
	{
...
TEST_F(Test_ADS_UL_IsSendPermit, Test_ADS_UL_IsSendPermit_001)
{
    //参数定义
    VOS_UINT32                          ulSendPermitFlg;
    ...
    //调用被测函数
    ulSendPermitFlg = ADS_UL_IsSendPermit();

    //执行检查
    EXPECT_EQ(VOS_TRUE, ulSendPermitFlg);
