...
/*****************************************************************************
类名     : Test_AT_RcvMuxCmdStream_PreProc
功能描述 : AT_RcvMuxCmdStream_PreProc UT工程类
修改历史     :
1.日   期  : 2012-08-09
作   者  :   l60609
修改内容 : 新生成类
*****************************************************************************/
class Test_AT_RcvMuxCmdStream_PreProc: public ::testing::Test
{
public:
    void SetUp()
    {
...
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_AT_RcvMuxCmdStream_PreProc, Test_AT_RcvMuxCmdStream_PreProc_001)
{
    VOS_UINT8                           aucData[3] = {'A', 'T', 0xd};
    VOS_UINT8                           ucMuxSupportFlg = VOS_TRUE;
    ...
    AT_RcvMuxCmdStream_PreProc(AT_MUX_DLCI1_ID, (VOS_UINT8 *)aucData, 3);
...
TEST_F(Test_At_CmdStreamPreProc, Test_At_CmdStreamPreProc_007)
{
    ...
    MOCKER(AT_DisplayVcomInputData)
        .expects(exactly(1));
...
/* Added by L47619 for V7R1C50 A-GPS Project, 2012/07/18, begin */
/*******************************************************************
...
/* Added by L47619 for V7R1C50 A-GPS Project, 2012/07/18, end */
#endif


class Test_AT_DisplayVcomInputData: public ::testing::Test
{
public:
    void SetUp()
    {
...
修改内容 : 新建CASE
*******************************************************************/
TEST_F(Test_AT_DisplayVcomInputData, Test_AT_DisplayVcomInputData_001)
{
    TAF_UINT8                           ucIndex;
    TAF_UINT8                          *pData;
    TAF_UINT16                          usLen;
...
TEST_F(Test_AT_DisplayVcomInputData, Test_AT_DisplayVcomInputData_002)
{
    VOS_UINT8                           ucIndex;
    VOS_UINT8                           aucData[4];
    VOS_UINT8                          *pData;
...
TEST_F(Test_AT_DisplayVcomInputData, Test_AT_DisplayVcomInputData_003)
{
    VOS_UINT8                           ucIndex = 0;
    VOS_UINT8                           aucData[3];
    VOS_UINT8                          *pData;
...
/* Added by L47619 for V7R1C50 A-GPS Project, 2012/07/17, begin */
/*****************************************************************************
...
/* Added by L47619 for V7R1C50 A-GPS Project, 2012/07/17, end */
