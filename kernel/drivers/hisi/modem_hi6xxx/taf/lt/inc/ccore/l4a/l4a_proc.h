 ...
 ******************************************************************************
  File Name       : l4a_proc.h
  Description     : l4a_proc.h header file
  History         :
     1.w00182550       2013-5-8     Draft Enact
     2.
******************************************************************************/
...
#define L4A_INFO_LOG    if(g_L4aPrintCtrl) vos_printf

#define L4A_ERROR_LOG vos_printf
