...
/* Max size of generated random vector in bits according DxUint16_t type of   * 
...
/*******************************************************************/ 
	...
	typedef struct
	{
	   ...
	   DxUint32_t crysRndEntrIntBuff[CRYS_RND_WORK_BUFFER_SIZE_WORDS];
	...
	#define CRYS_RND_WORK_BUFFER_SIZE_WORDS  1024 /*894*/
	typedef struct
	{
		/* include the specific fields that are used by the low level */
		DxUint32_t crysRndWorkBuff[CRYS_RND_WORK_BUFFER_SIZE_WORDS];
	}CRYS_RND_WorkBuff_t;
