...
static uint32_t gpio_rgb2mipi_power_1v2 = 54; //GPIO_6_6
static uint32_t gpio_rgb2mipi_standby = 67; //GPIO_8_3
static uint32_t gpio_rgb2mipi_resetn = 65; //GPIO_8_1
static uint32_t gpio_rgb2mipi_gating = 60; //GPIO_7_4
static uint32_t gpio_rgb2mipi_pclk_gating = 58; //GPIO_7_2
static uint32_t gpio_rgb2mipi_refclk_gating = 59; //GPIO_7_3
static uint32_t gpio_rgb2mipi_spics = 168; //GPIO_21_0
static uint32_t gpio_rgb2mipi_drv_en = 73; //GPIO_9_1
